...
#ifndef _XF_DATA_ANALYTICS_CLASSIFICATION_SVM2_TRAIN_HPP_
#define _XF_DATA_ANALYTICS_CLASSIFICATION_SVM2_TRAIN_HPP_
#include <ap_int.h>
#include <iostream>
#include <stdio.h>
#include <stdlib.h>
...
DATA_TYPE funcA2(DATA_TYPE op1, DATA_TYPE op2) {
    return (op1 * op2);
}

void funcB2(DATA_TYPE& reg, DATA_TYPE op) {
#pragma HLS inline off
    reg += op;
}

DATA_TYPE funcC2(DATA_TYPE op) {
    return op;
}
