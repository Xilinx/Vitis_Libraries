...
statics_predict_loop:
    ...
    for (unsigned i = 0; i < MAX_TREE_DEPTH; i++) {
        ...
        if (i < tree_dp && nodeInfo.range(71, 32) != INVALID_NODEID) {
            ...
            xf::data_analytics::common::internal::f_cast<MType> feature_val_;
...
#pragma HLS pipeline
        ...
        xf::data_analytics::common::internal::f_cast<TType> thre;
...
#pragma HLS pipeline
    ...
    xf::data_analytics::common::internal::f_cast<float> tmp;
...
#pragma HLS unroll
    ...
    int c = 0;
    int c_ = 0;
    xf::data_analytics::common::internal::f_cast<TType> tmp1;
    onerow = configs_in[r];
    for (int i = 0; i < features_num; i++) {
#pragma HLS loop_tripcount min = 15 max = 15 avg = 15
...
#pragma HLS unroll
        ...
        node_mid = nstrm.read();
        e = estrm.read();
        xf::data_analytics::common::internal::f_cast<MType> classId_;
