 ...
 */
#include "xf_DataAnalytics/classification/decision_tree_L2.hpp"
...
Count:
    statisticAndCompute<MType, WD, MAX_CAT_NUM, MAX_SPLITS, PARA_NUM, MAX_TREE_DEPTH>(
        dstrm, nstrm, estrm, splits, features_ids, para_splits, tree_dp, cur_layer_nodes_num, features_num, numClass,
        paras, ifstop, max_classes, max_feature_ids, max_split_values);
}
