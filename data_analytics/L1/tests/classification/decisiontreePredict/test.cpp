...
#define MAX_CAT_BITS_ 8
#define MAX_TREE_DEPTH_ 20
...
#include "test.hpp"
int main() {
    struct Node_H<DataType, MAX_TREE_DEPTH_, MAX_CAT_BITS_> nodes[MAX_NODES_NUM];
    int nodes_num = 1;
    ...
    precisonAndRecall(testsets, test_num, features_num, nodes, numClass);
    ...
    precisonAndRecallKernel<MAX_CAT_BITS_>(testsets, predictionsStrm, predictionsTag, features_num, numClass);
    return 0;
}
