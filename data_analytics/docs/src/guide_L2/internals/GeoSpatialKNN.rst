...
- `Sort Top-K(Graph Library L1 Primitive) <https://docs.xilinx.com/r/2022.2-English/Vitis_Libraries/graph/guide_L1/primitives/sortTopK.html>`_ : sort distance in ascending order and keep top-k objects.
