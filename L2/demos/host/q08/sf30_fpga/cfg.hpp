...
void get_cfg_dat_0(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ...
    t.range(191, 184) = (128 * 0 + 64 * 0 + 32 * 0 + 16 * 0 + 8 * 0 + 4 * 0 + 2 * 0 + 1);
...
void get_cfg_dat_2(ap_uint<512>* hbuf) {
    ...
    signed char id_b[] = {0, 1, 2, 3, 4, -1, -1, -1}; // not used.
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
...
void get_cfg_dat_3(ap_uint<512>* hbuf) {
    ...
    t.range(191, 184) = (128 * 0 + 64 * 0 + 32 * 0 + 16 * 0 + 8 * 0 + 4 * 1 + 2 * 1 + 1 * 1);
...
void get_cfg_dat_5(ap_uint<512>* hbuf) {
    ...
    signed char id_a[] = {1, -2, -1, -1, -1, -1, -1, -1}; // dup key to payload
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
