...
int main(int argc, const char* argv[]) {
    ...
    tbs[1] = Table("part", 200000, 3, in_dir);
    ...
    Table tk1("tk1", 2000, 8, "");
    Table tk2("tk2", 2000, 8, "");
    ...
    events_grp[0].push_back(eventsh2d_write[0][0]);
    events_grp[0].push_back(eventsh2d_write[1][0]);
    krnlstep[0].run(0, &(events_grp[0]), &(events[0][0]));
    transout[0].add(&tk1);
