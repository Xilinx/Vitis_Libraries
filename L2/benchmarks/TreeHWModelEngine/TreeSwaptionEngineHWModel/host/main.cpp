...
int main(int argc, const char* argv[]) {
    ...
    if (timestep == 50) {
        golden[0] = 13.19031464334458;  // ATM
        golden[1] = 2.6408964976379234; // OTM
        golden[2] = 42.372676709470298; // ITM
    } else
        golden[0] = 13.201767812700929; // 1000
    if (timestep == 10) golden[0] = 13.668140761267875;
