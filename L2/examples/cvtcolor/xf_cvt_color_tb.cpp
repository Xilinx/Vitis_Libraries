...
int main(int argc, char** argv) {
    ...
    OCL_CHECK(err, cl::Buffer imageToDevicebgr(context, CL_MEM_READ_ONLY, (inputimg.rows * inputimg.cols), NULL, &err));
    OCL_CHECK(err,
              cl::Buffer imageFromDevicehsv(context, CL_MEM_WRITE_ONLY, (outputimg.rows * outputimg.cols), NULL, &err));
    ...
    /* Copy input vectors to memory */
    OCL_CHECK(err, err = q.enqueueWriteBuffer(imageToDevicebgr, CL_TRUE, 0, (inputimg.rows * inputimg.cols * INPUT_CH_TYPE));
    printf("finished enqueueing task\n");
    ...
    OCL_CHECK(err, err = q.enqueueReadBuffer(imageFromDevicehsv, CL_TRUE, 0, (outputimg.rows * outputimg.cols * OUTPUT_CH_TYPE));
    q.finish();
    printf("write output buffer\n");
    /////////////////////////////////////// end of CL /////////////////////
