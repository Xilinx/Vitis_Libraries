...
void zlib_dm(xf::compression::uintMemWidth_t* in,
             xf::compression::uintMemWidth_t* out,
             uint32_t* encoded_size,
             uint32_t input_size,
             hls::stream<xf::compression::kStream16b_t>& instream,
             hls::stream<xf::compression::kStream8b_t>& outstream) {
...
extern "C" {
void xilZlibDm(xf::compression::uintMemWidth_t* in,
               xf::compression::uintMemWidth_t* out,
               uint32_t* encoded_size,
               uint32_t input_size,
