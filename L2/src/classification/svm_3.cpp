...
#include "xf_DataAnalytics/classification/svm_train_3.hpp"
...
void SVM_flow(internal::tagTableRandomLoader<512, WD, BURST_LEN, MType, ap_uint<WD> >& loader,
              internal::s_aggr<MType, StreamN, SampleDepth, &funcB3, 7, internal::URAM>& processor_agg,
    ...
    static const int LatencyT = internal::sl2<MType, StreamN, SampleDepth, 1, 1, &funcA3, &funcB3, &funcC3, 6,
...
#pragma HLS dataflow
    ...
    internal::sl2<MType, StreamN, SampleDepth, 1, 1, &funcA3, &funcB3, &funcC3, 6, internal::URAM, internal::URAM>
        processor;
...
#pragma HLS unroll
    ...
    xf::data_analytics::common::internal::s_aggr<DATA_TYPE, STREAM_NUM, SAMPLE_DEP, &funcB3, 7,
                                                 xf::data_analytics::common::internal::URAM>
        processor_agg;
    int L = xf::data_analytics::common::internal::s_aggr<DATA_TYPE, STREAM_NUM, SAMPLE_DEP, &funcB3, 7,
                                                         xf::data_analytics::common::internal::URAM>::L;
mainloop:
    while (i < MAX_ITER && !flag_tol) {
        DATA_TYPE sum_grediant[MAX_NUM_FEATURE];
        xf::data_analytics::classification::svm3::SVM_flow<DATA_TYPE, DATA_WIDTH, STREAM_NUM, SAMPLE_DEP>(
