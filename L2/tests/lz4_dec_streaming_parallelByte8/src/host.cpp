...
void xilCompressDecompressList(std::string& file_list, bool d_flow, uint32_t block_size, std::string& decompress_bin) {
    // De-Compression
...
void xilBatchVerify(std::string& file_list, uint32_t block_size, std::string& decompress_bin) {
    { // Start of Flow : Standard LZ4 Compress vs Xilinx LZ4 Decompress
        ...
        xilCompressDecompressList(file_list, 0, block_size, decompress_bin);
