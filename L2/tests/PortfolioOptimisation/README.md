...
Call the Makefile. For example:
	...
	make check TARGET=hw_emu DEVICES=xilinx_u200_xdma_201830_2

	make all TARGET=hw DEVICES=xilinx_u200_xdma_201830_2
        
	make run TARGET=hw DEVICES=xilinx_u200_xdma_201830_2
