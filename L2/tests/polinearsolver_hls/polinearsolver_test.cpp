...
void top_polinearsolver(DT* A, DT* B, int kRows) {
// clang-format off
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
    ...
    int info;
    xf::solver::polinearsolver<DT, N, NCU>(kRows, A, NB, B, kRows, NB, info);
}
...
int main(int argc, char* argv[]) {
    ...
    for (int idx = 0; idx < runNm; ++idx) {
        ...
        top_polinearsolver(dataA, dataB, kRows);
