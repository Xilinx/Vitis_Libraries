...
Note : Please read "Getting started with HLS" section of [Vitis Vision documentation] (https://xilinx.github.io/Vitis_Libraries/vision/2020.2/index.html) for special cases, constraints and other full details.
