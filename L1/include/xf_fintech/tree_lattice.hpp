...
#pragma HLS array_partition variable = tmp_values1[0] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values1[1] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values1[2] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values1[3] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values2[0] dim = 1 cyclic factor = 2
#pragma HLS array_partition variable = tmp_values2[1] dim = 1 cyclic factor = 2
#pragma HLS array_partition variable = tmp_values2[2] dim = 1 cyclic factor = 2
#pragma HLS array_partition variable = tmp_values2[3] dim = 1 cyclic factor = 2
...
#pragma HLS array_partition variable = tmp_values1._2d_array[0] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values1._2d_array[1] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values1._2d_array[2] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values1._2d_array[3] dim = 1 cyclic factor = 3
#pragma HLS array_partition variable = tmp_values2._2d_array[0] dim = 1 cyclic factor = 2
#pragma HLS array_partition variable = tmp_values2._2d_array[1] dim = 1 cyclic factor = 2
#pragma HLS array_partition variable = tmp_values2._2d_array[2] dim = 1 cyclic factor = 2
#pragma HLS array_partition variable = tmp_values2._2d_array[3] dim = 1 cyclic factor = 2
