...
#include "xf_fft/hls_ssr_fft_exp_table_traits.hpp"
#include "xf_fft/hls_ssr_fft_twiddle_table_traits.hpp"
#include "xf_fft/hls_ssr_fft_output_traits.hpp"
#include "xf_fft/hls_ssr_fft_butterfly_traits.hpp"
...
struct FFTTraits<t_scalingMode,
                 ...
                 complex_wrapper<float>,
                 complex_wrapper<float> > {
    typedef complex_wrapper<float> T_stageOutType;
    // typedef complex_wrapper<float> T_FFTOutType;
    typedef complex_wrapper<float> T_stageInType;
    typedef complex_wrapper<float> T_twiddleType;
    typedef complex_wrapper<float> T_expTabType;
...
struct FFTTraits<t_scalingMode,
                 ...
                 t_R,
                 t_stage,
                 complex_wrapper<double>,
                 complex_wrapper<double>,
                 complex_wrapper<double>,
                 complex_wrapper<double> > {
    typedef complex_wrapper<double> T_stageOutType;
    // typedef complex_wrapper<double> T_FFTOutType;
    typedef complex_wrapper<double> T_stageInType;
    typedef complex_wrapper<double> T_twiddleType;
    typedef complex_wrapper<double> T_expTabType;
    static const int NO_OF_FFT_STAGES = ssrFFTLog2<t_L>::val / ssrFFTLog2<t_R>::val;
    static const int tp_log2R = ssrFFTLog2<t_R>::val;
    static const unsigned int s = NO_OF_FFT_STAGES - t_stage;
...
struct FFTTraits<t_scalingMode,
                 ...
                 t_R,
                 t_stage,
                 complex_wrapper<ap_fixed<tw_WL, tw_IL> >,
                 complex_wrapper<ap_fixed<expTab_WL, expTab_IL> >,
                 complex_wrapper<ap_fixed<in_WL, in_IL> >,
                 complex_wrapper<ap_fixed<out_WL, out_IL> > > {
    static const int NO_OF_FFT_STAGES = ssrFFTLog2<t_L>::val / ssrFFTLog2<t_R>::val;
    static const int tp_log2R = ssrFFTLog2<t_R>::val;
    static const unsigned int s = NO_OF_FFT_STAGES - t_stage;
    ...
    typedef complex_wrapper<ap_fixed<nextStage_WL, nextStage_IL, AP_TRN, AP_WRAP, 0> > T_stageOutType;
    // typedef complex_wrapper<ap_fixed<out_WL,out_IL,AP_TRN,AP_WRAP,0> >  T_FFTOutType;
    typedef complex_wrapper<ap_fixed<in_WL, in_IL, AP_TRN, AP_WRAP, 0> > T_stageInType;
    typedef complex_wrapper<ap_fixed<tw_WL, tw_IL, AP_TRN, AP_WRAP, 0> > T_twiddleType;
    typedef complex_wrapper<ap_fixed<expTab_WL, expTab_IL, AP_TRN, AP_WRAP, 0> > T_expTabType;
 ...
 **/
/*
template <scaling_mode_enum t_scalingMode, int t_L, int t_R,
    int tw_WL, int tw_IL, int expTab_WL, int expTab_IL, int in_WL,
    int in_IL, int out_WL, int out_IL

>
struct FFTTraits<t_scalingMode, t_L, t_R, 1,
    complex_wrapper<ap_fixed<tw_WL, tw_IL> >,
    complex_wrapper<ap_fixed<expTab_WL, expTab_IL> >,
    complex_wrapper<ap_fixed<in_WL, in_IL> >,
    complex_wrapper<ap_fixed<out_WL, out_IL> > > {

  static const int NO_OF_FFT_STAGES = ssrFFTLog2 < t_L
      > ::val / ssrFFTLog2 < t_R > ::val;
  static const int tp_log2R = ssrFFTLog2 < t_R > ::val;
  static const unsigned int s = NO_OF_FFT_STAGES - t_stage;

  // one extra bit for stage 1
  static const int nextStage_WL = in_WL + tp_log2R + 1;
  // one extra bit for stage 1
  static const int nextStage_IL = in_IL + tp_log2R + 1;

  typedef complex_wrapper<
      ap_fixed<nextStage_WL, nextStage_IL, AP_TRN, AP_WRAP, 0> > T_stageOutType;
  //typedef complex_wrapper<ap_fixed<out_WL,out_IL,AP_TRN,AP_WRAP,0> >  T_FFTOutType;
  typedef complex_wrapper<ap_fixed<in_WL, in_IL, AP_TRN, AP_WRAP, 0> > T_stageInType;
  typedef complex_wrapper<ap_fixed<tw_WL, tw_IL, AP_TRN, AP_WRAP, 0> > T_twiddleType;
  typedef complex_wrapper<ap_fixed<expTab_WL, expTab_IL, AP_TRN, AP_WRAP, 0> > T_expTabType;
...
struct FFTTraits<SSR_FFT_SCALE,
    ...
    typedef complex_wrapper<ap_fixed<nextStage_WL, nextStage_IL, AP_TRN, AP_WRAP, 0> > T_stageOutType;
    // typedef complex_wrapper<ap_fixed<out_WL,out_IL,AP_TRN,AP_WRAP,0> >  ;
    typedef complex_wrapper<ap_fixed<in_WL, in_IL, AP_TRN, AP_WRAP, 0> > T_stageInType;
    typedef complex_wrapper<ap_fixed<tw_WL, tw_IL, AP_TRN, AP_WRAP, 0> > T_twiddleType;
    typedef complex_wrapper<ap_fixed<expTab_WL, expTab_IL, AP_TRN, AP_WRAP, 0> > T_expTabType;
...
struct FFTTraits<SSR_FFT_GROW_TO_MAX_WIDTH, // specialization for max growth scaling mode
    ...
    // replaced//static const int nextStage_IL= ( EXPECTED_NEXT_STAGE_WL <= DSP48_OP2_BIT_WIDTH ) ?
    // EXPECTED_NEXT_STAGE_IL:in_IL+MAX_ALLOWED_BIT_WIDTH_MARGIN;
...
struct FFTTraits<t_scalingMode,
                 ...
                 t_R,
                 t_stage,
                 complex_wrapper<ap_fixed<tw_WL, tw_IL, tw_q_mode, tw_o_mode, tw_sat_bits> >,
                 complex_wrapper<ap_fixed<expTab_WL, expTab_IL, expTab_q_mode, expTab_o_mode, expTab_sat_bits> >,
                 complex_wrapper<ap_fixed<in_WL, in_IL, in_q_mode, in_o_mode, in_sat_bits> >,
                 complex_wrapper<ap_fixed<out_WL, out_IL, out_q_mode, out_o_mode, out_sat_bits> > > {
    static const int NO_OF_FFT_STAGES = ssrFFTLog2<t_L>::val / ssrFFTLog2<t_R>::val;
    static const int tp_log2R = ssrFFTLog2<t_R>::val;
    static const unsigned int s = NO_OF_FFT_STAGES - t_stage;
    ...
    typedef complex_wrapper<ap_fixed<nextStage_WL, nextStage_IL, out_q_mode, out_o_mode, out_sat_bits> > T_stageOutType;

    // typedef complex_wrapper<ap_fixed<out_WL,out_IL,out_q_mode,out_o_mode,out_sat_bits> >
    // T_FFTOutType;
    typedef complex_wrapper<ap_fixed<in_WL, in_IL, in_q_mode, in_o_mode, in_sat_bits> > T_stageInType;
    typedef complex_wrapper<ap_fixed<tw_WL, tw_IL, tw_q_mode, tw_o_mode, tw_sat_bits> > T_twiddleType;
    typedef complex_wrapper<ap_fixed<expTab_WL, expTab_IL, expTab_q_mode, expTab_o_mode, expTab_sat_bits> >
        T_expTabType;
...
//(((2.1))) complex_wrapper < ap_fixed < WL,IL,ap_q_mode, ap_ovf_mode, int sat_bits > >
...
//(((2.2))) complex_wrapper < ap_fixed < WL,IL,ap_q_mode, ap_ovf_mode, int sat_bits > >
...
//(((2.3))) complex_wrapper < ap_fixed < WL,IL,ap_q_mode, ap_ovf_mode, int sat_bits > >
...
struct FFTTraits<SSR_FFT_GROW_TO_MAX_WIDTH,
    ...
    // replaced//static const int nextStage_IL= ( EXPECTED_NEXT_STAGE_WL <= DSP48_OP2_BIT_WIDTH ) ?
    // EXPECTED_NEXT_STAGE_IL:in_WL+MAX_ALLOWED_BIT_WIDTH_MARGIN;
