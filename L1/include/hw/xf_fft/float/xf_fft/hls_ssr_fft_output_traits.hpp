...
#include "xf_fft/hls_ssr_fft_dsp48.hpp"
...
/*
 ...
 1- inner type used for complex_wrapper output
 2- complex type which will be used by output complex_wrapper<ap_fixed<>>
...
template <int t_L,
          ...
          transform_direction_enum transform_direction,
          butterfly_rnd_mode_enum butterfly_rnd_mode>
struct FFTOutputTraits<t_L, t_R, t_scalingMode, transform_direction, butterfly_rnd_mode, complex_wrapper<float> > {
...
template <int t_L,
          ...
          transform_direction_enum transform_direction,
          butterfly_rnd_mode_enum butterfly_rnd_mode>
struct FFTOutputTraits<t_L, t_R, t_scalingMode, transform_direction, butterfly_rnd_mode, complex_wrapper<double> > {
...
struct FFTOutputTraits<t_L,
    ...
    // typedef complex_wrapper<ap_fixed<t_inputSizeBits, t_integerPartBits, AP_TRN, AP_WRAP, 0> > T_FFTOutType;
    // typedef ap_fixed<t_inputSizeBits, t_integerPartBits, AP_TRN, AP_WRAP, 0> T_innerFFTOutType;
    static const int type = 1;
};
template <int t_L,
          int t_R,
...
struct FFTOutputTraits<t_L,
                       ...
                       transform_direction,
                       butterfly_rnd_mode,
                       complex_wrapper<ap_fixed<t_inputSizeBits,
                                                t_integerPartBits,
                                                t_inputQuantizationMode,
                                                t_inputOverflowMode,
                                                t_inNumOfSatBits> > > {
    /*typedef complex_wrapper<
      ap_fixed<t_inputSizeBits, t_integerPartBits, t_inputQuantizationMode, t_inputOverflowMode, t_inNumOfSatBits> >
    T_FFTOutType; typedef ap_fixed<t_inputSizeBits, t_integerPartBits, t_inputQuantizationMode, t_inputOverflowMode,
    t_inNumOfSatBits> T_innerFFTOutType;*/
...
struct FFTOutputTraits<t_L,
    ...
    typedef complex_wrapper<ap_fixed<OUTPUT_WL, OUTPUT_IL, AP_TRN, AP_WRAP, 0> > T_FFTOutType;
...
struct FFTOutputTraits<t_L,
    ...
    typedef complex_wrapper<ap_fixed<t_inputSizeBits, OUTPUT_IL, AP_TRN, AP_WRAP, 0> > T_FFTOutType;
...
struct FFTOutputTraits<t_L,
    ...
    typedef complex_wrapper<ap_fixed<O_WL, O_IL, AP_TRN, AP_WRAP, 0> > T_FFTOutType;
...
struct FFTOutputTraits<t_L,
    ...
    static const int IFFT_SCALING_BITS = (ssrFFTLog2<t_L>::val);
    static const int O_IL = (transform_direction == FORWARD_TRANSFORM) ? O_IL_FFT : O_IL_FFT - IFFT_SCALING_BITS;
    typedef complex_wrapper<ap_fixed<O_WL, O_IL, t_inputQuantizationMode, t_inputOverflowMode, t_inNumOfSatBits> >
        T_FFTOutType;
...
struct FFTScaledOutput<t_L, transform_direction, complex_wrapper<float> > {
    typedef complex_wrapper<float> T_scaledFFTOutputType;
};

//======================== Specialize for double complex type===============
template <int t_L, transform_direction_enum transform_direction>
struct FFTScaledOutput<t_L, transform_direction, complex_wrapper<double> > {
    typedef complex_wrapper<double> T_scaledFFTOutputType;
};
//======================== Specialize for float complex type===============
template <int t_L, transform_direction_enum transform_direction>
struct FFTScaledOutput<t_L, transform_direction, complex_wrapper<int> > {
    typedef complex_wrapper<int> T_scaledFFTOutputType;
};
...
struct FFTScaledOutput<t_L, transform_direction, complex_wrapper<ap_fixed<t_inputSizeBits, t_integerPartBits> > > {
    static const int BITS_TO_SCALE = (transform_direction == REVERSE_TRANSFORM) ? (ssrFFTLog2<t_L>::val) : 0;
    typedef complex_wrapper<ap_fixed<t_inputSizeBits, t_integerPartBits - BITS_TO_SCALE, AP_TRN, AP_WRAP, 0> >
...
struct FFTScaledOutput<t_L,
                       ...
                       complex_wrapper<ap_fixed<t_inputSizeBits,
                                                ...
                                                t_inNumOfSatBits> > > {
    static const int BITS_TO_SCALE = (transform_direction == REVERSE_TRANSFORM) ? (ssrFFTLog2<t_L>::val) : 0;
    typedef complex_wrapper<ap_fixed<t_inputSizeBits,
