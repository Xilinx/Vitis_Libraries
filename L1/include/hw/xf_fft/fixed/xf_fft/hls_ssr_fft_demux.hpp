...
template <unsigned int t_numOfKernels,
          ...
          typename T_elemType>
void demuxWideStreaming(
    typename WideTypeDefs<t_memReadWidth, T_elemType>::WideIFStreamType& p_inWideStream,
    typename WideTypeDefs<t_memReadWidth, T_elemType>::WideIFStreamType p_outWideStream[t_numOfKernels]) {
...
#pragma HLS PIPELINE II = 1 rewind
        ...
        typename WideTypeDefs<t_memReadWidth, T_elemType>::WideIFType wideIFSample = p_inWideStream.read();
#ifdef DEBUG_DEMUX
