...
#pragma HLS STREAM variable = hash_strm depth = 64 dim = 1
    hls::stream<bool> hash_e_strm("hash_e_strm");
#pragma HLS STREAM variable = hash_e_strm depth = 64 dim = 1
    //	#pragma HLS STREAM variable=hash_strm depth=128 dim=1
...
#pragma HLS STREAM variable = chk_hash_strm depth = 64 dim = 1
    hls::stream<bool> chk_hash_e_strm("chk_hash_e_strm");
#pragma HLS STREAM variable = chk_hash_e_strm depth = 64 dim = 1
...
#pragma HLS STREAM variable = hash_strm0 depth = 64 dim = 1
    hls::stream<ap_uint<BV_W> > hash_strm1("hash_strm1");
#pragma HLS STREAM variable = hash_strm1 depth = 64 dim = 1
    hls::stream<ap_uint<BV_W> > hash_strm2("hash_strm2");
#pragma HLS STREAM variable = hash_strm2 depth = 64 dim = 1
    hls::stream<bool> hash_e_strm("hash_e_strm");
#pragma HLS STREAM variable = hash_e_strm depth = 64 dim = 1
