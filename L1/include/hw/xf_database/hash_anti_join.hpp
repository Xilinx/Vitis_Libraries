...
void anti_probe_htb(ap_uint<32>& depth,
...
void anti_probe_wrapper(ap_uint<32>& depth,
...
#pragma HLS resource variable = e1_strm core = FIFO_SRL
    ...
    anti_probe_htb<HASHW, KEYW, PW, T_PW, ARW>(depth, i_hash_strm, i_key_strm, i_pld_strm, i_e_strm,
...
// probe
    ...
    anti_probe_wrapper<HASHWL, KEYW, PW, S_PW, T_PW, ARW>(depth,
...
/// @brief compare the same hash value, if key not match, output row
template <int KEYW, int S_PW, int T_PW, int ARW>
void join_unit_1(ap_uint<32>& join_depth,
                 // input large table
...
#pragma HLS PIPELINE II = 1
            ...
            if (s1_key != t1_key) flag1++;
            if (nm_1 == flag1) {
                j1(KEYW + S_PW + T_PW - 1, S_PW + T_PW) = t1_key;
                if (S_PW > 0) {
                    j1(S_PW + T_PW - 1, T_PW) = 0;
                }
                if (T_PW > 0) {
                    j1(T_PW - 1, 0) = t1_pld;
                }
                ...
                o1_j_strm.write(j1);
                o1_e_strm.write(false);
            }
        }
    }
    o1_j_strm.write(0);
    o1_e_strm.write(true);
}

/// @brief output unequel hash value row
...
/// @brief split t_strm to hash hit stream and hash unhit stream
...
/// @brief comebine hash hit stream and hash unhit stream output
...
#pragma HLS array_partition variable = j_arr dim = 1
    ...
    do {
#pragma HLS pipeline II = 1
        empty_e[0] = !o1_e_strm.empty() && !last[0];
        empty_e[1] = !o2_e_strm.empty() && !last[1];

        rd_e[0] = (bool)empty_e[0];
        rd_e[1] = empty_e[0] > 0 ? (bool)0 : (bool)empty_e[1];

        if (rd_e[0]) {
            j_arr[0] = o1_j_strm.read();
            last[0] = o1_e_strm.read();
        }

        if (rd_e[1]) {
            j_arr[1] = o2_j_strm.read();
            last[1] = o2_e_strm.read();
        }

        ap_uint<1> id = join_v2::mux<2>(rd_e);
...
/// @brief top function of anti_join unit
...
#pragma HLS DATAFLOW
    ...
    hls::stream<ap_uint<KEYW> > i1_t_key_strm;
#pragma HLS STREAM variable = i1_t_key_strm depth = 512
#pragma HLS resource variable = i1_t_key_strm core = FIFO_BRAM
    hls::stream<ap_uint<T_PW> > i1_t_pld_strm;
#pragma HLS STREAM variable = i1_t_pld_strm depth = 512
#pragma HLS resource variable = i1_t_pld_strm core = FIFO_BRAM
    hls::stream<ap_uint<ARW> > i1_nm_strm;
#pragma HLS STREAM variable = i1_nm_strm depth = 512
#pragma HLS resource variable = i1_nm_strm core = FIFO_BRAM
    hls::stream<bool> i1_e0_strm;
#pragma HLS STREAM variable = i1_e0_strm depth = 512
#pragma HLS resource variable = i1_e0_strm core = FIFO_SRL
    hls::stream<ap_uint<KEYW> > i2_t_key_strm;
#pragma HLS STREAM variable = i2_t_key_strm depth = 512
#pragma HLS resource variable = i2_t_key_strm core = FIFO_BRAM
    hls::stream<ap_uint<T_PW> > i2_t_pld_strm;
#pragma HLS STREAM variable = i2_t_pld_strm depth = 512
#pragma HLS resource variable = i2_t_pld_strm core = FIFO_BRAM
    hls::stream<ap_uint<ARW> > i2_nm_strm;
#pragma HLS STREAM variable = i2_nm_strm depth = 512
#pragma HLS resource variable = i2_nm_strm core = FIFO_BRAM
    hls::stream<bool> i2_e0_strm;
#pragma HLS STREAM variable = i2_e0_strm depth = 512
#pragma HLS resource variable = i2_e0_strm core = FIFO_SRL
    hls::stream<ap_uint<KEYW + S_PW + T_PW> > o1_j_strm("j1");
#pragma HLS STREAM variable = o1_j_strm depth = 512
#pragma HLS resource variable = o1_j_strm core = FIFO_BRAM
    hls::stream<bool> o1_e_strm("b1");
#pragma HLS STREAM variable = o1_e_strm depth = 512
#pragma HLS resource variable = o1_e_strm core = FIFO_SRL
    hls::stream<ap_uint<KEYW + S_PW + T_PW> > o2_j_strm("j2");
#pragma HLS STREAM variable = o2_j_strm depth = 512
#pragma HLS resource variable = o2_j_strm core = FIFO_BRAM
    hls::stream<bool> o2_e_strm("b2");
#pragma HLS STREAM variable = o2_e_strm depth = 512
#pragma HLS resource variable = o2_e_strm core = FIFO_SRL

    split_stream<KEYW, S_PW, T_PW, ARW>(i_t_key_strm, i_t_pld_strm, i_nm_strm, i_e0_strm, i1_t_key_strm, i1_t_pld_strm,
                                        i1_nm_strm, i1_e0_strm, i2_t_key_strm, i2_t_pld_strm, i2_nm_strm, i2_e0_strm);

    join_unit_1<KEYW, S_PW, T_PW, ARW>(depth, i1_t_key_strm, i1_t_pld_strm, i1_nm_strm, i1_e0_strm, i_base_s_key_strm,
                                       i_base_s_pld_strm, i_overflow_s_key_strm, i_overflow_s_pld_strm, o1_j_strm,
                                       o1_e_strm);
    join_unit_2<KEYW, S_PW, T_PW, ARW>(i2_t_key_strm, i2_t_pld_strm, i2_nm_strm, i2_e0_strm, o2_j_strm, o2_e_strm);

    combine_stream<KEYW, S_PW, T_PW, ARW>(o1_j_strm, o1_e_strm, o2_j_strm, o2_e_strm, o_j_strm, o_e_strm);
...
#pragma HLS unroll
...
#endif
#endif
        details::hash_anti_join::build_merge_anti_probe_wrapper<HASH_MODE, HASHWH, HASHWL, KEYW, S_PW, B_PW, ARW>(
            // input status
            depth,
    ...
    for (int i = 0; i < PU; i++) {
#pragma HLS unroll
        details::hash_anti_join::anti_join_unit<KEYW, S_PW, B_PW, ARW>(
#ifndef __SYNTHESIS__
            i,
#endif
...
#endif // !defined(XF_DATABASE_HASH_ANTI_JOIN_H)
