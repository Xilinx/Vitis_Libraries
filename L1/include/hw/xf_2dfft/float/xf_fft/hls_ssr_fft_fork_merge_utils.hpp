...
#pragma HLS INLINE off
    ...
    //#pragma HLS DATA_PACK variable=p_outStreamArray
    ...
    // SuperSampleContainer< t_R/t_forkingFactor , T_dtype > temp_factored_array[t_forkingFactor];
    ...
    /////////////////////// Read input Sample Stream of size t_R ////////////////////
    //////////////////////////////////////////////////////////////////////////////////

    ////////////////////// Split t_R size single stream to t_forkingFactor streamS //////
...
#pragma HLS UNROLL
            ...
            for (int sample_no = 0; sample_no < t_R / t_forkingFactor; sample_no++) {
#pragma HLS UNROLL
                // super_sample_sample_out.superSample[fork_no*fork_size +
                // sample_no]=sub_sample_in.superSample[sample_no];
                super_sample_sample_out.superSample[(sample_no << (ssrFFTLog2<t_forkingFactor>::val)) + fork_no] =
                    sub_sample_in.superSample[sample_no];

                // p_out[(r<<(ssrFFTLog2<t_forkingFactor>::val)) + t_forkNumber-1]=p_in[r];
            }
        }
