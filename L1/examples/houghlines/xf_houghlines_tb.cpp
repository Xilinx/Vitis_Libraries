...
static ap_fixed<16, 1, AP_RND> sinvalt[360] = {
...
static ap_fixed<16, 1, AP_RND> cosvalt[360] = {
...
void xiHoughLinesstandardfixed(cv::Mat& img,
                               std::vector<cv::Vec2f>& lines,
                               float rho,
                               float theta,
                               int threshold,
...
int main(int argc, char** argv) {
    ...
    xiHoughLinesstandard(dst, lines, RHOSTEP, angleref, threshold, maxlines, MAXTHETA,
                         MINTHETA); // Fixed point reference code
