...
set_top top_fft2d
add_files src/top_2d_fft_test.cpp -cflags "-I../../include/hw/vitis_2dfft/fixed/"
add_files -tb src/main_2d_fft_test.cpp -cflags "-I../../include/hw/vitis_2dfft/fixed/"
add_files -tb src/top_2d_fft_test.cpp -cflags "-I../../include/hw/vitis_2dfft/fixed/"
