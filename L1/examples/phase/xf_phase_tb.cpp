...
int main(int argc, char** argv) {
    ...
    static xf::cv::Mat<XF_16SC1, HEIGHT, WIDTH, NPC1> imgInputx(in_gray.rows, in_gray.cols);
    static xf::cv::Mat<XF_16SC1, HEIGHT, WIDTH, NPC1> imgInputy(in_gray.rows, in_gray.cols);
    static xf::cv::Mat<XF_16SC1, HEIGHT, WIDTH, NPC1> imgOutput(in_gray.rows, in_gray.cols);
