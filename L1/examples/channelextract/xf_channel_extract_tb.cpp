...
int main(int argc, char** argv) {
    ...
    static xf::cv::Mat<XF_8UC4, HEIGHT, WIDTH, XF_NPPC1> imgInput(in_rgba.rows, in_rgba.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1> imgOutput(in_rgba.rows, in_rgba.cols);
    ...
    xf::cv::absDiff(bgr_planes[2], imgOutput, diff);
