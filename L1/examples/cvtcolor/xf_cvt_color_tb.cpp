...
int main(int argc, char** argv) {
    ...
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgInput0(inputimg0.rows, inputimg0.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, NPC1> imgInput1(inputimg1.rows, inputimg1.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, NPC1> imgInput2(inputimg2.rows, inputimg2.cols);

    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight_y, newwidth_y);
    static xf::cv::Mat<XF_8UC2, HEIGHT / 2, WIDTH / 2, NPC2> imgOutput1(newheight_uv, newwidth_uv);
    ...
    xf::cv::imwrite("out_Y.png", imgOutput0);
    xf::cv::imwrite("out_UV.png", imgOutput1);
    ...
    static xf::cv::Mat<XF_8UC4, HEIGHT, WIDTH, NPC1> imgOutput0(inputimg0.rows, inputimg0.cols);
    //#endif
    //#if RO
    imgInput0.copyTo(inputimg0.data);
    imgInput1.copyTo(inputimg1.data);
...
#if NO
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1> imgInput0(inputimg0.rows, inputimg0.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, XF_NPPC1> imgInput1(inputimg1.rows, inputimg1.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, XF_NPPC1> imgInput2(inputimg2.rows, inputimg2.cols);

    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, XF_NPPC1> imgOutput0(inputimg0.rows, inputimg0.cols);
    ...
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight_y, newwidth_y);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput1(newheight_u, newwidth_u);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput2(newheight_v, newwidth_v);
    ...
    xf::cv::imwrite("out_Y.png", imgOutput0);
    xf::cv::imwrite("out_U.png", imgOutput1);
    xf::cv::imwrite("out_V.png", imgOutput2);
    ...
    xf::cv::absDiff(refimage0, imgOutput0, error_img0);
    xf::cv::absDiff(refimage1, imgOutput1, error_img1);
    xf::cv::absDiff(refimage2, imgOutput2, error_img2);
    ...
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgInput0(inputimg0.rows, inputimg0.cols);
    static xf::cv::Mat<XF_8UC2, HEIGHT / 2, WIDTH / 2, NPC2> imgInput1(inputimg1.rows, inputimg1.cols);

    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight_y, newwidth_y);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, NPC1> imgOutput1(newheight_u_v, newwidth_u_v);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, NPC1> imgOutput2(newheight_u_v, newwidth_u_v);
    ...
    xf::cv::absDiff(refimg0, imgOutput0, error_img0);
    xf::cv::absDiff(refimg1, imgOutput1, error_img1);
    xf::cv::absDiff(refimg2, imgOutput2, error_img2);
    ...
    static xf::cv::Mat<XF_8UC4, HEIGHT, WIDTH, NPC1> imgOutput0(newheight, newwidth);
    ...
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgOutput0(newheight, newwidth);

    imgInput0.copyTo(inputimg0.data);
    imgInput1.copyTo((unsigned short int*)inputimg1.data);

    if (NV122RGB) cvtcolor_nv122rgb(imgInput0, imgInput1, imgOutput0);
    if (NV122BGR) cvtcolor_nv122bgr(imgInput0, imgInput1, imgOutput0);
    ...
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight_y, newwidth_y);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput1(newheight_u_v, newwidth_u_v);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput2(newheight_u_v, newwidth_u_v);
    ...
    static xf::cv::Mat<XF_16UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight_uyvy, newwidth_uyvy);
    ...
    if (NV122NV21) cvtcolor_nv122nv21(imgInput0, imgInput1, imgOutput0, imgOutput1);
    if (NV212NV12) cvtcolor_nv212nv12(imgInput0, imgInput1, imgOutput0, imgOutput1);
    ...
    xf::cv::imwrite("out_uyvy.png", imgOutput0);
    ...
    xf::cv::imwrite("out_yuyv.png", imgOutput0);
    ...
    if (NV212RGB) cvtcolor_nv212rgb(imgInput0, imgInput1, imgOutput0);
    if (NV212BGR) cvtcolor_nv212bgr(imgInput0, imgInput1, imgOutput0);
    ...
    static xf::cv::Mat<XF_8UC4, HEIGHT, WIDTH, NPC1> imgInput(inputimg.rows, inputimg.cols);
    ...
    static xf::cv::Mat<XF_8UC4, HEIGHT, WIDTH, NPC1> imgInput(inputimg0.rows, inputimg0.cols);
    ...
    xf::cv::imwrite("out_Y.png", imgOutput0);
    xf::cv::imwrite("out_VU.png", imgOutput1);
    ...
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgInput(inputimg.rows, inputimg.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight_y, newwidth_y);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, NPC1> imgOutput1(newheight_u_v, newwidth_u_v);
    static xf::cv::Mat<XF_8UC1, HEIGHT / 4, WIDTH, NPC1> imgOutput2(newheight_u_v, newwidth_u_v);
    ...
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgInput(inputimg0.rows, inputimg0.cols);
    ...
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgInput(inputimg0.rows, inputimg0.cols);
    static xf::cv::Mat<XF_16UC1, HEIGHT, WIDTH, NPC1> imgOutput0(height_uyvy, width_uyvy);
    ...
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgInput(inputimg0.rows, inputimg0.cols);
    static xf::cv::Mat<XF_16UC1, HEIGHT, WIDTH, NPC1> imgOutput0(height_yuyv, width_yuyv);
    ...
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgInput(inputimg0.rows, inputimg0.cols);
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgOutput0(height, width);
    ...
    xf::cv::imwrite("out_bgr.png", imgOutput0);
...
//	fclose(fp1);
    ...
    static xf::cv::Mat<XF_16UC1, HEIGHT, WIDTH, NPC1> imgInput(inputimg.rows, inputimg.cols);
    ...
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight_y, newwidth_y);
    static xf::cv::Mat<XF_8UC2, HEIGHT / 2, WIDTH / 2, NPC2> imgOutput1(newheight_u_v, newwidth_u_v);
    ...
    static xf::cv::Mat<XF_16UC1, HEIGHT, WIDTH, NPC1> imgOutput0(newheight, newwidth);

    imgInput.copyTo((unsigned short int*)inputimg.data);

    if (UYVY2YUYV) cvtcolor_uyvy2yuyv(imgInput, imgOutput0);
    if (YUYV2UYVY) cvtcolor_yuyv2uyvy(imgInput, imgOutput0);
    ...
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgInput(inputimg.rows, inputimg.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgOutput(outputimg.rows, outputimg.cols);
    ...
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPC1> imgInput(inputimg.rows, inputimg.cols);
    static xf::cv::Mat<XF_8UC3, HEIGHT, WIDTH, NPC1> imgOutput(outputimg.rows, outputimg.cols);
...
// xf::cv::analyzeDiff(error_img0,ERROR_THRESHOLD,err_per);
