...
int main(int argc, char** argv) {
    ...
    static xf::cv::Mat<IN_T, HEIGHT, WIDTH, XF_NPPC1> imgInputL(height, width);
    static xf::cv::Mat<IN_T, HEIGHT, WIDTH, XF_NPPC1> imgInputR(height, width);

    static xf::cv::Mat<OUT_T, HEIGHT, WIDTH, XF_NPPC1> imgOutput(height, width);
    imgInputL = xf::cv::imread<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1>(argv[1], 0);
    imgInputR = xf::cv::imread<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1>(argv[2], 0);
    ...
    xf::cv::absDiff(disp_mat, imgOutput, diff);
