...
int main(int argc, char* argv[]) {
    ...
    static xf::cv::Mat<XF_8UC4, XF_HEIGHT, XF_WIDTH, XF_NPPC1> inMat(frame.rows, frame.cols);
    ...
    for (int f_no = 1; f_no <= no_of_frames; f_no++) {
        ...
        mean_shift_accel(inMat, tlx, tly, obj_height, obj_width, dx, dy, track, frame_status, no_objects,
                         no_of_iterations);
