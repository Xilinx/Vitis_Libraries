...
void test_hmac_md5(hls::stream<ap_uint<KEYW> >& keyStrm,
                   ...
                   hls::stream<bool>& eHshStrm) {
    xf::security::hmac<KEYW, MSGW, LENW, HSHW, BLOCK_SIZE, md5_wrapper>(keyStrm, lenKeyStrm, msgStrm, lenStrm, eLenStrm,
                                                                        hshStrm, eHshStrm);
}
...
#pragma HLS stream variable = endHshStrm depth = 128
    ...
    // call fpga module
    test_hmac_md5(keyStrm, lenKeyStrm, msgStrm, lenMsgStrm, endLenStrm, hshStrm, endHshStrm);
