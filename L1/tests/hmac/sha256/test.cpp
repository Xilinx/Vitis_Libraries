...
void test_hmac_sha256(hls::stream<ap_uint<KEYW> >& keyStrm,
                      ...
                      hls::stream<bool>& eHshStrm) {
    xf::security::hmac<KEYW, MSGW, LENW, HSHW, BLOCK_SIZE, sha256_wrapper>(keyStrm, lenKeyStrm, msgStrm, lenStrm,
...
#pragma HLS stream variable = endHshStrm depth = 128
    ...
    // call fpga module
    test_hmac_sha256(keyStrm, lenKeyStrm, msgStrm, lenMsgStrm, endLenStrm, hshStrm, endHshStrm);
