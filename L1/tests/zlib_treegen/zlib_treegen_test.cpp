...
void treegenMM(hls::stream<uint32_t>& lz77OutStreamTree,
    ...
    // treegenMain(ltree_freq, dtree_freq, CodeStream, CodeSize);
...
void zlibDecompress(hls::stream<ap_uint<16> >& inStream,
    ...
    xf::compression::details::inflateMultiByteCore<c_decoderType, 1>(inStream, outStream, outStreamEoS, outSizeStream,
                                                                     input_size);
    // read extra data
