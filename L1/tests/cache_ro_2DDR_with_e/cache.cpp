...
#pragma HLS INTERFACE s_axilite port = ddrMem1 bundle = control
    ...
    xf::common::utils_hw::cache<ap_uint<BUSDATAWIDTH>, RAMROW, GRPRAM, EACHLINE, BUSADDRWIDTH, 2, 2, 2> dut;

    dut.initDualOffChip();

    dut.readOnly(ddrMem0, ddrMem1, raddrStrm, e_raddrStrm, rdataStrm0, e_rdataStrm0, rdataStrm1, e_rdataStrm1);
}
