...
add_files ${XF_PROJ_ROOT}/L1/tests/hw/amin/uut_top.cpp                    -cflags "-I${XF_PROJ_ROOT}/L1/include/hw -g -O0 -std=c++11                     -BLAS_L1=true -DBLAS_opName=amin -DBLAS_vectorSize=1024 -DBLAS_dataType=uint16_t -DBLAS_resDataType=int32_t -DBLAS_logParEntries=2     -DBLAS_parEntries=4"
