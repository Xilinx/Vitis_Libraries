...
add_files ${XF_PROJ_ROOT}/L1/tests/hw/copy/uut_top.cpp                    -cflags "-I${XF_PROJ_ROOT}/L1/include/hw -g -O0 -std=c++11                     -BLAS_L1=true -DBLAS_opName=copy -DBLAS_vectorSize=4096 -DBLAS_dataType=double -DBLAS_resDataType=double -DBLAS_logParEntries=3     -DBLAS_parEntries=8"
