...
params:
	...
	@echo "#define MaxD   ${HEIGHT}"		>> params.hpp 
...
case_gen: data_gen params
	...
	python ${DES_SCRIPT} --func laplacian --testDir ${TEST_DIR} 
...
data_gen:
	python ${PYTHON_SCRIPT} --func testLaplacian --path ${TEST_DIR}/data/ --width ${WIDTH} --depth ${HEIGHT} --nxb ${NXB} --nzb ${NZB} --time ${NT} --order ${ORDER}
