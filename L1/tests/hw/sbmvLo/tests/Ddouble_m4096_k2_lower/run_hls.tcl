...
add_files ${XF_PROJ_ROOT}/L1/tests/hw/sbmvLo/uut_top.cpp                    -cflags "-I${XF_PROJ_ROOT}/L1/include/hw -g -O0 -std=c++11                     -DBLAS_L2=true -DBLAS_opName=sbmv -DBLAS_resDataType=uint32_t             -DBLAS_vectorSize=4096 -DBLAS_matrixSize=16777216    -DBLAS_memorySize=12288 -DBLAS_dataType=double -DBLAS_logParEntries=-1    -DBLAS_parEntries=4"
...
if {$CSIM == 1} {
  csim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/sbmvLo/tests/Ddouble_m4096_k2_lower/TestBin.bin"
}
if {$CSYNTH == 1} {
  csynth_design
}
if {$COSIM == 1} {
  cosim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/sbmvLo/tests/Ddouble_m4096_k2_lower/TestBin.bin"
}
if {$VIVADO_SYN == 1} {
