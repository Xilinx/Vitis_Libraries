...
#pragma HLS DATAFLOW
    tbmSuper2Stream<BLAS_dataType, BLAS_parEntries>(p_n, p_ku, p_a, l_strA);
    vec2TbUpMatStream<BLAS_dataType, BLAS_parEntries>(p_n, p_ku, p_x, l_strX);
    readVec2Stream<BLAS_dataType, BLAS_parEntries>(p_y, p_m, l_strY);
    gbmv<BLAS_dataType, BLAS_parEntries, BLAS_vectorSize>(p_m, p_n, p_ku, 0, p_alpha, l_strA, l_strX, p_beta, l_strY,
                                                          l_strYR);
