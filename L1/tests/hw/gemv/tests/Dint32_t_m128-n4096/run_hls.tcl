...
add_files ${XF_PROJ_ROOT}/L1/tests/hw/gemv/uut_top.cpp                    -cflags "-I${XF_PROJ_ROOT}/L1/include/hw -g -O0 -std=c++11                     -DBLAS_L2=true -DBLAS_opName=gemv -DBLAS_resDataType=uint32_t             -DBLAS_vectorSize=4096 -DBLAS_matrixSize=524288    -DBLAS_memorySize=524288 -DBLAS_dataType=int32_t -DBLAS_logParEntries=2    -DBLAS_parEntries=4"
...
if {$CSIM == 1} {
  csim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/gemv/tests/Dint32_t_m128-n4096/TestBin.bin"
}
if {$CSYNTH == 1} {
  csynth_design
}
if {$COSIM == 1} {
  cosim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/gemv/tests/Dint32_t_m128-n4096/TestBin.bin"
}
if {$VIVADO_SYN == 1} {
