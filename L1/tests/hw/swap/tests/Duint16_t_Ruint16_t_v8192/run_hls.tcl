...
add_files ${XF_PROJ_ROOT}/L1/tests/hw/swap/uut_top.cpp                    -cflags "-I${XF_PROJ_ROOT}/L1/include/hw                    -I${XF_PROJ_ROOT}/L1/include/hw/xf_blas                    -I${XF_PROJ_ROOT}/L1/tests/hw -std=c++11  -DBLAS_L1=true -DBLAS_opName=swap -DBLAS_vectorSize=8192    -DBLAS_dataType=uint16_t -DBLAS_resDataType=uint16_t -DBLAS_logParEntries=3     -DBLAS_parEntries=8"
