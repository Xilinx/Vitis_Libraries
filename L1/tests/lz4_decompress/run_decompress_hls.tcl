...
if {$CSIM == 1} {
  csim_design -O -argv "${XF_PROJ_ROOT}common/data/sample.txt.lz4 ${XF_PROJ_ROOT}common/data/sample.txt"
}
...
if {$COSIM == 1} {
  cosim_design -O -argv "${XF_PROJ_ROOT}common/data/sample.txt.lz4 ${XF_PROJ_ROOT}common/data/sample.txt"
}
