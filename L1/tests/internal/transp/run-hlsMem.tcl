...
set_top uut_transpMat 
add_files $pwd/internal/transp/test_memTransp.cpp -cflags "$CFLAGS_K"
add_files -tb $pwd/internal/transp/test_memTransp.cpp -cflags "$CFLAGS_H"
