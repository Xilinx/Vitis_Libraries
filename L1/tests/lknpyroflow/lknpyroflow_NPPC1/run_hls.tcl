...
if {$CSIM == 1} {
  csim_design -compiler gcc -argv " ${XF_PROJ_ROOT}/L1/examples/lknpyroflow/data/im0.png ${XF_PROJ_ROOT}/L1/examples/lknpyroflow/data/im1.png " -clean
}
...
if {$COSIM == 1} {
  cosim_design -argv " ${XF_PROJ_ROOT}/L1/examples/lknpyroflow/data/im0.png ${XF_PROJ_ROOT}/L1/examples/lknpyroflow/data/im1.png "
}
