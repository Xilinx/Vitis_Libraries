...
void SidebySidePrintComplexNumArrays(complex_wrapper<tt_dtype> in[p_rows][p_cols],
                                     complex_wrapper<tt_dtype> in2[p_rows][p_cols]) {
...
void SidebySidePrintComplexNumArrays(complex_wrapper<tt_dtype1> in[p_rows][p_cols],
                                     complex_wrapper<tt_dtype2> in2[p_rows][p_cols]) {
    std::cout << "\n\n################### Printing Arrays Side by Side for Comparison ##############" << std::endl;
    for (int i = 0; i < p_rows; i++)
        for (int j = 0; j < p_cols; j++) {
            // in[i][j] = i*(R)+j;
...
void printComplexNumArray(complex_wrapper<tt_dtype> in[p_rows][p_cols]) {
    std::cout << "###################" << std::endl;
    for (int j = 0; j < p_cols; j++)
        for (int i = 0; i < p_rows; i++) {
            // in[i][j] = i*(R)+j;
...
void printComplexNumArray1D(complex_wrapper<tt_dtype> in[p_rows]) {
    std::cout << "###################" << std::endl;
    for (int i = 0; i < p_rows; i++) {
        // in[i][j] = i*(R)+j;
        std::cout << "[" << i << "]"
