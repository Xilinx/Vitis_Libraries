...
#
 NIMBIX_XSA_xilinx_adm-pcie-ku3_2ddr-xpr = nx1
 NIMBIX_XSA_xilinx_adm-pcie-7v3_1ddr = nx2
 NIMBIX_XSA_xilinx_xil-accel-rd-ku115_4ddr-xpr = nx3
 NIMBIX_XSA_xilinx_xil-accel-rd-vu9p_4ddr-xpr = nx4
#
 xsa2type = $(NIMBIX_XSA_$(call sanitize_xsa,$(1)))
#
 nimbix_RUNNER = $(COMMON_REPO)/utility/nimbix/nimbix-run.py $(NIMBIXFLAGS) --type $(call xsa2type,$(1)) --
...
.PHONY: $(1)_$(2)_$(call device2sanxsa,$(3))_check
$(1)_$(2)_$(call device2sanxsa,$(3))_check: $($(1)_DEPS) $($(1)_EXE) $(foreach xclbin,$($(1)_XCLBINS),$(XCLBIN_DIR)/$(xclbin).$(2).$(call device2sanxsa,$(3)).xclbin)
ifneq ($(2),hw)
	$(EMCONFIGUTIL) --platform $(3) --nd $(NUM_DEVICES)
endif
ifdef $(1)_$(2)_$(call device2sanxsa,$(3))_ARGS
	$(call loader,$(2),$(3)) ./$($(1)_EXE) $($(1)_$(2)_$(call device2sanxsa,$(3))_ARGS)
else
ifdef $(1)_$(call device2sanxsa,$(3))_ARGS
	$(call loader,$(2),$(3)) ./$($(1)_EXE) $($(1)_$(call device2sanxsa,$(3))_ARGS)
else
ifdef $(1)_$(2)_ARGS
...
CHECK_GOALS += $(1)_$(2)_$(call device2sanxsa,$(3))_check
