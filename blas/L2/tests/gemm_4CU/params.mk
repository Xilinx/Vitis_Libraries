...
GEN_BIN_PROGRAM=gemm 128 128 128 128 128 128 128 1 0 A B C X
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	XCL_EMULATION_MODE=$(TARGET) $(API_GEMM_EXE) $(BUILD_DIR)/blas.xclbin 128 128 128 128 128 128 128 1 0
else
	${API_GEMM_EXE} $(BUILD_DIR)/blas.xclbin 2048 2048 2048 2048 2048 2048 2048 1 0
endif
...
check: dump_config
	...
	${GEN_BIN_EXE} -read ${DATA_DIR}/app_out1.bin  > ${DATA_DIR}/app_out1.txt
	cmp -i 8192 ${APP_GOLD_BIN} ${DATA_DIR}/app_out1.bin || ${GEN_BIN_EXE} -compare 1e-3 3e-6 ${APP_GOLD_BIN} ${DATA_DIR}/app_out1.bin
	${GEN_BIN_EXE} -read ${DATA_DIR}/app_out2.bin  > ${DATA_DIR}/app_out2.txt
	cmp -i 8192 ${APP_GOLD_BIN} ${DATA_DIR}/app_out2.bin || ${GEN_BIN_EXE} -compare 1e-3 3e-6 ${APP_GOLD_BIN} ${DATA_DIR}/app_out2.bin
	${GEN_BIN_EXE} -read ${DATA_DIR}/app_out3.bin  > ${DATA_DIR}/app_out3.txt
	cmp -i 8192 ${APP_GOLD_BIN} ${DATA_DIR}/app_out3.bin || ${GEN_BIN_EXE} -compare 1e-3 3e-6 ${APP_GOLD_BIN} ${DATA_DIR}/app_out3.bin
