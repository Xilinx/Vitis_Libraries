...
set PROJ "asum_Duint16_t_Ruint16_t_v8192_test.prj"
set SOLN "sol"
...
if {$CSIM == 1} {
  csim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/asum/tests/Duint16_t_Ruint16_t_v8192/TestBin.bin"
}
...
if {$COSIM == 1} {
  cosim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/asum/tests/Duint16_t_Ruint16_t_v8192/TestBin.bin"
}
