...
if {$CSIM == 1} {
  csim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/tpmvLo/tests/Dint32_t_m16_lower/TestBin.bin"
}
if {$CSYNTH == 1} {
  csynth_design
}
if {$COSIM == 1} {
  cosim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/tpmvLo/tests/Dint32_t_m16_lower/TestBin.bin"
}
if {$VIVADO_SYN == 1} {
