...
/* This file comes from open source QuantLib, https://github.com/lballabio/QuantLib.git. The license for it is
 * BSD-3-Clause.
 * This file is used by XILINX as a reference.
 * In order to simplify its usage, some modification is added to the source file, such as change the data type, remove
 * some not used codes.
...
static const long PrimitivePolynomialDegree01[] = {0, /* x+1 (1)(1) */
                                                   -1};

static const long PrimitivePolynomialDegree02[] = {1, /* x^2+x+1 (1)1(1) */
                                                   -1};

static const long PrimitivePolynomialDegree03[] = {1, /* x^3    +x+1 (1)01(1) */
                                                   2, /* x^3+x^2  +1 (1)10(1) */
                                                   -1};

static const long PrimitivePolynomialDegree04[] = {1, /* x^4+       +x+1 (1)001(1) */
                                                   4, /* x^4+x^3+     +1 (1)100(1) */
                                                   -1};

static const long PrimitivePolynomialDegree05[] = {2,  /* x^5        +x^2  +1 (1)0010(1) */
...
static const long PrimitivePolynomialDegree06[] = {1,  /* x^6                +x+1 (1)00001(1) */
...
static const long PrimitivePolynomialDegree07[] = {1,  /* x^7                    +x+1 (1)000001(1) */
...
static const long PrimitivePolynomialDegree08[] = {14, 21, 22, 38, 47,  49,  50,  52, 56,
                                                   67, 70, 84, 97, 103, 115, 122, -1};

static const long PrimitivePolynomialDegree09[] = {8,   13,  16,  22,  25,  44,  47,  52,  55,  59,  62,  67,  74,
                                                   81,  82,  87,  91,  94,  103, 104, 109, 122, 124, 137, 138, 143,
                                                   145, 152, 157, 167, 173, 176, 181, 182, 185, 191, 194, 199, 218,
                                                   220, 227, 229, 230, 234, 236, 241, 244, 253, -1};

static const long PrimitivePolynomialDegree10[] = {
    4,   13,  19,  22,  50,  55,  64,  69,  98,  107, 115, 121, 127, 134, 140, 145, 152, 158, 161, 171, 181, 194, 199,
    203, 208, 227, 242, 251, 253, 265, 266, 274, 283, 289, 295, 301, 316, 319, 324, 346, 352, 361, 367, 382, 395, 398};

#define N_ALT_MAX_DEGREE 10

const long* const AltPrimitivePolynomials[N_ALT_MAX_DEGREE] = {
    PrimitivePolynomialDegree01, PrimitivePolynomialDegree02, PrimitivePolynomialDegree03, PrimitivePolynomialDegree04,
    PrimitivePolynomialDegree05, PrimitivePolynomialDegree06, PrimitivePolynomialDegree07, PrimitivePolynomialDegree08,
    PrimitivePolynomialDegree09, PrimitivePolynomialDegree10};
...
const unsigned int* const JoeKuoD6initializers[21200] = {
    dim1JoeKuoD6Init,   dim2JoeKuoD6Init,   dim3JoeKuoD6Init,   dim4JoeKuoD6Init,   dim5JoeKuoD6Init,
    dim6JoeKuoD6Init,   dim7JoeKuoD6Init,   dim8JoeKuoD6Init,   dim9JoeKuoD6Init,   dim10JoeKuoD6Init,
    dim11JoeKuoD6Init,  dim12JoeKuoD6Init,  dim13JoeKuoD6Init,  dim14JoeKuoD6Init,  dim15JoeKuoD6Init,
    dim16JoeKuoD6Init,  dim17JoeKuoD6Init,  dim18JoeKuoD6Init,  dim19JoeKuoD6Init,  dim20JoeKuoD6Init,
    dim21JoeKuoD6Init,  dim22JoeKuoD6Init,  dim23JoeKuoD6Init,  dim24JoeKuoD6Init,  dim25JoeKuoD6Init,
    dim26JoeKuoD6Init,  dim27JoeKuoD6Init,  dim28JoeKuoD6Init,  dim29JoeKuoD6Init,  dim30JoeKuoD6Init,
    dim31JoeKuoD6Init,  dim32JoeKuoD6Init,  dim33JoeKuoD6Init,  dim34JoeKuoD6Init,  dim35JoeKuoD6Init,
    dim36JoeKuoD6Init,  dim37JoeKuoD6Init,  dim38JoeKuoD6Init,  dim39JoeKuoD6Init,  dim40JoeKuoD6Init,
    dim41JoeKuoD6Init,  dim42JoeKuoD6Init,  dim43JoeKuoD6Init,  dim44JoeKuoD6Init,  dim45JoeKuoD6Init,
    dim46JoeKuoD6Init,  dim47JoeKuoD6Init,  dim48JoeKuoD6Init,  dim49JoeKuoD6Init,  dim50JoeKuoD6Init,
    dim51JoeKuoD6Init,  dim52JoeKuoD6Init,  dim53JoeKuoD6Init,  dim54JoeKuoD6Init,  dim55JoeKuoD6Init,
    dim56JoeKuoD6Init,  dim57JoeKuoD6Init,  dim58JoeKuoD6Init,  dim59JoeKuoD6Init,  dim60JoeKuoD6Init,
    dim61JoeKuoD6Init,  dim62JoeKuoD6Init,  dim63JoeKuoD6Init,  dim64JoeKuoD6Init,  dim65JoeKuoD6Init,
    dim66JoeKuoD6Init,  dim67JoeKuoD6Init,  dim68JoeKuoD6Init,  dim69JoeKuoD6Init,  dim70JoeKuoD6Init,
    dim71JoeKuoD6Init,  dim72JoeKuoD6Init,  dim73JoeKuoD6Init,  dim74JoeKuoD6Init,  dim75JoeKuoD6Init,
    dim76JoeKuoD6Init,  dim77JoeKuoD6Init,  dim78JoeKuoD6Init,  dim79JoeKuoD6Init,  dim80JoeKuoD6Init,
    dim81JoeKuoD6Init,  dim82JoeKuoD6Init,  dim83JoeKuoD6Init,  dim84JoeKuoD6Init,  dim85JoeKuoD6Init,
    dim86JoeKuoD6Init,  dim87JoeKuoD6Init,  dim88JoeKuoD6Init,  dim89JoeKuoD6Init,  dim90JoeKuoD6Init,
    dim91JoeKuoD6Init,  dim92JoeKuoD6Init,  dim93JoeKuoD6Init,  dim94JoeKuoD6Init,  dim95JoeKuoD6Init,
    dim96JoeKuoD6Init,  dim97JoeKuoD6Init,  dim98JoeKuoD6Init,  dim99JoeKuoD6Init,  dim100JoeKuoD6Init,
    dim101JoeKuoD6Init, dim102JoeKuoD6Init, dim103JoeKuoD6Init, dim104JoeKuoD6Init, dim105JoeKuoD6Init,
    dim106JoeKuoD6Init, dim107JoeKuoD6Init, dim108JoeKuoD6Init, dim109JoeKuoD6Init, dim110JoeKuoD6Init,
    dim111JoeKuoD6Init, dim112JoeKuoD6Init, dim113JoeKuoD6Init, dim114JoeKuoD6Init, dim115JoeKuoD6Init,
    dim116JoeKuoD6Init, dim117JoeKuoD6Init, dim118JoeKuoD6Init, dim119JoeKuoD6Init, dim120JoeKuoD6Init,
    dim121JoeKuoD6Init, dim122JoeKuoD6Init, dim123JoeKuoD6Init, dim124JoeKuoD6Init, dim125JoeKuoD6Init,
    dim126JoeKuoD6Init, dim127JoeKuoD6Init, dim128JoeKuoD6Init};
...
class SobolRsg {
   public:
    ...
    void initialization() {
        ...
        int j;
        for (j = 0; j < bits_; j++) directionIntegers_[0][j] = (1UL << (bits_ - j - 1));
        ...
        for (int k = 1; k < DIM; k++) {
            ...
            for (int l = gk; l < bits_; l++) {
                ...
                for (int j = 1; j < gk; j++) {
                    ...
                    if ((ppmt[k] >> (gk - j - 1)) & 1UL) n ^= directionIntegers_[k][l - j];
                }
