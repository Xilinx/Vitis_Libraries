...
#pragma HLS INTERFACE m_axi port = types offset = slave bundle = gmem3
#pragma HLS INTERFACE m_axi port = t offset = slave bundle = gmem4
#pragma HLS INTERFACE m_axi port = T offset = slave bundle = gmem5
#pragma HLS INTERFACE m_axi port = S offset = slave bundle = gmem6
#pragma HLS INTERFACE m_axi port = K offset = slave bundle = gmem7
