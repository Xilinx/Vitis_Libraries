...
std::map<int, std::string> optionTypeFilePath = {
    {BinomialTreeEuropeanPut, "data/" + BinomialTreeEuropeanPutName + "/"},
    {BinomialTreeEuropeanCall, "data/" + BinomialTreeEuropeanCallName + "/"},
    {BinomialTreeAmericanPut, "data/" + BinomialTreeAmericanPutName + "/"},
    {BinomialTreeAmericanCall, "data/" + BinomialTreeAmericanCallName + "/"}};
