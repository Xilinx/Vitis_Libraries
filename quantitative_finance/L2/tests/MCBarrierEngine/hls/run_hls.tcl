...
add_files "${WORKDIR}/kernel/MCBarrierNoBiasEngine_k0.cpp" -cflags "-I ${WORKDIR}/kernel -I ${WORKDIR}/host -I ${WORKDIR}/../../../L2/include -I${WORKDIR}/../../../L1/include -D HLS_TEST"
...
set_top MCBarrierNoBiasEngine_k0
