...
extern "C" void kernel_MCAsianAP_0(TEST_DT underlying,
                                   TEST_DT volatility,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
    ...
    xf::fintech::MCAsianArithmeticAPEngine<TEST_DT, MCM_NM>(underlying, volatility, dividendYield, riskFreeRate,
                                                            timeLength, strike, option, seed, outputs,
