...
int main(int argc, const char* argv[]) {
    ...
    for (int i = 0; i < 1; i++) {
        ...
        inputParam1_alloc[i].a = 0.16046325834281869;
        inputParam1_alloc[i].sigma = 0.0037370022855109613;
        inputParam1_alloc[i].flatRate = 0.04875825;
        inputParam0_alloc[i].x0 = 0.0079988201434896891;
