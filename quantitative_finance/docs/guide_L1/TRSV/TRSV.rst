...
The Tridiagonal Matrix Solver solves a tridiagonal linear system using parallel cyclic reduction (also known as odd-even elimination). More details about this algorithm can be found in the paper: C. Levit, "Parallel Solution of Pentadiagonal Systems Using Generalized Odd-Even Elimination", 1989.
