## Black Scholes Merton L3 Test 
This is a test of the Black Scholes Merton model using the Vitis environment.  It supports software and hardware emulation as well as running the hardware accelerator on supported Alveo cards.
