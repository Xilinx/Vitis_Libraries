...
#pragma HLS array_partition variable = inlow cyclic factor = NCU
#pragma HLS array_partition variable = indiag cyclic factor = NCU
#pragma HLS array_partition variable = inup cyclic factor = NCU
#pragma HLS array_partition variable = inrhs cyclic factor = NCU
