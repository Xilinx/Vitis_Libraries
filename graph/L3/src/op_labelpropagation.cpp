...
void opLabelPropagation::createHandle(class openXRM* xrm,
                                      clHandle& handle,
    ...
    if (ret == 0) {
        ...
        if (cuPerBoardLabelPropagation >= 2) instanceName0 = "LPKernel:{" + instanceName0 + "}";
    } else {
        instanceName0 = "LPKernel";
    }
    handle.isBusy = false;
...
void opLabelPropagation::freeLabelPropagation(xrmContext* ctx) {
...
void opLabelPropagation::init(class openXRM* xrm,
                              std::string kernelName,
                              std::string kernelAlias,
                              std::string xclbinFile,
                              uint32_t* deviceIDs,
