...
#ifndef _XF_GRAPH_L3_OP_SCC_HPP_
#define _XF_GRAPH_L3_OP_SCC_HPP_
...
class opSCC : public opBase {
   public:
    static uint32_t cuPerBoardSCC;

    static uint32_t dupNmSCC;
