...
.. table:: Table 1 Hardware resources for Louvain fast in u55c now in 21.2, higher frequency and lower resources.
    :align: center
...
.. table:: Table 2 Hardware resources for Louvain fast in u50 before 21.2
    :align: center
