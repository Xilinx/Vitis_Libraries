...
#define depOffset ((testVertex + floatUnrollNm) / floatUnrollNm) // offsetCSC, degreeCSR buffer depth of 512 bits
#define depVertex \
    ((testVertex + unrollNm) / unrollNm)           // pagerank, cntValFull, buffPing, buffPong buffers depth of 512 bits
#define depEdge ((testEdge + unrollNm) / unrollNm) // indiceCSC buffer depth of 512 bits
