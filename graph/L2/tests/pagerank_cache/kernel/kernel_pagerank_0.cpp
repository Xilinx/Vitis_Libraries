...
#pragma HLS INTERFACE m_axi offset = slave bundle = gmem1 port = degreeCSR latency = 64 num_read_outstanding = \
...
#pragma HLS INTERFACE m_axi offset = slave bundle = gmem4 port = cntValFull latency = 125 num_read_outstanding = \
    32 max_read_burst_length = 2 num_write_outstanding = 2 max_write_burst_length = 32
