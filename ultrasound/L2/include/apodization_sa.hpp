...
class apodization_sa : public adf::graph {
   public:
    ...
    apodization_sa() {
        ...
        adf::fifo_depth(image_points_stream) = FIFO_DEPTH;
        adf::fifo_depth(apo_ref_stream) = FIFO_DEPTH;
        adf::fifo_depth(equalZero_stream_in) = FIFO_DEPTH;
        adf::fifo_depth(sumVV_stream_in) = FIFO_DEPTH;
        adf::fifo_depth(mulVS_stream_in) = FIFO_DEPTH;
        adf::fifo_depth(f_number_stream_in) = FIFO_DEPTH;
        adf::fifo_depth(sumVOne_stream_in) = FIFO_DEPTH;
        adf::fifo_depth(absV_stream_in) = FIFO_DEPTH;
        adf::fifo_depth(apodization_stream_out) = FIFO_DEPTH;
    }
