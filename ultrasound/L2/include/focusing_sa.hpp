...
class focusing_sa : public adf::graph {
   public:
    ...
    focusing_sa() {
        ...
        adf::connect<adf::stream> focusing_xdc_def_in_0(img_points_0, focusing_diffSVKernel1.in[1]);
        adf::connect<adf::stream> focusing_apo_ref_in_1(apo_ref_1, focusing_diffSVKernel2.in[0]);
        adf::connect<adf::stream> focusing_xdc_def_in_1(img_points_1, focusing_diffSVKernel2.in[1]);
        adf::connect<adf::window<WIN_SIZE_VECTOR_> >(focusing_diffSVKernel1.out[0], focusing_squareVKernel1.in[0]);
        adf::connect<adf::window<WIN_SIZE_VECTOR_> >(focusing_diffSVKernel2.out[0], focusing_squareVKernel2.in[0]);
        adf::connect<adf::window<WIN_SIZE_VECTOR_> >(focusing_squareVKernel1.out[0], focusing_sumVVKernel.in[0]);
        adf::connect<adf::window<WIN_SIZE_VECTOR_> >(focusing_squareVKernel2.out[0], focusing_sumVVKernel.in[1]);
        adf::connect<adf::window<WIN_SIZE_VECTOR_> >(focusing_sumVVKernel.out[0], focusing_sqrtVKernel.in[0]);
