...
#define INPUT_SIZE_1 ((POINT_SIZE * SPACE_DIMENSION) * ITERATIONS)
#define INPUT_SIZE_2 (POINT_SIZE * ITERATIONS)
#define OUTPUT_SIZE (POINT_SIZE * ITERATIONS)
...
int main(int argc, const char** argv) {
    ...
    file_set[1] = data_path + "apodization_reference.txt";
    file_set[2] = data_path + "apo_distance_k.txt";
    file_set[3] = data_path + "F_number.txt";
    ...
    for (int i = 0; i < INPUT_RANGE; i++) {
        ...
        memcpy(in_bomapped_set[i], buf_mem[i], sizeIn[i]);
    ...
    golden_file_set[0] = data_path + "apodization_golden.txt";
