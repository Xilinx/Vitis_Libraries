 ...
 */
#ifndef _APODIZATION2_HPP_
#define _APODIZATION2_HPP_
...
class apodization_graph : public adf::graph {
   public:
    ...
    apodization_graph(double kernel_ratio = KERNEL_RATIO) {
        ...
        adf::source(absVKernel1) = "absV.cpp";
        adf::source(equalZeroKernel) = "equalS.cpp";
        adf::source(mulVS1Kernel) = "mulVS.cpp";
        adf::source(sumVVKernel) = "sumVV.cpp";
        adf::source(reciprocalVKernel) = "reciprocalV.cpp";
        adf::source(mulVS2Kernel) = "mulVS.cpp";
        adf::source(mulVS2FNumberKernel) = "mulVS.cpp";
        adf::source(mulVS2Pi2Kernel) = "mulVS.cpp";
        adf::source(cosVKernel) = "cosV.cpp";
        adf::source(diffOneVKernel) = "diffSV.cpp";
        adf::source(mulVHalfKernel) = "mulVS.cpp";
        adf::source(absVKernel2) = "absV.cpp";
        adf::source(lessThanOneKernel) = "lessOrEqualThanS.cpp";
        adf::source(mulVVKernel) = "mulVV.cpp";
        adf::source(sumVOneKernel) = "sumVS.cpp";
