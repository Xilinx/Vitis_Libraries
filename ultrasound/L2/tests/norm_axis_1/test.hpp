...
class normAxis1 : public adf::graph {
   public:
    normAxis1() {
        ...
        // connections
        adf::connect<adf::window<WIN_SIZE_MATRIX> > input1_normAxis1_q(input1_normAxis1.out[0], normAxis1Kernel.in[0]);
        adf::connect<adf::window<WIN_SIZE_MATRIX> > output_normAxis1_q(normAxis1Kernel.out[0], output_normAxis1.in[0]);
        ...
        // Setting FIFO depth
        adf::fifo_depth(input1_normAxis1_q) = FIFO_DEPTH;
        adf::fifo_depth(output_normAxis1_q) = FIFO_DEPTH;
    }
