...
int main(int argc, const char** argv) {
    ...
    // Input: image-points
    file_set[0] = data_path + "P0.txt";
    file_set[1] = data_path + "P0.txt";
    file_set[2] = data_path + "P0.txt";
    file_set[3] = data_path + "P0.txt";
    file_set[4] = data_path + "P0.txt";
    ...
    golden_file_set[0] = data_path + "C.txt";
