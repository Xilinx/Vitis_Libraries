...
int main(int argc, const char** argv) {
    ...
    // Input: image-points
    file_set[0] = data_path + "image_points.txt";
    file_set[1] = data_path + "image_points.txt";
    file_set[2] = data_path + "tx_def_ref_point.txt";
    file_set[3] = data_path + "tx_def_ref_point.txt";
    file_set[4] = data_path + "tx_def_ref_point.txt";
    file_set[5] = data_path + "tx_def_ref_point.txt";
    file_set[6] = data_path + "t_start.txt";

    sizeIn[0] = 128; // image_points_from_PL
    sizeIn[1] = 128; // image_points_from_PL2
    sizeIn[2] = 4;   // tx_def_ref_point
    sizeIn[3] = 4;   // tx_def_delay_distance
    sizeIn[4] = 32;  // tx_def_delay_distance2
    sizeIn[5] = 4;   // tx_def_focal_point
    sizeIn[6] = 4;   // t_start
    sizeOut[0] = 32; // delay_to_PL
    ...
    golden_file_set[0] = data_path + "delay_to_PL_golden.txt";

    // loading golden data
    float* golden_buf_mem[OUTPUT_RANGE];

    for (int i = 0; i < OUTPUT_RANGE; i++) {
        golden_buf_mem[i] = data_loading<float>(golden_file_set[i], sizeOut[i]);
    }
