...
int main(int argc, const char** argv) {
    ...
    // Inputs
    file_set[0] = data_path + "image_points_from_PL.txt";
    file_set[1] = data_path + "delay_from_PL.txt";
    file_set[2] = data_path + "xdc_def_positions.txt";
    file_set[3] = data_path + "sampling_frequency.txt";

    // mem inputSize & outSize define
    sizeIn[0] = 128;
    sizeIn[1] = 32;
    sizeIn[2] = 4;
    sizeIn[3] = 32;
    ...
    golden_file_set[0] = data_path + "samples_to_PL_golden.txt";
