...
adf::simulation::platform<24, 6> platform(
    // INPUTS
    // IMAGE POINTS
    start_positions,
    directions,
...
adf::connect<> src_delay_ref(platform.src[4], d.tx_def_reference_point);
adf::connect<> src_t_start(platform.src[5], d.t_start);
// FOCUSING
adf::connect<> input_apo_0(platform.src[6], foc.apo_ref_0);
adf::connect<> input_xdc_0(platform.src[7], foc.xdc_def_0);
adf::connect<> input_apo_1(platform.src[8], foc.apo_ref_1);
adf::connect<> input_xdc_1(platform.src[9], foc.xdc_def_1);
////SAMPLES
adf::connect<> src_image_points_2(platform.src[10], sam.image_points_from_PL_2);
adf::connect<> delay_in(platform.src[11], sam.delay_from_PL);
adf::connect<> xdc_def_pos_in(platform.src[12], sam.xdc_def_positions);
adf::connect<> sampl_freq(platform.src[13], sam.samplingFrequency);
////APODIZATION
adf::connect<> src_image_points_apo(platform.src[14], apo.image_points);
adf::connect<> src_apodization_reference(platform.src[15], apo.apodization_reference_i);
adf::connect<> src_apo_distance_k(platform.src[16], apo.apo_distance_k);
adf::connect<> src_F_number(platform.src[17], apo.F_number);
////INTERPOLATOR
adf::connect<> in_P1(platform.src[18], interp.P1);
adf::connect<> in_P2(platform.src[19], interp.P2);
adf::connect<> in_P3(platform.src[20], interp.P3);
adf::connect<> in_P4(platform.src[21], interp.P4);
adf::connect<> in_P5(platform.src[22], interp.P5);
adf::connect<> in_P6(platform.src[23], interp.P6);
