...
// FOCUSING SA
adf::PLIO* apo_ref_0_sa = new adf::PLIO("apo_ref_0_tx", adf::plio_32_bits, "data/apo_ref_0.txt");
adf::PLIO* img_points_0_sa = new adf::PLIO("img_points_0", adf::plio_32_bits, "data/xdc_def_0.txt");
adf::PLIO* apo_ref_1_sa = new adf::PLIO("apo_ref_1_tx", adf::plio_32_bits, "data/apo_ref_1.txt");
adf::PLIO* img_points_1_sa = new adf::PLIO("img_points_1_tx", adf::plio_32_bits, "data/xdc_def_1.txt");
// APODIZATION SA
adf::PLIO* image_points_sa = new adf::PLIO("image_points_tx", adf::plio_32_bits, "data/image_points.txt");
adf::PLIO* apodization_reference_sa =
    new adf::PLIO("apodization_reference_tx", adf::plio_32_bits, "data/apodization_reference.txt");
adf::PLIO* apo_distance_k_sa = new adf::PLIO("apo_distance_k_tx", adf::plio_32_bits, "data/apo_distance_k.txt");
adf::PLIO* F_number_sa = new adf::PLIO("F_number_tx", adf::plio_32_bits, "data/F_number.txt");
// // FOCUSING
...
// FOCUSING SA
adf::PLIO* focusing_output_tx = new adf::PLIO("focusing_output_tx", adf::plio_32_bits, "data/focusing_output.txt");
// APODIZATION SA
adf::PLIO* apodization_output_tx = new adf::PLIO("apodization_tx", adf::plio_32_bits, "data/apodization.txt");
// // FOCUSING
...
us::L2::delay<> d;
us::L2::focusing_sa<> foc_sa;
us::L2::apodization_sa<> apo_sa;
// us::L2::focusing foc;
us::L2::samples<> sam;
...
////FOCUSING SA
adf::connect<> input_apo_0_sa(platform.src[10], foc_sa.apo_ref_0);
adf::connect<> input_img_p_0_sa(platform.src[11], foc_sa.img_points_0);
adf::connect<> input_apo_1_sa(platform.src[12], foc_sa.apo_ref_1);
adf::connect<> input_img_p_1_sa(platform.src[13], foc_sa.img_points_1);
////APODIZATION SA
adf::connect<> src_image_points_apo_sa(platform.src[14], apo_sa.image_points);
adf::connect<> src_apodization_reference_sa(platform.src[15], apo_sa.apodization_reference_i);
adf::connect<> src_apo_distance_k_sa(platform.src[16], apo_sa.apo_distance_k);
adf::connect<> src_F_number_sa(platform.src[17], apo_sa.F_number);
// ////FOCUSING
// adf::connect<> input_apo_0(platform.src[18], foc.apo_ref_0);
// adf::connect<> input_xdc_0(platform.src[19], foc.xdc_def_0);
// adf::connect<> input_apo_1(platform.src[20], foc.apo_ref_1);
// adf::connect<> input_xdc_1(platform.src[21], foc.xdc_def_1);
//////SAMPLES
adf::connect<> src_image_points_2(platform.src[18], sam.image_points_from_PL_2);
adf::connect<> delay_in(platform.src[19], sam.delay_from_PL);
adf::connect<> xdc_def_pos_in(platform.src[20], sam.xdc_def_positions);
adf::connect<> sampl_freq(platform.src[21], sam.samplingFrequency);
// //////APODIZATION
// adf::connect<> src_image_points_apo(platform.src[26], apo.image_points);
// adf::connect<> src_apodization_reference(platform.src[27], apo.apodization_reference_i);
// adf::connect<> src_apo_distance_k(platform.src[28], apo.apo_distance_k);
// adf::connect<> src_F_number(platform.src[29], apo.F_number);
//////INTERPOLATOR
...
////FOCUSING SA
adf::connect<> out_foc_sa(foc_sa.focusing_output, platform.sink[2]);
////APODIZATION SA
adf::connect<> out_apo_Sa(apo_sa.apodization_output, platform.sink[3]);
// ////FOCUSING
// adf::connect<> output_vector(foc.focusing_output, platform.sink[4]);
//////SAMPLES
adf::connect<> out_samples(sam.samples_to_PL, platform.sink[4]);
// //////APODIZATION
// adf::connect<> out_apodization_output(apo.apodization_output, platform.sink[6]);
//////INTERPOLATOR
