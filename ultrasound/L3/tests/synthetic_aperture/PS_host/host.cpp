...
#include "synthetic_aperture.hpp"
...
int main(int argc, const char** argv) {
    ...
    // run aie application
    us::L3::synthetic_aperture<>(xclbin_path, data_path, res_out, res_out_size, ITER);
    ...
    golden_file_set[3] = data_path + "golden/apodization.txt";
    golden_file_set[4] = data_path + "golden/samples_to_PL.txt";
    ...
    golden_sizeOut[0] = 128; // image-points output
    golden_sizeOut[1] = 32;  // delay output
    golden_sizeOut[2] = 32;  // focusing sa output
    golden_sizeOut[3] = 32;  // apodization sa output
    golden_sizeOut[4] = 32;  // samples
    golden_sizeOut[5] = 128; // interpolator
