...
template <int TIER = 1>
void scanline(std::string xclbin_path,
    ...
    file_set[15] = data_path + "delay_from_PL.txt";
    file_set[16] = data_path + "xdc_def_positions.txt";
    file_set[17] = data_path + "sampling_frequency.txt";
    file_set[18] = data_path + "image_points.txt";
    file_set[19] = data_path + "apodization_reference.txt";
    file_set[20] = data_path + "apo_distance_k.txt";
    file_set[21] = data_path + "F_number.txt";
    ...
    // image_points
    sizeIn[0] = 4;  // image-points
    sizeIn[1] = 4;  // directions
    sizeIn[2] = 32; // samples
    // delay
    sizeIn[3] = 128; // image_points_from_PL
    sizeIn[4] = 128; // image_points_from_PL2
    sizeIn[5] = 4;   // tx_def_delay_distance
    sizeIn[6] = 32;  // tx_def_delay_distance2
    sizeIn[7] = 32;  // tx_def_ref_point
    sizeIn[8] = 4;   // tx_def_focal_point
    sizeIn[9] = 4;   // t_start
    // focusing
    sizeIn[10] = 32; // data_path + "apo_ref_0.txt";
    sizeIn[11] = 32; // data_path + "xdc_def_0.txt";
    sizeIn[12] = 32; // data_path + "apo_ref_1.txt";
    sizeIn[13] = 32; // data_path + "xdc_def_1.txt";
    // samples
    sizeIn[14] = 128; // image_points
    sizeIn[15] = 32;  // delay_from_PL
    sizeIn[16] = 4;   // xdc_def_positions
    sizeIn[17] = 32;  // sampling_frequency
    // apodization
    sizeIn[18] = 128; // image_points
    sizeIn[19] = 4;   // apodization_reference
    sizeIn[20] = 32;  // apo_distance_k
    sizeIn[21] = 4;   // F_number
    // interpolation
    sizeIn[22] = 128; // P1
    sizeIn[23] = 128; // P2
    sizeIn[24] = 128; // P3
