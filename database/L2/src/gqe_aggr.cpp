...
#include "gqe_blocks/eval_part.hpp"
#include "gqe_blocks/filter_part.hpp"
#include "gqe_blocks/group_aggregate_part.hpp"
#include "gqe_blocks/aggr_part.hpp"
#include "gqe_blocks/write_info.hpp"
...
extern "C" void gqeAggr(                                        //
    ap_uint<8 * TPCH_INT_SZ * VEC_LEN> buf_in[TEST_BUF_DEPTH],  // input data
    ap_uint<8 * TPCH_INT_SZ * VEC_LEN> buf_out[TEST_BUF_DEPTH], // output data
...
#pragma HLS INTERFACE m_axi offset = slave latency = 64 num_write_outstanding = 1 num_read_outstanding = \
    16 max_write_burst_length = 32 max_read_burst_length = 32 bundle = gmem0_0 port = buf_in
...
#pragma HLS INTERFACE m_axi offset = slave latency = 64 num_write_outstanding = 16 num_read_outstanding = \
    1 max_write_burst_length = 32 max_read_burst_length = 32 bundle = gmem0_1 port = buf_out
...
#pragma HLS resource variable = e_scan_strms core = FIFO_SRL
    ...
    load_config<n_channel, n_column>(buf_cfg, cid_strm, alu0_cfg_strm, alu1_cfg_strm, filter_cfg_strm,
                                     shuffle1_cfg_strm, shuffle2_cfg_strm, shuffle3_cfg_strm, shuffle4_cfg_strm,
                                     merge_column_cfg_strm, group_aggr_cfg_strm, direct_aggr_cfg_strm, write_cfg_strm);
    ...
    scan_to_channel<n_column, n_channel>(buf_in, cid_strm, scan_strms, e_scan_strms);
...
//------------------------write out--------------------------
    ...
    writeTable<BURST_LEN, 8 * TPCH_INT_SZ, VEC_LEN, 2 * n_column>(direct_aggr_strm, e_direct_aggr_strm, buf_out,
                                                                  write_cfg_strm);
