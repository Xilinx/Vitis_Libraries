...
int main(int argc, const char* argv[]) {
    ...
    tbs[2] = Table("supplier", 10000 * 30, 8, in_dir);
    ...
    Table tbx(512);
    Table th0("th0", 16, 5, "");
    Table th1("th1", 24000, 2, "");
    Table th2("th2", 24000, 5, "");
    Table tk0("tk0", 180000 * 30, 8, "");
    Table tk1("tk1", 180000 * 30, 8, "");
    ...
    krnlstep[2].setup(th1, tk1, th2, cfgcmds[2], buftmp);
    ...
    events_grp[0].push_back(events[1][0]);
    events_grp[0].push_back(eventsh2d_write[2][0]);

    krnlstep[2].run(0, &(events_grp[0]), &(events[2][0]));
    //  q2Join_t4_t3(th1,tk1,th0);
