...
int main(int argc, const char* argv[]) {
   ...
   */
    ...
    krnlstep[5].setup(tbs[1], tk0, tk2, cfgcmds[5], buftmp);
    ...
    cl::UserEvent uevent(context);
    cl_ulong stime;
    uevent.getProfilingInfo(CL_PROFILING_COMMAND_START, &stime);
