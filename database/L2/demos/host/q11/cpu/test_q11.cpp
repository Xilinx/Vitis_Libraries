...
int main(int argc, const char* argv[]) {
    ...
    q11Join_t1_s(th0, tbs[1], tk0);
    gettimeofday(&tv_r_1, 0);

    // step3 : t2 ps -> t3
    q11Join_t2_p(tk0, tbs[2], tk1);
    ...
    int64_t filterv = q14scalsum(tk1);
    // step5 : part filter -> t5
    q11Filter_Sort(filterv, th0, tk0);
    ...
    std::cout << "Join t2_p CPU time of Host " << tvdiff(&tv_r_1, &tv_r_2) / 1000 << " ms" << std::endl;
