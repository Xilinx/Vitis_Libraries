...
int main(int argc, const char* argv[]) {
    ...
    // step1 :group lineitem-> t1
    q15GroupBy(tbs[0], th0);

    // step2:find the max key
    ...
    std::cout << "Filter CPU time of Host " << tvdiff(&tv_r_0, &tv_r_1) / 1000 << " ms" << std::endl;
    std::cout << "Join t1_s CPU time of Host " << tvdiff(&tv_r_1, &tv_r_2) / 1000 << " ms" << std::endl;
