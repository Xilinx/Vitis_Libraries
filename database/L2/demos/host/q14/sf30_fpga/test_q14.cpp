...
int main(int argc, const char* argv[]) {
    ...
    tbs[0].addCol("p_type", TPCH_READ_P_TYPE_LEN + 1, 0, 0);
    ...
    Table tbx(512);
    Table th0("th0", 1001000, 1, "");
    Table tk0("tk0", 380000, 1, "");
    Table tk1("tk1", 2250000, 1, "");
    ...
    krnlstep[1].setup(tbs[0], tbs[1], tk1, cfgcmds[1], buftmp);
    ...
    ap_int<64> sum1 = 0;
    ap_int<64> sum = 0;
    sum1.range(31, 0) = tk0.getInt32(2, 0);
    sum1.range(63, 32) = tk0.getInt32(3, 0);
    sum.range(31, 0) = tk1.getInt32(2, 0);
    sum.range(63, 32) = tk1.getInt32(3, 0);
    ...
    print_h_time(tv_r_s, tv_r_s, tv_r_0, "PartFilter..");
    print_d_time(eventsh2d_write[1][0], eventsd2h_read[0][0], kstart, "kernel0/1");
