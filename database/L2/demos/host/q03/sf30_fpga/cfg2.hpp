...
void get_aggr_cfg(ap_uint<32>* buf, int i) {
    ...
    shuffle3_cfg(15, 8) = 1; // linestatus
    ...
    merge[0] = 0;
    merge[1] = 0;
    merge[2] = 0xe0; // 1110_0000
    merge[3] = 0x80; // 1000_0000
    merge[4] = 0;
    ...
    // write out
    config[82] = 0xe181; // 1110_0001_1000_0001
    /*
        config[80][0]=1;//suml
        config[80][1]=0;
        config[80][2]=0;
