...
int main(int argc, const char* argv[]) {
    ...
    tbs[1].addCol("l_shipmode", TPCH_READ_MAXAGG_LEN + 1);
    tbs[1].addCol("l_shipinstruct", TPCH_READ_MAXAGG_LEN + 1);

    std::cout << "DEBUG0" << std::endl;
    // tbx is for the empty bufferB in kernel
    Table tbx(512);
    Table th0("th0", 1800000 * scale, 8, "");
    Table th1("th1", 1800000 * scale, 8, "");
    Table th2("th2", 1800000 * scale, 8, "");
    Table tk0("tk0", 300000 * scale, 8, "");
