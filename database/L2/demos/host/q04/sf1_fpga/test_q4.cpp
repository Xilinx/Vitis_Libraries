...
int main(int argc, const char* argv[]) {
    ...
    tbs[0] = Table("lineitem", 6001215, 3, in_dir);
    ...
    krnlstep[0].setup(tbs[0], tbs[1], tk0, cfgcmds[0], buftmp);
    ...
    //  q4SemiJoin_o_l(tbs[0],tbs[1],tk0);
    transin[kernelInd].host2dev(0, nullptr, &(eventsh2d_write[0][0]));
