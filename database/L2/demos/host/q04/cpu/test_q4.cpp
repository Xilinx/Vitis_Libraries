...
int main(int argc, const char* argv[]) {
    ...
    std::cout << std::dec << "SemiJoin CPU time of Host " << tvdiff(&tv_r_s, &tv_r_0) / 1000 << " ms" << std::endl;
    std::cout << std::dec << "Groupby CPU time of Host " << tvdiff(&tv_r_0, &tv_r_1) / 1000 << " ms" << std::endl;
