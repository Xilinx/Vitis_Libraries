...
void scan_col_bufs(ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A1,
                   ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A2,
                   ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A3,
                   ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A4,
                   ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A5,
                   ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A6,
                   ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A7,
                   ap_uint<8 * TPCH_INT_SZ * VEC_SCAN>* ptr_A8,
                   hls::stream<int>& nrow_strm,
    ...
    /* if join_on, read from A buf and B buf once
    ...
    if (join_on) {
        scan_cols<8 * TPCH_INT_SZ, VEC_SCAN, CH_NM, COL_NM>(ptr_A1, ptr_A2, ptr_A3, ptr_A4, ptr_A5, ptr_A6, ptr_A7,
                                                            ptr_A8, nrowA, cid_A_strm, out_strm, e_out_strm);

#ifndef __SYNTHESIS__
        int s_a = 0;
        for (int ch = 0; ch < CH_NM; ++ch) {
            s_a += e_out_strm[ch].size() - 1;
        }
