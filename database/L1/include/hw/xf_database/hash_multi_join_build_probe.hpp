...
#ifndef XF_DATABASE_HASH_MULTI_JOIN_BUILD_PROBE_H
#define XF_DATABASE_HASH_MULTI_JOIN_BUILD_PROBE_H
...
void dispatch_wrapper(hls::stream<ap_uint<KEYW> >& i_key_strm,
    ...
    details::join_v3::sc::dispatch_unit<HASH_MODE, KEYW, PW, HASHWH, HASHWL, PU>(
        i_key_strm, i_pld_strm, i_e_strm, o_key_strm, o_pld_strm, o_hash_strm, o_e_strm);
}
...
void merge1_1_wrapper(hls::stream<ap_uint<KEYW> >& i_key_strm,
    ...
    details::join_v2::merge1_1<KEYW, PW, HASHW>(i_key_strm, i_pld_strm, i_hash_strm, i_e_strm, o_key_strm, o_pld_strm,
...
void merge2_1_wrapper(hls::stream<ap_uint<KEYW> >& i0_key_strm,
    ...
    details::join_v2::merge2_1<KEYW, PW, HASHW>(i0_key_strm, i1_key_strm, i0_pld_strm, i1_pld_strm, i0_hash_strm,
                                                i1_hash_strm, i0_e_strm, i1_e_strm, o_key_strm, o_pld_strm, o_hash_strm,
                                                o_e_strm);
}
...
void merge4_1_wrapper(hls::stream<ap_uint<KEYW> >& i0_key_strm,
    ...
    details::join_v2::merge4_1<KEYW, PW, HASHW>(i0_key_strm, i1_key_strm, i2_key_strm, i3_key_strm, i0_pld_strm,
                                                ...
                                                i2_hash_strm, i3_hash_strm, i0_e_strm, i1_e_strm, i2_e_strm, i3_e_strm,
...
#pragma HLS resource variable = bit_vector1 core = RAM_2P_URAM
    ...
    initiate_uram<HASHWL, ARW>(build_probe_flag, htb_buf, bit_vector0, bit_vector1);
    if (!build_probe_flag) {
#ifndef __SYNTHESIS__
...
// probe
        ...
        hash_multi_join::multi_probe_wrapper<HASHWL, KEYW, PW, S_PW, T_PW, ARW>(
            depth,
            // join_flag_strm,
...
template <int KEYW, int S_PW, int T_PW, int ARW>
void join_unit_2(bool& build_probe_flag,
                 // input large table
                 hls::stream<ap_uint<3> >& join_flag_strm_o,
...
#pragma HLS resource variable = i_e_strm core = FIFO_SRL
    ...
    split_stream<KEYW, S_PW, T_PW, ARW>(build_probe_flag, join_flag_strm, i_t_key_strm, i_t_pld_strm, i_nm_strm,
                                        i_e0_strm, join1_flag_strm, i1_t_key_strm, i1_t_pld_strm, i1_nm_strm,
                                        i1_e0_strm, join2_flag_strm, i2_t_key_strm, i2_t_pld_strm, i2_nm_strm,
                                        i2_e0_strm);
    ...
    join_unit_1<KEYW, S_PW, T_PW, ARW>(build_probe_flag, depth, join1_flag_strm, i1_t_key_strm, i1_t_pld_strm,
    ...
    join_unit_2<KEYW, S_PW, T_PW, ARW>(build_probe_flag, join2_flag_strm, i2_t_key_strm, i2_t_pld_strm, i2_nm_strm,
                                       i2_e0_strm, i_j_strm[1], i_e_strm[1]);
    ...
    combine_stream<KEYW, S_PW, T_PW, ARW>(build_probe_flag, i_j_strm, i_e_strm, o_j_strm, o_e_strm);
#ifndef __SYNTHESIS__
#ifdef DEBUG
...
template <int _NOut>
void dup_join_flag(bool build_probe_flag,
                   hls::stream<bool> bp_flag_strm[_NOut],
                   hls::stream<ap_uint<3> >& join_flag_strm,
                   hls::stream<ap_uint<3> > join_flags[_NOut]) {
    for (int i = 0; i < _NOut; ++i) {
#pragma HLS unroll
        bp_flag_strm[i].write(build_probe_flag);
    }
...
void hashMultiJoinBuildProbe(bool build_probe_flag,
                             // type
                             hls::stream<ap_uint<3> >& join_flag_strm,
                             // input
...
#pragma HLS unroll
...
#endif
#endif
        details::hash_multi_join_build_probe::build_merge_multi_probe_wrapper<HASH_MODE, HASHWH, HASHWL, KEYW, S_PW,
                                                                              B_PW, ARW>(
            // input status
            // id,
    ...
    for (int i = 0; i < PU; i++) {
#pragma HLS unroll
        details::hash_multi_join_build_probe::multi_join_unit<KEYW, S_PW, B_PW, ARW>(
#ifndef __SYNTHESIS__
            i,
#endif
