...
void init_flag(const int join_flag, hls::stream<ap_uint<3> >& join_flag_strm) {
...
#pragma HLS INTERFACE s_axilite port = join_flag bundle =control
...
#pragma HLS stream variable = pu_end_status_strm depth = 8
    ...
    xf::database::hashMultiJoin<HJ_MODE,        // 0 - radix, 1 - Jenkins
                                ...
                                >(
        // input
        join_flag_strm, k0_strm_arry, p0_strm_arry, e0_strm_arry,
