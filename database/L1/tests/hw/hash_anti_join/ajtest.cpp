...
int main() {
    ...
    hash_join_golden<nrow_s>(s_key_strm, s_pld_strm, s_e_strm, t_key_strm, t_pld_strm, t_e_strm, j_strm, j_e_strm);

    // check
    int nerror;
    nerror = check_data<nrow_s>(j_strm, j_e_strm, j_res0);
