...
#define WHASH 7   // 17 is suggested in hardware, each pu have 2^17 = 128K entries. 8 PU have totally 1M entries.
#define BLOOM_FILTER_W 24 // bloom filter hash value width
#define EN_BLOOM_FILTER 0 // bloom filter switch on-off
...
#define BUILD_CFG_DEPTH (11)   // number of s_unit, pu s base ptr * 8
