...
void load_strm2bram(hls::stream<ap_uint<16> >& bit_vet_strm,
...
#pragma HLS pipeline II = 1
    ...
    load_strm2bram(bit_vet_strm, bit_vet_e_strm, bit_vector_ptr0, bit_vector_ptr1, bit_vector_ptr2);
...
void load_strm2uram(hls::stream<ap_uint<64> >& bit_vet_strm,
                    hls::stream<bool>& bit_vet_e_strm,
...
#pragma HLS pipeline II = 1
    ...
    load_strm2uram(bit_vet_strm, bit_vet_e_strm, bit_vector_ptr0, bit_vector_ptr1, bit_vector_ptr2);
