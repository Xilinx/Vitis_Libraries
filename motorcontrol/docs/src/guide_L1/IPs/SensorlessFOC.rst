...
***************************************************************
Internal Design of Sensor-less field-orientated control (FOC)
***************************************************************
...
As an independent IP, Sensorless FOC could work with SVPWM_DUTY, PWM_GEN and QEI in this library.
...
Implemention
==============
The Sensorless FOC Features:

Table 1 : Sensorless FOC Features

.. table:: Table 1 Sensorless FOC Features
    :align: center
...
Figure 1 : Sensorless FOC architecture top view

.. figure:: /images/Design_Sensorlessfoc.png
      :alt: Figure 1 Sensorless FOC architecture top view
      :width: 60%
      :align: center
...
.. toctree::
   ...
   benchmark of Sensorless FOC <../../benchmark/FOC_sensorless.rst>
