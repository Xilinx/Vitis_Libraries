...
[Comprehensive documentation](https://xilinx.github.io/Vitis_Libraries/security/2020.2/index.html)
...
For further detials, please refer to the `Benchmark Reuslt` page in the library document.
