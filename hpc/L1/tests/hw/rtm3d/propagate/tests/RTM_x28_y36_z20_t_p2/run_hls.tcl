...
set PROJ "propagate_RTM_x28_y36_z20_t_p2_test.prj"
set SOLN "sol"
...
if {$CSIM == 1} {
  csim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/rtm3d/propagate/tests/RTM_x28_y36_z20_t_p2/data/"
}
...
if {$COSIM == 1} {
  cosim_design -argv "${XF_PROJ_ROOT}/L1/tests/hw/rtm3d/propagate/tests/RTM_x28_y36_z20_t_p2/data/"
}
