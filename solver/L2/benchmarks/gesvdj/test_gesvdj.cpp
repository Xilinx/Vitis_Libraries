...
int main(int argc, const char* argv[]) {
    ...
    cl::Kernel kernel_gesvdj_0(program, "kernel_gesvdj_0", &err);
    ...
    mext_o[1] = {2, dataU_svd, kernel_gesvdj_0()};
    mext_o[2] = {3, dataV_svd, kernel_gesvdj_0()};
    ...
    // Setup kernel
    kernel_gesvdj_0.setArg(0, input_buffer[0]);
    kernel_gesvdj_0.setArg(1, output_buffer[0]);
    kernel_gesvdj_0.setArg(2, output_buffer[1]);
    kernel_gesvdj_0.setArg(3, output_buffer[2]);
    kernel_gesvdj_0.setArg(4, dataAN);
    q.finish();
