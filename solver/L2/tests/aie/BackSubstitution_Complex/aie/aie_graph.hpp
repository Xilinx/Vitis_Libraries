...
#ifndef _XF_SOLVER_BACK_SUBSTITUTION_GRAPH_HPP_
#define _XF_SOLVER_BACK_SUBSTITUTION_GRAPH_HPP_
...
class TestGraph: public adf::graph {
    public: 
        ...
        TestGraph(std::string fin0, 
            ...
            connect<stream>(plin0.out[0], backSubstitutionGraph.din0);
            connect<stream>(plin1.out[0], backSubstitutionGraph.din1);
