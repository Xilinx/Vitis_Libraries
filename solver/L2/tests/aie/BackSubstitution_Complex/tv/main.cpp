...
std::string fRC_Trans_backwords_0 = "../data/RC_Trans_backwords_0_" + std::to_string(row_num) + "_" + std::to_string(col_num) + ".txt";
std::string fRC_Trans_backwords_1 = "../data/RC_Trans_backwords_1_" + std::to_string(row_num) + "_" + std::to_string(col_num) + ".txt";

std::string fout_backwords_0 = "../data/out_backwords_0_" + std::to_string(col_num) + ".txt";
std::string fout_backwords_1 = "../data/out_backwords_1_" + std::to_string(col_num) + ".txt";
std::string fgld_backwords_0 = "../data/gld_backwords_0_" + std::to_string(col_num) + ".txt";
std::string fgld_backwords_1 = "../data/gld_backwords_1_" + std::to_string(col_num) + ".txt";
...
int main() {
    ...
    writeComplexToFiles_backwords<Type>(X, fgld_backwords_0, fgld_backwords_1, N);
    ...
    writeComplexTriangularToFiles_backwords<Type>(R, fRC_Trans_backwords_0, fRC_Trans_backwords_1);
    writeComplexToFiles_backwords<Type>(C, fRC_Trans_backwords_0, fRC_Trans_backwords_1, N);
    std::cout << "Write Backsubstitution's input MatrixR && MatrixC to files: \n";
    printTriangularMatrix_backwords(fRC_Trans_backwords_0, fRC_Trans_backwords_1, N, N, N, K);
