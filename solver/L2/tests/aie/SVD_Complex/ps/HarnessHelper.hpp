...
public:
    ...
    void runPL(T* data, int data_length, int result_length,int PL_loop) {
        ...
        this->fastXM::runPL(0, {{0, true, (unsigned int)datamoverCfgGen.cfg_size_in_byte, (char*)datamoverCfgGen.cfg_buf, 0},
                        {1, true, (unsigned int)data_sz, (char*)this->data, 0},
                        {2, true, (unsigned int)result_sz, (char*)this->result, 0}});
        this->fastXM::runPL(1, {{0, false, 0, nullptr, pattern_size},
                        {1, false, 0, nullptr, PL_loop}});
    }
