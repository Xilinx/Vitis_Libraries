...
std::string fout_0 = "./data/out_0_" + std::to_string(colA_num) + ".txt";
std::string fout_1 = "./data/out_1_" + std::to_string(colA_num) + ".txt";
std::string fgld_0 = "./data/gld_0_" + std::to_string(colA_num) + ".txt";
std::string fgld_1 = "./data/gld_1_" + std::to_string(colA_num) + ".txt";


//TestGraph mygraph(fin_0, fin_1, fout_0, fout_1);
TestGraph mygraph(fin_0, fin_1, fRC_0, fRC_1);
...
int main(int argc, char** argv) {
    ...
    //if(N < 65) {
    //    std::cout << "Out Matrix\n";
    //    printOutputMatrix128(fout_0, fout_1, colA_num, colB_num);
    //    std::cout << "Gld Matrix\n";
    //    printOutputMatrix32(fgld_0, fgld_1, colA_num, colB_num);
    //}
    //errNum = verify_output(fout_0, fout_1, fgld_0, fgld_1,  colA_num, colB_num);
