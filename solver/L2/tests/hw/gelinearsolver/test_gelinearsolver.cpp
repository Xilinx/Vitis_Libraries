...
int main(int argc, const char* argv[]) {
    ...
    cl::Kernel kernel_gelinearsolver_0(program, "kernel_gelinearsolver_0", &err);
    ...
    // mext_io[1].obj = dataB;
    // mext_io[1].param = 0;
    mext_io[0] = {1, dataA, kernel_gelinearsolver_0()};
    mext_io[1] = {2, dataB, kernel_gelinearsolver_0()};
