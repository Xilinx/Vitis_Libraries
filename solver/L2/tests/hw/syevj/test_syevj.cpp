...
int main(int argc, const char* argv[]) {
    ...
    cl::Kernel kernel_syevj_0(program, "kernel_syevj_0", &err);
    ...
    // mext_o[1].param = 0;
    mext_i[0] = {0, dataA_evj, kernel_syevj_0()};
    mext_o[0] = {1, sigma_out, kernel_syevj_0()};
    mext_o[1] = {2, dataU_evj, kernel_syevj_0()};
