...
.. table:: Cholesky configuration parameters
    ...
    +------------------------+----------------+----------------+------------------------------------------------+
    | CASC_LEN               |    unsigned    |    1           | The number of kernels chained in sequence      |
    |                        |                |                | to pipeline the cholesky operation in time.    |
    +------------------------+----------------+----------------+------------------------------------------------+
...
For the QRD Householder library element, use the following list of configurable parameters and default values.

.. table:: QRD Householder configuration parameters
...
.. table:: SVD configuration parameters
    ...
    |                        |                |                |                                                |
    +------------------------+----------------+----------------+------------------------------------------------+
    | PASSES                 |    unsigned    |    4           | The number of operations  per call to the      |
    |                        |                |                | kernel.                                        |
    +------------------------+----------------+----------------+------------------------------------------------+
    | CASC_LEN               |    unsigned    |    1           | The number of cascaded kernels to              |
    |                        |                |                | be used to perform the function.               |
