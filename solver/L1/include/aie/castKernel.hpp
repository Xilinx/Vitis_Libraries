...
class castKernel {
   ...
   public:
    ...
    void cast_main(input_buffer<cfloat>& __restrict in, output_buffer<float>& __restrict out);

    // Register Kernel Class
    static void registerKernelClass() { REGISTER_FUNCTION(castKernel::cast_main); }
};
