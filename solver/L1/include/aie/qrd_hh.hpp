...
class qrd_hh_kernel {
   ...
   public:
      ...
      static constexpr int m_kRcolNum = (TP_DIM_ROWS <= TP_DIM_COLS - (TP_KERNEL_POS*TP_DIM_ROWS)) ? TP_DIM_ROWS : (TP_DIM_COLS - (TP_KERNEL_POS*TP_DIM_ROWS)); //Remaining col number for R update
      ...
      static constexpr int m_kColChunkLeadingEnd = m_kColChunkLeadingStart + m_kRowChunkNum - 1; //Leading col chunk to end
      ...
      static constexpr auto m_kKernelRolesR = det_kernel_roles_r<m_kColChunkNum, m_kRowChunkNum, m_kColChunkLeadingStart, m_kColChunkLeadingEnd, m_kColChunkFinalStart, TP_KERNEL_POS, TP_CASC_LEN>();

      static constexpr auto m_kKernelRolesQ = det_kernel_roles_q<m_kColChunkNum, m_kRowChunkNum, m_kColChunkLeadingStart, m_kColChunkLeadingEnd, m_kColChunkFinalStart, TP_KERNEL_POS, TP_CASC_LEN>();
...
class qrd_hh : qrd_hh_kernel<TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, TP_ROUT_EN, TP_STREAM_EN> {
   ...
   public:
      ...
      // Constructor
      qrd_hh() : qrd_hh_kernel<TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, TP_ROUT_EN, TP_STREAM_EN>(){};
...
// QRD kernel class -- multi kernel operating, streaming input and output of kernels, no R output due to Rs being ourputted from the upper kernels
template <typename TT_DATA,
          unsigned int TP_DIM_ROWS,
          unsigned int TP_DIM_COLS,
          unsigned int TP_NUM_FRAMES,
...
class qrd_hh <TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, false, true>: qrd_hh_kernel<TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, false, true> {
   private:
   public:

      // Constructor
      qrd_hh() : qrd_hh_kernel<TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, false, true>(){};
...
class qrd_hh <TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, true, true>: qrd_hh_kernel<TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, true, true> {
   private:
   public:

      // Constructor
      qrd_hh() : qrd_hh_kernel<TT_DATA, TP_DIM_ROWS, TP_DIM_COLS, TP_NUM_FRAMES, TP_CASC_LEN, TP_KERNEL_POS, true, true>(){};
