...
std::string fin = "datas/A_" + std::to_string(DIM) + ".txt";
std::string fgld = "datas/Lgld_" + std::to_string(DIM) + ".txt";
std::string fout = "datas/Lout_" + std::to_string(DIM) + ".txt";
...
int main() {
    ...
    A.matrix_mul(L, LT);
    A.print();
    writeComplextoFileByRow<Type>(A, fin);
