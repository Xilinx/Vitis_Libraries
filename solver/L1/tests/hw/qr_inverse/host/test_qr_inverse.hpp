...
#ifndef _DUT_QR_INVERSE_HPP_
#define _DUT_QR_INVERSE_HPP_
...
struct lapack_interface {
    typedef T QR_INV_TYPE;
    typedef T QR_INV_BASE_TYPE;
...
struct lapack_interface<hls::x_complex<T> > {
    typedef hls::x_complex<T> QR_INV_TYPE;
    typedef T QR_INV_BASE_TYPE;
...
struct lapack_interface<std::complex<T> > {
    typedef std::complex<T> QR_INV_TYPE;
    typedef T QR_INV_BASE_TYPE;
...
struct lapack_interface<ap_fixed<W, I, Q, O, N> > {
    typedef double QR_INV_TYPE;
    typedef double QR_INV_BASE_TYPE;
...
struct lapack_interface<hls::x_complex<ap_fixed<W, I, Q, O, N> > > {
    typedef hls::x_complex<double> QR_INV_TYPE;
    typedef double QR_INV_BASE_TYPE;
...
struct lapack_interface<std::complex<ap_fixed<W, I, Q, O, N> > > {
    typedef std::complex<double> QR_INV_TYPE;
    typedef double QR_INV_BASE_TYPE;
...
const QR_INV_BASE_TYPE eps = hls::numeric_limits<MATRIX_IN_BASE_T>::epsilon();
