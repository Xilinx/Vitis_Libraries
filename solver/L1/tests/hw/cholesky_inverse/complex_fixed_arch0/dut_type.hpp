...
const int TOTAL_BITS_OUT = 31;
const int I_BITS_OUT = 13;

typedef hls::x_complex<ap_fixed<TOTAL_BITS_IN, I_BITS_IN, AP_RND_CONV> > MATRIX_IN_T;
typedef hls::x_complex<ap_fixed<TOTAL_BITS_OUT, I_BITS_OUT, AP_RND_CONV> > MATRIX_OUT_T;
