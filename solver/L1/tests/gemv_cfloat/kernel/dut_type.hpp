...
//const unsigned int K = 251;
//const unsigned int N = 1;
//const unsigned int M = 32;
//const unsigned int K = 16;
//const unsigned int N = 1;
const unsigned ROWA= _ROWSA;
const unsigned COLA= _COLSA;
const unsigned ROWB= _COLSA;
const unsigned COLB= _COLSB;
const unsigned ROWC= _ROWSA;
const unsigned COLC= _COLSB;
const unsigned BR = 4;
const unsigned BC = 4;
