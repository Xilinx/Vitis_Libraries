...
.. meta::
   :keywords: Vitis, Library, Data Compression, AMD, L1 Modules, Data Compression HLS, ZLIB HLS, LZ4 HLS, Google Snappy HLS , HLS Streams, HLS Dataflow, HLS Pipeline, HLS Unroll, HLS Array Partition
...
The Algorithm library provides a range of primitives for implementing data compression in C++ for AMD Vitis™. Headers for these hardware APIs can be found in the ``include`` directory of the package.
