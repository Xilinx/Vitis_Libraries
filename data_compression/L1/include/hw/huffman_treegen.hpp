...
const static uint8_t c_tgnBitlengthBits = 4;
...
void computeBitLength(ap_uint<SYMBOL_BITS>* parent,
    ...
    ap_uint<SYMBOL_SIZE> tmp;
    child_depth[num_symbols - 1] = 0; // Depth of the root node is 0.
...
inline void lcl_ddr2bram(Frequency* inFreq, uint32_t* lit_freq, uint32_t* dist_freq) {
#pragma HLS inline
