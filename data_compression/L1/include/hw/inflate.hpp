...
template <int DECODER, int PARALLEL_BYTES, int HISTORY_SIZE = (32 * 1024)>
...
#pragma HLS dataflow
    ...
    xf::compression::details::lzProcessingUnit<ap_uint<9> >(bitunpackstream, litLenStream, matchLenStream, offsetStream,
                                                            lzProcOutStream);
...
#pragma HLS dataflow
    ...
    details::inflateMultiByteCore<DECODER, PARALLEL_BYTES, HISTORY_SIZE>(axi2HlsStrm, axi2HlsEos, inflateOut);
