 ...
 * @brief adler32
 *
 * @tparam W Input DataWidth
 * @param adlerStrm Initial adler value
 * @param inStrm  input data stream
 * @param inPackLenStrm input data strb
 * @param outStrm output adler output
 */
template <int W>
