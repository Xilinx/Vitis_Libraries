...
{   
    xf::compression::lz4DecompressEngine_NinMout<INPUT_BYTES, OUTPUT_BYTES, HISTORY_SIZE>(inStream, outStream, input_size);
}
...
int main(int argc, char* argv[]) {
    ...
    if (pass) {
        ...
        std::cout << "TEST FAILED"  << "\tcnt_error=" <<cnt_error << std::endl;
        return 1;
    }
