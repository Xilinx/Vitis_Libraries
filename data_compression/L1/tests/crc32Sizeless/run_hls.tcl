...
if {$CSIM == 1} {
  csim_design -argv "${XF_PROJ_ROOT}/L1/tests/crc32Sizeless/sample.txt" 
}
...
if {$COSIM == 1} {
  cosim_design -disable_dependency_check -argv "${XF_PROJ_ROOT}/L1/tests/crc32Sizeless/sample.txt"
}
