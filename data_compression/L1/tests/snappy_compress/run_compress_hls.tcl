...
if {$CSIM == 1} {
  csim_design -O -argv "${XF_PROJ_ROOT}/common/data/sample.txt ${XF_PROJ_ROOT}/common/data/sample.txt.snappy"
}
...
if {$COSIM == 1} {
  cosim_design -O -argv "${XF_PROJ_ROOT}/common/data/sample.txt ${XF_PROJ_ROOT}/common/data/sample.txt.snappy"
}
