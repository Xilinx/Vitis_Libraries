...
#ifndef _XFCOMPRESSION_BLOCK_STREAM_PERF_DM_HPP_
#define _XFCOMPRESSION_BLOCK_STREAM_PERF_DM_HPP_

/**
 * @file block_stream_perf_dm.hpp
 ...
 * @param numItr            number of iterations
...
#endif // _XFCOMPRESSION_BLOCK_STREAM_PERF_DM_HPP_
