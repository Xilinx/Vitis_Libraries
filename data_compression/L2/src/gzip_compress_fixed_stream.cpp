 ...
 */
/**
 * @file gzip_compress_fixed_stream.cpp
 * @brief Source for GZIP compression kernel.
 *
 * This file is part of Vitis Data Compression Library.
 */

#ifndef _XFCOMPRESSION_GZIP_COMPRESS_FIXED_STREAM_CPP_
#define _XFCOMPRESSION_GZIP_COMPRESS_FIXED_STREAM_CPP_
...
#pragma HLS interface ap_ctrl_none port = return
    ...
    xf::compression::zlibCompressStaticStreaming<GMEM_IN_DWIDTH, GMEM_OUT_DWIDTH, ZLIB_BLOCK_SIZE>(inStream, outStream,
                                                                                                   inSizeStream);
}
}
#endif
