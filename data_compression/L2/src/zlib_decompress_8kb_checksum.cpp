...
#include "zlib_decompress_8kb_checksum.hpp"
...
#pragma HLS interface axis port = outaxistreamd
    ...
    xf::compression::inflate<DECODER_TYPE, MULTIPLE_BYTES, xf::compression::FileFormat::ZLIB, c_historySize,
                             TUSER_WIDTH>(inaxistreamd, outaxistreamd);
}
}
