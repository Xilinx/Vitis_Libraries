...
#include "zlib_decompress_fixed.hpp"

const int c_historySize = LZ_MAX_OFFSET_LIMIT;

extern "C" {
void xilDecompressFixed(hls::stream<ap_axiu<16, 0, 0, 0> >& inaxistreamd,
...
#pragma HLS interface axis port = outaxistreamd
    ...
    xf::compression::inflateMultiByte<DECODER_TYPE, MULTIPLE_BYTES, c_historySize>(inaxistreamd, outaxistreamd);
}
}
