 ...
 */
/**
 * @file zlib_compress_mm.cpp
 * @brief Source for ZLIB compression kernel.
 *
 * This file is part of Vitis Data Compression Library.
 */

#include "zlib_compress_mm.hpp"
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
    ...
    xf::compression::zlibCompressMM<xf::compression::uintMemWidth_t, GMEM_DWIDTH, GMEM_BURST_SIZE, ZLIB_BLOCK_SIZE>(
