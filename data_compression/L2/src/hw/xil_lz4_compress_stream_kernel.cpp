...
extern "C" {
void xilLz4CompressStream(hls::stream<xf::compression::pkt1b>& inaxistream,
                          hls::stream<xf::compression::pkt1b>& outaxistream,
                          hls::stream<xf::compression::pkt4b>& compressedsizeaxis,
                          uint32_t inputSize) {
...
#pragma HLS dataflow
    ...
    xf::compression::axis2s(inaxistream, inStream, inputSize);
    ...
    xf::compression::s2axis(outStream, lz4OutEos, outaxistream, compressedSize, compressedsizeaxis);
}
}
