...
void xilLz4DecompressStream(hls::stream<ap_axiu<c_parallelBit, 0, 0, 0> >& inaxistream,
...
#pragma HLS dataflow
    ...
    xf::compression::lz4DecompressEngine<MULTIPLE_BYTES, historySize>(inStream, decompressedStream, lzxendOfStream,
