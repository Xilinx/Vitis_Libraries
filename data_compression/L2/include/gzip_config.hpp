 ...
 *
 */
#ifndef _XFCOMPRESSION_GZIP_CONFIG_H_
#define _XFCOMPRESSION_GZIP_CONFIG_H_

/**
 * @file gzip_config.h
 * @brief Header for configuration for gzip compression and decompression kernels.
 *
...
#endif // _XFCOMPRESSION_GZIP_CONFIG_H_
