...
#ifndef _XFCOMPRESSION_ZLIB_DECOMPRESS_FULL_HPP_
#define _XFCOMPRESSION_ZLIB_DECOMPRESS_FULL_HPP_

/**
 * @file zlib_decompress_full.hpp
 * @brief Header for zlib decompression full kernel.
 *
...
extern "C" {
/**
 * @brief Zlib decompression full kernel top function.
 *
