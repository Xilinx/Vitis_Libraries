...
#ifndef _XFCOMPRESSION_ZLIB_DECOMPRESS_FIXED_HPP_
#define _XFCOMPRESSION_ZLIB_DECOMPRESS_FIXED_HPP_

/**
 * @file zlib_decompress_fixed.hpp
 * @brief Header for zlib decompression fixed kernel.
 *
...
extern "C" {
/**
 * @brief Zlib decompression fixed kernel top function.
 *
 ...
 *
 */
void xilDecompressFixed(uint32_t input_size,
