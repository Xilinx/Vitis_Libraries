 ...
 *
 */
#ifndef _XFCOMPRESSION_GZIP_COMPRESS_FIXED_STREAM_HPP_
#define _XFCOMPRESSION_GZIP_COMPRESS_FIXED_STREAM_HPP_

/**
 * @file gzip_compress_fixed_stream.hpp
 ...
 * in block based fashion and writes the output to global memory. This kernel uses fixed
