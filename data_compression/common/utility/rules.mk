...
.PHONY: clean
clean:
	rm -rf $(EXE_GOALS) $(XCLBIN_DIR)/{*sw_emu*,*hw_emu*} vitis_* TempConfig system_estimate.xtxt *.rpt
	rm -rf src/*.ll _xocc_* .Xil emconfig.json $(EXTRA_CLEAN) dltmp* xmltmp* *.log *.jou *.wcfg *.wdb
	rm -rf ../benchmark/*/*.lz4 ../benchmark/*/*.out ../benchmark/*/*.orig ../benchmark/*/*_xil ../benchmark/*/*.xe2sd
