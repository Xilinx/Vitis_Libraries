...
The GZip example resides in the ``L2/demos/gzip`` directory. 
...
The following table presents the resource utilization of the GZip Compress/Decompress kernels. The final Fmax achieved is 300 MHz. 
...
.. note:: The overall throughput can still be increased with multiple computes.


Standard GZip Support
---------------------

This application is compatible with the standard Gzip/Zlib application (compress/decompres).  
