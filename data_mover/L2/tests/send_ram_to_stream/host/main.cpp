...
int main(int argc, const char* argv[]) {
    ...
    int mode = 0;
    kernel0.setArg(0, mode);
    kernel0.setArg(1, ch1_buff[0]);
    kernel0.setArg(3, (uint64_t)SIZE);
    kernel0.setArg(4, ch2_buff[0]);
    kernel0.setArg(6, (uint64_t)SIZE);
