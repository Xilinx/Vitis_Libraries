...
#include "config.hpp" // define NUM_PORTS
static constexpr int DATA_COUNT = 1 << 10;
...
int main(int argc, const char* argv[]) {
    ...
    auto krnl_mm2s = xrt::kernel(device, uuid, "mm2s_mp");
    auto krnl_s2mm = xrt::kernel(device, uuid, "s2mm_mp");
