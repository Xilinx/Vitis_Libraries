...
extern "C" void {krnl_name} ("""
    ...
    hls::stream<ap_axiu<{S_WIDTH}, 0, 0, 0> >& axis_i{i}"""
...
#pragma HLS interface axis port=axis_i{i}"""
...
"""
    for i in range(NUM_PORTS):
        code += f"""
    xf::data_mover::stream_to_ddr<{S_WIDTH}, {C_DEPTH}, {c_latency}, {MM_BURST_LEN}, {MM_OUTSTANDING}>(cfg{i}, data{i}, sync_i{i}, sync_o{i}, axis_i{i});"""
