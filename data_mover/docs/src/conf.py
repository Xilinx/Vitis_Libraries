...
project = 'Vitis Data Mover Library'
...
htmlhelp_basename = 'xf_data_mover'
...
latex_documents = [
    (master_doc, 'xf_data_mover.tex', 'Vitis Data Mover Library',
     'Xilinx', 'manual'),
]
...
man_pages = [
    (master_doc, 'xf_data_mover', 'Vitis Data Mover Library',
     [author], 1)
]
