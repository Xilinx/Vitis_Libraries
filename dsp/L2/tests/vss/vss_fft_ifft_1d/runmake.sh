...
then
    ...
    test_arr[${#test_arr[*]}]="make all DATA_TYPE=cint32 TWIDDLE_TYPE=cint16 SSR=16 PARALLEL_POWER=2 SHIFT=5 POINT_SIZE=8192 AIE_VARIANT=1"
    test_arr[${#test_arr[*]}]="make all DATA_TYPE=cint32 TWIDDLE_TYPE=cint16 SSR=16 PARALLEL_POWER=2 SHIFT=5 POINT_SIZE=8192 AIE_VARIANT=1 API_IO=1"
    ...
    test_arr[${#test_arr[*]}]="make all DATA_TYPE=cint16 TWIDDLE_TYPE=cint16 SSR=4 PARALLEL_POWER=2 SHIFT=10 POINT_SIZE=2048 AIE_VARIANT=2 PART=xcve2802-vsvh1760-2MP-e-S API_IO=1"
    test_arr[${#test_arr[*]}]="make all VSS_MODE=1 DATA_TYPE=cint16 TWIDDLE_TYPE=cint16 SSR=8  PARALLEL_POWER=2 SHIFT=10 POINT_SIZE=4096 AIE_VARIANT=22 PART=xc2ve3858-ssva2112-2LP-e-S API_IO=1"
# vss_mode = 2
    ...
    test_arr[${#test_arr[*]}]="make all VSS_MODE=2 DATA_TYPE=cint16 TWIDDLE_TYPE=cint16 SSR=8  PARALLEL_POWER=2 SHIFT=10 POINT_SIZE=2048 AIE_VARIANT=2 PART=xcve2802-vsvh1760-2MP-e-S API_IO=1"
fi
