...
#endif
    fft2dKernel<k_memWidthBits, k_memWidth, k_numRows, k_numCols, k_numImages, k_wordLength, k_growLength,
                k_numOfKernels, FFTParams, FFTParams2, k_rowInstanceIDOffset, k_colInstanceIDOffset, T_elemType,
                T_outType>(p_fftInData, p_fftOutData, n_images);
}
