 ...
 */
#ifndef FIR_Symmetric_Stream_ba71117a_GRAPH_H_
#define FIR_Symmetric_Stream_ba71117a_GRAPH_H_

#include <adf.h>
#include "fir_sr_sym_graph.hpp"

class FIR_Symmetric_Stream_ba71117a : public adf::graph {
   public:
    ...
    FIR_Symmetric_Stream_ba71117a() : filter(taps) {
...
#endif // FIR_Symmetric_Stream_ba71117a_GRAPH_H_
