 ...
 */
#ifndef FIR_Symmetric_Stream_801ef6d0_GRAPH_H_
#define FIR_Symmetric_Stream_801ef6d0_GRAPH_H_

#include <adf.h>
#include "fir_sr_sym_graph.hpp"

class FIR_Symmetric_Stream_801ef6d0 : public adf::graph {
   public:
    ...
    FIR_Symmetric_Stream_801ef6d0() : filter(taps) {
...
#endif // FIR_Symmetric_Stream_801ef6d0_GRAPH_H_
