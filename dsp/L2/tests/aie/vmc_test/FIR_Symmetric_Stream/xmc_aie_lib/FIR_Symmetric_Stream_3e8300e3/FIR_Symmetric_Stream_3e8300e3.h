 ...
 */
#ifndef FIR_Symmetric_Stream_3e8300e3_GRAPH_H_
#define FIR_Symmetric_Stream_3e8300e3_GRAPH_H_

#include <adf.h>
#include "fir_sr_sym_graph.hpp"

class FIR_Symmetric_Stream_3e8300e3 : public adf::graph {
   public:
    ...
    xf::dsp::aie::fir::sr_sym::fir_sr_sym_graph<cint16, // TT_DATA
                                                int16,  // TT_COEFF
                                                32,     // TP_FIR_LEN
                                                0,      // TP_SHIFT
                                                0,      // TP_RND
    ...
    FIR_Symmetric_Stream_3e8300e3() : filter(taps) {
...
#endif // FIR_Symmetric_Stream_3e8300e3_GRAPH_H_
