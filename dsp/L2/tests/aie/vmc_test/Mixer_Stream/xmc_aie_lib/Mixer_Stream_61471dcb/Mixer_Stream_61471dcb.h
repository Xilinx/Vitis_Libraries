 ...
 */
#ifndef Mixer_Stream_61471dcb_GRAPH_H_
#define Mixer_Stream_61471dcb_GRAPH_H_

#include <adf.h>
#include "dds_mixer_graph.hpp"

class Mixer_Stream_61471dcb : public adf::graph {
   public:
    // ports
    ...
    xf::dsp::aie::mixer::dds_mixer::dds_mixer_graph<cint16, // TT_DATA
                                                    ...
                                                    >
        mixer_graph;
    Mixer_Stream_61471dcb() : mixer_graph(0, 0) {
        // kernels
        // runtime_ratio
        // connections in loop
...
#endif // Mixer_Stream_61471dcb_GRAPH_H_
