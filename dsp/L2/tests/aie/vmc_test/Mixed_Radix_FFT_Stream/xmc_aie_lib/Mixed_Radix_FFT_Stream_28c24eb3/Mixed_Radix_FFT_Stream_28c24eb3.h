 ...
 */
#ifndef Mixed_Radix_FFT_Stream_28c24eb3_GRAPH_H_
#define Mixed_Radix_FFT_Stream_28c24eb3_GRAPH_H_

#include <adf.h>
#include "mixed_radix_fft_graph.hpp"

class Mixed_Radix_FFT_Stream_28c24eb3 : public adf::graph {
   public:
    // ports
    ...
    Mixed_Radix_FFT_Stream_28c24eb3() : mixed_radix_fft_graph() {
        if (1 == 0) {
...
#endif // Mixed_Radix_FFT_Stream_28c24eb3_GRAPH_H_
