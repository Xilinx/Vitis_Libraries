 ...
 */
#ifndef FIR_Interpolation_67359202_GRAPH_H_
#define FIR_Interpolation_67359202_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_asym_graph.hpp"

class FIR_Interpolation_67359202 : public adf::graph {
   public:
    ...
    FIR_Interpolation_67359202() : filter(taps) {
...
#endif // FIR_Interpolation_67359202_GRAPH_H_
