 ...
 */
#ifndef FIR_Interpolation_ce5fef0f_GRAPH_H_
#define FIR_Interpolation_ce5fef0f_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_asym_graph.hpp"

class FIR_Interpolation_ce5fef0f : public adf::graph {
   public:
    ...
    FIR_Interpolation_ce5fef0f() : filter(taps) {
...
#endif // FIR_Interpolation_ce5fef0f_GRAPH_H_
