 ...
 */
#ifndef FIR_Interpolation_83dd6162_GRAPH_H_
#define FIR_Interpolation_83dd6162_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_asym_graph.hpp"

class FIR_Interpolation_83dd6162 : public adf::graph {
   public:
    ...
    FIR_Interpolation_83dd6162() : filter(taps) {
...
#endif // FIR_Interpolation_83dd6162_GRAPH_H_
