 ...
 */
#ifndef FIR_Resampler_Filter_4dcd5a5d_GRAPH_H_
#define FIR_Resampler_Filter_4dcd5a5d_GRAPH_H_

#include <adf.h>
#include "fir_resampler_graph.hpp"

class FIR_Resampler_Filter_4dcd5a5d : public adf::graph {
   public:
    ...
    FIR_Resampler_Filter_4dcd5a5d() : filter(taps) {
...
#endif // FIR_Resampler_Filter_4dcd5a5d_GRAPH_H_
