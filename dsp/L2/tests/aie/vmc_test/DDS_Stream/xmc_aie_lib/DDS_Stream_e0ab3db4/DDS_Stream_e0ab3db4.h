 ...
 */
#ifndef DDS_Stream_e0ab3db4_GRAPH_H_
#define DDS_Stream_e0ab3db4_GRAPH_H_

#include <adf.h>
#include "dds_mixer_graph.hpp"

class DDS_Stream_e0ab3db4 : public adf::graph {
   public:
    // ports
    ...
    xf::dsp::aie::mixer::dds_mixer::dds_mixer_graph<cint16, // TT_DATA
                                                    ...
                                                    >
        mixer_graph;
    DDS_Stream_e0ab3db4() : mixer_graph(0, 0) {
        // kernels
        // runtime_ratio
        // connections in loop
...
#endif // DDS_Stream_e0ab3db4_GRAPH_H_
