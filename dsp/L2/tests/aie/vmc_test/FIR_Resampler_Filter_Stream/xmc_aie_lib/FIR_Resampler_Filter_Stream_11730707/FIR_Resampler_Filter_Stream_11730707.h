 ...
 */
#ifndef FIR_Resampler_Filter_Stream_11730707_GRAPH_H_
#define FIR_Resampler_Filter_Stream_11730707_GRAPH_H_

#include <adf.h>
#include "fir_resampler_graph.hpp"

using namespace adf;
class FIR_Resampler_Filter_Stream_11730707 : public adf::graph {
   public:
    ...
    FIR_Resampler_Filter_Stream_11730707() : filter(taps) {
...
#endif // FIR_Resampler_Filter_Stream_11730707_GRAPH_H_
