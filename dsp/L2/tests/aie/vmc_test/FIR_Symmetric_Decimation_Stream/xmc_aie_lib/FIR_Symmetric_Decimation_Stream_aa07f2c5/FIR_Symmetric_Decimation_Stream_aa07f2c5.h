 ...
 */
#ifndef FIR_Symmetric_Decimation_Stream_aa07f2c5_GRAPH_H_
#define FIR_Symmetric_Decimation_Stream_aa07f2c5_GRAPH_H_

#include <adf.h>
#include "fir_decimate_sym_graph.hpp"

class FIR_Symmetric_Decimation_Stream_aa07f2c5 : public adf::graph {
   public:
    ...
    FIR_Symmetric_Decimation_Stream_aa07f2c5() : filter(taps) {
...
#endif // FIR_Symmetric_Decimation_Stream_aa07f2c5_GRAPH_H_
