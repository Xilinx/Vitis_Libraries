 ...
 */
#ifndef FIR_Halfband_Decimator_225db10e_GRAPH_H_
#define FIR_Halfband_Decimator_225db10e_GRAPH_H_

#include <adf.h>
#include "fir_decimate_hb_graph.hpp"

class FIR_Halfband_Decimator_225db10e : public adf::graph {
   public:
    ...
    FIR_Halfband_Decimator_225db10e() : filter(taps) {
...
#endif // FIR_Halfband_Decimator_225db10e_GRAPH_H_
