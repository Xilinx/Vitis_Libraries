 ...
 */
#ifndef FIR_Halfband_Decimator_acf59597_GRAPH_H_
#define FIR_Halfband_Decimator_acf59597_GRAPH_H_

#include <adf.h>
#include "fir_decimate_hb_graph.hpp"

class FIR_Halfband_Decimator_acf59597 : public adf::graph {
   public:
    ...
    FIR_Halfband_Decimator_acf59597() : filter(taps) {
...
#endif // FIR_Halfband_Decimator_acf59597_GRAPH_H_
