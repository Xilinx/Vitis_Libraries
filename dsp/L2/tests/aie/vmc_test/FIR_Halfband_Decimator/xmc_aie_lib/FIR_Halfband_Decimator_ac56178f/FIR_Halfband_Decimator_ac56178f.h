 ...
 */
#ifndef FIR_Halfband_Decimator_ac56178f_GRAPH_H_
#define FIR_Halfband_Decimator_ac56178f_GRAPH_H_

#include <adf.h>
#include "fir_decimate_hb_graph.hpp"

class FIR_Halfband_Decimator_ac56178f : public adf::graph {
   public:
    ...
    FIR_Halfband_Decimator_ac56178f() : filter(taps) {
...
#endif // FIR_Halfband_Decimator_ac56178f_GRAPH_H_
