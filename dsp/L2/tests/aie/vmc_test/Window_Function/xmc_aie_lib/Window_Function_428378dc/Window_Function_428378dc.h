 ...
 */
#ifndef Window_Function_428378dc_GRAPH_H_
#define Window_Function_428378dc_GRAPH_H_

#include <adf.h>
#include "fft_window_graph.hpp"

class Window_Function_428378dc : public adf::graph {
   public:
    ...
    Window_Function_428378dc() : fft_window(weights) {
...
#endif // Window_Function_428378dc_GRAPH_H_
