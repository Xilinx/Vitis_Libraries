 ...
 */
#ifndef Window_Function_199c7552_GRAPH_H_
#define Window_Function_199c7552_GRAPH_H_

#include <adf.h>
#include "fft_window_graph.hpp"

class Window_Function_199c7552 : public adf::graph {
   public:
    ...
    Window_Function_199c7552() : fft_window(weights) {
...
#endif // Window_Function_199c7552_GRAPH_H_
