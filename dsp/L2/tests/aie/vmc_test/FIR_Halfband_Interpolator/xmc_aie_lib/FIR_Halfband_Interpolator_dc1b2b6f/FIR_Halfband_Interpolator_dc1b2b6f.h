 ...
 */
#ifndef FIR_Halfband_Interpolator_dc1b2b6f_GRAPH_H_
#define FIR_Halfband_Interpolator_dc1b2b6f_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_hb_graph.hpp"

class FIR_Halfband_Interpolator_dc1b2b6f : public adf::graph {
   public:
    ...
    FIR_Halfband_Interpolator_dc1b2b6f() : filter(taps) {
...
#endif // FIR_Halfband_Interpolator_dc1b2b6f_GRAPH_H_
