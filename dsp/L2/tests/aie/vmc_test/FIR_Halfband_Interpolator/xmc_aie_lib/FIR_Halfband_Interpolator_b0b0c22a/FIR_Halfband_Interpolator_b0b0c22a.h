 ...
 */
#ifndef FIR_Halfband_Interpolator_b0b0c22a_GRAPH_H_
#define FIR_Halfband_Interpolator_b0b0c22a_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_hb_graph.hpp"

class FIR_Halfband_Interpolator_b0b0c22a : public adf::graph {
   public:
    ...
    FIR_Halfband_Interpolator_b0b0c22a() : filter(taps) {
...
#endif // FIR_Halfband_Interpolator_b0b0c22a_GRAPH_H_
