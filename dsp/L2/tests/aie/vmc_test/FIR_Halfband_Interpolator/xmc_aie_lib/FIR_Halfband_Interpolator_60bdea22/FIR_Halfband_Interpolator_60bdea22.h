 ...
 */
#ifndef FIR_Halfband_Interpolator_60bdea22_GRAPH_H_
#define FIR_Halfband_Interpolator_60bdea22_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_hb_graph.hpp"

class FIR_Halfband_Interpolator_60bdea22 : public adf::graph {
   public:
    ...
    FIR_Halfband_Interpolator_60bdea22() : filter(taps) {
...
#endif // FIR_Halfband_Interpolator_60bdea22_GRAPH_H_
