 ...
 */
#ifndef FIR_Interpolation_Stream_7498103a_GRAPH_H_
#define FIR_Interpolation_Stream_7498103a_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_asym_graph.hpp"

class FIR_Interpolation_Stream_7498103a : public adf::graph {
   public:
    ...
    FIR_Interpolation_Stream_7498103a() : filter(taps) {
...
#endif // FIR_Interpolation_Stream_7498103a_GRAPH_H_
