 ...
 */
#ifndef FIR_Interpolation_Stream_4cc68ad1_GRAPH_H_
#define FIR_Interpolation_Stream_4cc68ad1_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_asym_graph.hpp"

class FIR_Interpolation_Stream_4cc68ad1 : public adf::graph {
   public:
    ...
    FIR_Interpolation_Stream_4cc68ad1() : filter(taps) {
...
#endif // FIR_Interpolation_Stream_4cc68ad1_GRAPH_H_
