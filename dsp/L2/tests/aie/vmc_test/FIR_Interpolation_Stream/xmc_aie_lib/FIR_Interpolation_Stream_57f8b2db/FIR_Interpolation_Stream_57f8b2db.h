 ...
 */
#ifndef FIR_Interpolation_Stream_57f8b2db_GRAPH_H_
#define FIR_Interpolation_Stream_57f8b2db_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_asym_graph.hpp"

class FIR_Interpolation_Stream_57f8b2db : public adf::graph {
   public:
    ...
    FIR_Interpolation_Stream_57f8b2db() : filter(taps) {
...
#endif // FIR_Interpolation_Stream_57f8b2db_GRAPH_H_
