 ...
 */
#ifndef FIR_Asymmetric_Stream_4ceb34ca_GRAPH_H_
#define FIR_Asymmetric_Stream_4ceb34ca_GRAPH_H_

#include <adf.h>
#include "fir_sr_asym_graph.hpp"

class FIR_Asymmetric_Stream_4ceb34ca : public adf::graph {
   public:
    ...
    FIR_Asymmetric_Stream_4ceb34ca() : filter(taps) {
...
#endif // FIR_Asymmetric_Stream_4ceb34ca_GRAPH_H_
