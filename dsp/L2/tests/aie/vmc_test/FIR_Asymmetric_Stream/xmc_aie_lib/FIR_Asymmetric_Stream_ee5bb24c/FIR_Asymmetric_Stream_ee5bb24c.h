 ...
 */
#ifndef FIR_Asymmetric_Stream_ee5bb24c_GRAPH_H_
#define FIR_Asymmetric_Stream_ee5bb24c_GRAPH_H_

#include <adf.h>
#include "fir_sr_asym_graph.hpp"

class FIR_Asymmetric_Stream_ee5bb24c : public adf::graph {
   public:
    ...
    FIR_Asymmetric_Stream_ee5bb24c() : filter(taps) {
...
#endif // FIR_Asymmetric_Stream_ee5bb24c_GRAPH_H_
