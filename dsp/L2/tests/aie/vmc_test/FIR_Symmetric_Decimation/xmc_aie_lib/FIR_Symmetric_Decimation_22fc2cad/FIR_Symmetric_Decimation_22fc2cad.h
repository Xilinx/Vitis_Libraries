 ...
 */
#ifndef FIR_Symmetric_Decimation_22fc2cad_GRAPH_H_
#define FIR_Symmetric_Decimation_22fc2cad_GRAPH_H_

#include <adf.h>
#include "fir_decimate_sym_graph.hpp"

class FIR_Symmetric_Decimation_22fc2cad : public adf::graph {
   public:
    ...
    FIR_Symmetric_Decimation_22fc2cad() : filter(taps) {
...
#endif // FIR_Symmetric_Decimation_22fc2cad_GRAPH_H_
