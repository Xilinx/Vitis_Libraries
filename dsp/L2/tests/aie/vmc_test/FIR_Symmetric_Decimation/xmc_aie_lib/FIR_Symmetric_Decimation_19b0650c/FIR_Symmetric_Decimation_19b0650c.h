 ...
 */
#ifndef FIR_Symmetric_Decimation_19b0650c_GRAPH_H_
#define FIR_Symmetric_Decimation_19b0650c_GRAPH_H_

#include <adf.h>
#include "fir_decimate_sym_graph.hpp"

class FIR_Symmetric_Decimation_19b0650c : public adf::graph {
   public:
    ...
    FIR_Symmetric_Decimation_19b0650c() : filter(taps) {
...
#endif // FIR_Symmetric_Decimation_19b0650c_GRAPH_H_
