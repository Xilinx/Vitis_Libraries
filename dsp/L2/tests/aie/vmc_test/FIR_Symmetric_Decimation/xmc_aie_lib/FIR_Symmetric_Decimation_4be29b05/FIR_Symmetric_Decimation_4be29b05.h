 ...
 */
#ifndef FIR_Symmetric_Decimation_4be29b05_GRAPH_H_
#define FIR_Symmetric_Decimation_4be29b05_GRAPH_H_

#include <adf.h>
#include "fir_decimate_sym_graph.hpp"

class FIR_Symmetric_Decimation_4be29b05 : public adf::graph {
   public:
    ...
    FIR_Symmetric_Decimation_4be29b05() : filter(taps) {
...
#endif // FIR_Symmetric_Decimation_4be29b05_GRAPH_H_
