 ...
 */
#ifndef FIR_Halfband_Interpolator_Stream_f0f298aa_GRAPH_H_
#define FIR_Halfband_Interpolator_Stream_f0f298aa_GRAPH_H_

#include <adf.h>
#include "fir_interpolate_hb_graph.hpp"

class FIR_Halfband_Interpolator_Stream_f0f298aa : public adf::graph {
   public:
    ...
    FIR_Halfband_Interpolator_Stream_f0f298aa() : filter(taps) {
...
#endif // FIR_Halfband_Interpolator_Stream_f0f298aa_GRAPH_H_
