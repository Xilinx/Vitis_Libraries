 ...
 */
#ifndef FIR_Symmetric_22cea747_GRAPH_H_
#define FIR_Symmetric_22cea747_GRAPH_H_

#include <adf.h>
#include "fir_sr_sym_graph.hpp"

class FIR_Symmetric_22cea747 : public adf::graph {
   public:
    ...
    FIR_Symmetric_22cea747() : filter(taps) {
...
#endif // FIR_Symmetric_22cea747_GRAPH_H_
