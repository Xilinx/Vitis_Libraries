 ...
 */
#ifndef FIR_Symmetric_7606e633_GRAPH_H_
#define FIR_Symmetric_7606e633_GRAPH_H_

#include <adf.h>
#include "fir_sr_sym_graph.hpp"

class FIR_Symmetric_7606e633 : public adf::graph {
   public:
    ...
    FIR_Symmetric_7606e633() : filter(taps) {
...
#endif // FIR_Symmetric_7606e633_GRAPH_H_
