 ...
 */
#ifndef FIR_Symmetric_61ec160c_GRAPH_H_
#define FIR_Symmetric_61ec160c_GRAPH_H_

#include <adf.h>
#include "fir_sr_sym_graph.hpp"

class FIR_Symmetric_61ec160c : public adf::graph {
   public:
    ...
    FIR_Symmetric_61ec160c() : filter(taps) {
...
#endif // FIR_Symmetric_61ec160c_GRAPH_H_
