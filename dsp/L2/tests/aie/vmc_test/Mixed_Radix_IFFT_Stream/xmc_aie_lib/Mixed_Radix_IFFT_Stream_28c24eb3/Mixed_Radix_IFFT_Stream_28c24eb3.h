 ...
 */
#ifndef Mixed_Radix_IFFT_Stream_28c24eb3_GRAPH_H_
#define Mixed_Radix_IFFT_Stream_28c24eb3_GRAPH_H_

#include <adf.h>
#include "mixed_radix_fft_graph.hpp"

class Mixed_Radix_IFFT_Stream_28c24eb3 : public adf::graph {
   public:
    // ports
    // template <typename dir>

    static constexpr int kStreamsPerTile = get_input_streams_core_module(); // a device trait
    static constexpr int m_kNumPorts = 1 == 0 ? 1 : kStreamsPerTile;        // 1 for iobuffer, 2 for streams
    ...
    Mixed_Radix_IFFT_Stream_28c24eb3() : mixed_radix_fft_graph() {
        if (1 == 0) {
...
#endif // Mixed_Radix_IFFT_Stream_28c24eb3_GRAPH_H_
