 ...
 */
#ifndef Mixer_LUT_b54af5a2_GRAPH_H_
#define Mixer_LUT_b54af5a2_GRAPH_H_

#include <adf.h>
#include "dds_mixer_lut_graph.hpp"


class Mixer_LUT_b54af5a2 : public adf::graph {
public:
  // ports
  ...
  > mixer_graph;
  Mixer_LUT_b54af5a2() : mixer_graph(0, 0) {
    //kernels
    //runtime_ratio
    //connections in loop
...
#endif // Mixer_LUT_b54af5a2_GRAPH_H_
