 ...
 */
#ifndef DDS_LUT_Stream_97f1d6b9_GRAPH_H_
#define DDS_LUT_Stream_97f1d6b9_GRAPH_H_

#include <adf.h>
#include "dds_mixer_lut_graph.hpp"


class DDS_LUT_Stream_97f1d6b9 : public adf::graph {
public:
  // ports
  ...
  > mixer_graph;
  DDS_LUT_Stream_97f1d6b9() : mixer_graph(0, 0) {
    //kernels
    //runtime_ratio
    //connections in loop
...
#endif // DDS_LUT_Stream_97f1d6b9_GRAPH_H_
