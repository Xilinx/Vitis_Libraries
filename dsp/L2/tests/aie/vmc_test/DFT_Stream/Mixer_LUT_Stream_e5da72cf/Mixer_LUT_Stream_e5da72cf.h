 ...
 */
#ifndef Mixer_LUT_Stream_e5da72cf_GRAPH_H_
#define Mixer_LUT_Stream_e5da72cf_GRAPH_H_

#include <adf.h>
#include "dds_mixer_lut_graph.hpp"


class Mixer_LUT_Stream_e5da72cf : public adf::graph {
public:
  // ports
  ...
  > mixer_graph;
  Mixer_LUT_Stream_e5da72cf() : mixer_graph(0, 0) {
    //kernels
    //runtime_ratio
    //connections in loop
...
#endif // Mixer_LUT_Stream_e5da72cf_GRAPH_H_
