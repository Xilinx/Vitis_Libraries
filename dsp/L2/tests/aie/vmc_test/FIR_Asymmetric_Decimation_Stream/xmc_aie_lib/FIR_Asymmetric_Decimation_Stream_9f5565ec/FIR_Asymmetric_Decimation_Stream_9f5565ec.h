 ...
 */
#ifndef FIR_Asymmetric_Decimation_Stream_9f5565ec_GRAPH_H_
#define FIR_Asymmetric_Decimation_Stream_9f5565ec_GRAPH_H_

#include <adf.h>
#include "fir_decimate_asym_graph.hpp"

class FIR_Asymmetric_Decimation_Stream_9f5565ec : public adf::graph {
   public:
    ...
    FIR_Asymmetric_Decimation_Stream_9f5565ec() : filter(taps) {
...
#endif // FIR_Asymmetric_Decimation_Stream_9f5565ec_GRAPH_H_
