 ...
 */
#ifndef Mixer_LUT_Stream_ddab5496_GRAPH_H_
#define Mixer_LUT_Stream_ddab5496_GRAPH_H_

#include <adf.h>
#include "dds_mixer_lut_graph.hpp"

class Mixer_LUT_Stream_ddab5496 : public adf::graph {
   public:
    // ports
    ...
    xf::dsp::aie::mixer::dds_mixer::dds_mixer_lut_graph<cint16, // TT_DATA
                                                        ...
                                                        >
        mixer_graph;
    Mixer_LUT_Stream_ddab5496() : mixer_graph(0, 0) {
        // kernels
        // runtime_ratio
        // connections in loop
...
#endif // Mixer_LUT_Stream_ddab5496_GRAPH_H_
