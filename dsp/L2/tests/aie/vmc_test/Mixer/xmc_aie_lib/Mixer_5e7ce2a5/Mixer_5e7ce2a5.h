 ...
 */
#ifndef Mixer_5e7ce2a5_GRAPH_H_
#define Mixer_5e7ce2a5_GRAPH_H_

#include <adf.h>
#include "dds_mixer_graph.hpp"

class Mixer_5e7ce2a5 : public adf::graph {
   public:
    // ports
    ...
    xf::dsp::aie::mixer::dds_mixer::dds_mixer_graph<cint16, // TT_DATA
                                                    ...
                                                    >
        mixer_graph;
    Mixer_5e7ce2a5() : mixer_graph(0, 0) {
        // kernels
        // runtime_ratio
        // connections in loop
