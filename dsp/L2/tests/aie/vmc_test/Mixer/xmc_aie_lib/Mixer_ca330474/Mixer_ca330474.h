 ...
 */
#ifndef Mixer_ca330474_GRAPH_H_
#define Mixer_ca330474_GRAPH_H_

#include <adf.h>
#include "dds_mixer_graph.hpp"

class Mixer_ca330474 : public adf::graph {
   public:
    // ports
    ...
    xf::dsp::aie::mixer::dds_mixer::dds_mixer_graph<cint16, // TT_DATA
                                                    ...
                                                    >
        mixer_graph;
    Mixer_ca330474() : mixer_graph(0, 0) {
        // kernels
        // runtime_ratio
        // connections in loop
