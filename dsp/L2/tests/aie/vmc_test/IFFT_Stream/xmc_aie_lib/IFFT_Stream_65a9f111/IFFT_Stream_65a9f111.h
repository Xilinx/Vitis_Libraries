 ...
 */
#ifndef IFFT_Stream_65a9f111_GRAPH_H_
#define IFFT_Stream_65a9f111_GRAPH_H_

#include <adf.h>
#include "fft_ifft_dit_1ch_graph.hpp"

class IFFT_Stream_65a9f111 : public adf::graph {
   public:
    // ports
    ...
    IFFT_Stream_65a9f111() : fft_graph() {
        for (int i = 0; i < 2; i++) {
...
#endif // IFFT_Stream_65a9f111_GRAPH_H_
