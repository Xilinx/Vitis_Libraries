 ...
 */
#ifndef FIR_Halfband_Decimator_Stream_a3c9e17c_GRAPH_H_
#define FIR_Halfband_Decimator_Stream_a3c9e17c_GRAPH_H_

#include <adf.h>
#include "fir_decimate_hb_graph.hpp"

class FIR_Halfband_Decimator_Stream_a3c9e17c : public adf::graph {
   public:
    ...
    FIR_Halfband_Decimator_Stream_a3c9e17c() : filter(taps) {
...
#endif // FIR_Halfband_Decimator_Stream_a3c9e17c_GRAPH_H_
