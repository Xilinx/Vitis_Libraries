 ...
 */
#ifndef DDS_LUT_72b3c4e5_GRAPH_H_
#define DDS_LUT_72b3c4e5_GRAPH_H_

#include <adf.h>
#include "dds_mixer_lut_graph.hpp"

class DDS_LUT_72b3c4e5 : public adf::graph {
   public:
    // ports
    ...
    xf::dsp::aie::mixer::dds_mixer::dds_mixer_lut_graph<cint16, // TT_DATA
                                                        ...
                                                        >
        mixer_graph;
    DDS_LUT_72b3c4e5() : mixer_graph(0, 0) {
        // kernels
        // runtime_ratio
        // connections in loop
...
#endif // DDS_LUT_72b3c4e5_GRAPH_H_
