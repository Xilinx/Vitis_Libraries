 ...
 */
#ifndef Window_Function_Stream_aeca0684_GRAPH_H_
#define Window_Function_Stream_aeca0684_GRAPH_H_

#include <adf.h>
#include "fft_window_graph.hpp"

class Window_Function_Stream_aeca0684 : public adf::graph {
   public:
    ...
    Window_Function_Stream_aeca0684() : fft_window(weights) {
...
#endif // Window_Function_Stream_aeca0684_GRAPH_H_
