...
PARAM_MAP = DATA_TYPE $(DATA_TYPE) MIXER_MODE $(MIXER_MODE) P_API $(P_API) UUT_SSR $(UUT_SSR) DDS_PHASE_INC $(DDS_PHASE_INC) INITIAL_DDS_OFFSET $(INITIAL_DDS_OFFSET) INPUT_WINDOW_VSIZE $(INPUT_WINDOW_VSIZE) ROUND_MODE $(ROUND_MODE) SAT_MODE $(SAT_MODE)
