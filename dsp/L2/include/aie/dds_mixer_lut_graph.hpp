 ...
 */
#ifndef _DSPLIB_DDS_MIXER_LUT_GRAPH_HPP_
#define _DSPLIB_DDS_MIXER_LUT_GRAPH_HPP_
/*
...
class dds_mixer_lut_graph : public graph {
    ...
    **/
    ...
    using kernelClass = dds_mixer<TT_DATA, TP_INPUT_WINDOW_VSIZE, TP_MIXER_MODE, TP_API, USE_LUT_SINCOS, TP_NUM_TABLES>;
...
#endif //_DSPLIB_DDS_MIXER_LUT_GRAPH_HPP_
