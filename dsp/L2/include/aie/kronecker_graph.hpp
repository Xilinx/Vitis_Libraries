 ...
 * @tparam TT_DATA_A describes the data type of input A. \n
 *         This is a typename and must be one of the following: \n
 *         int16, int32, cint16, cint32, float, cfloat.
 * @tparam TT_DATA_B describes the data type of input B. \n
 *         This is a typename and must be one of the following: \n
 *         int16, int32, cint16, cint32, float, cfloat.
 ...
 * @tparam TP_NUM_FRAMES describes number of frames in a window.
 * @tparam TP_API describes whether to use streams (1) or windows (0) on output.
 * @tparam TP_SHIFT described the number of bits to downshift
