...
def vmc_validate_ssr(args):
    ...
    ssr = args["ssr"]
    fir_length = args["fir_length"]
    return fn_validate_TP_SSR(AIE_VARIANT, data_type, coef_type, api, fir_length, use_coeff_reload, decimate_factor, ssr)
...
def vmc_validate_num_outputs(args):
    ...
    api = 1
    AIE_VARIANT = args["AIE_VARIANT"]
    return fn_validate_TP_NUM_OUTPUTS(api, num_outputs, AIE_VARIANT)
