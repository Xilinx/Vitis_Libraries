...
#if 0 // Disable this Header for std::complex<ap_fixed<> > implementation.
...
class std::complex {
   ...
   public:
    ...
    friend std::ostream& operator<<(std::ostream& out, const std::complex<T_in>& c) {
...
template <typename T_in>
inline bool operator==(const std::complex<T_in>& lhs, const std::complex<T_in>& rhs) {
...
#endif // Disable this Header for std::complex<ap_fixed<> > implementation.
