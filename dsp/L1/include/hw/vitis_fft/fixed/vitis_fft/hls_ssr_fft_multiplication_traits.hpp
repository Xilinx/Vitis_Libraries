 ...
 */
template <>
struct FFTMultiplicationTraits<std::complex<float>, std::complex<float> > {
    typedef std::complex<float> T_productOpType;
 ...
 */
template <>
struct FFTMultiplicationTraits<std::complex<double>, std::complex<double> > {
    typedef std::complex<double> T_productOpType;
...
struct FFTMultiplicationTraits<std::complex<ap_fixed<t_op1_WL, t_op1_IL> >,
                               std::complex<ap_fixed<t_op2_WL, t_op2_IL> > > {
    ...
    // typedef std::complex<double> T_accumOutType;
    // typedef std::complex<double> T_productOutType;
};
...
template <int t_op1_WL,
          ...
          >
struct FFTMultiplicationTraits<
    std::complex<ap_fixed<t_op1_WL, t_op1_IL, t_op1QuantizationMode, t_op1OverflowMode, t_op1NumSatBits> >,
    std::complex<ap_fixed<t_op2_WL, t_op2_IL> > > {
    static const int product_IL = (t_op1_IL > t_op2_IL) ? t_op1_IL : t_op2_IL;
    ...
    static const int product_fraction_lenth =
        (op1_fraction_length > op2_fraction_length) ? op1_fraction_length : op2_fraction_length;
    static const int product_WL = product_IL + product_fraction_lenth;
    typedef std::complex<ap_fixed<product_WL, product_IL, t_op1QuantizationMode, t_op1OverflowMode, t_op1NumSatBits> >
        T_productOpType;
    /// Get inner types of the given comples types ::::
...
template <int t_op1_WL,
          ...
          >
struct FFTMultiplicationTraits<
    std::complex<ap_fixed<t_op1_WL, t_op1_IL> >,
    std::complex<ap_fixed<t_op2_WL, t_op2_IL, t_op2QuantizationMode, t_op2OverflowMode, t_op2NumSatBits> > > {
    static const int product_IL = (t_op1_IL > t_op2_IL) ? t_op1_IL : t_op2_IL;
    ...
    static const int product_fraction_lenth =
        (op1_fraction_length > op2_fraction_length) ? op1_fraction_length : op2_fraction_length;
    static const int product_WL = product_IL + product_fraction_lenth;
    typedef std::complex<ap_fixed<product_WL, product_IL, t_op2QuantizationMode, t_op2OverflowMode, t_op2NumSatBits> >
        T_productOpType;
    /// Get inner types of the given comples types ::::
    typedef ap_fixed<t_op1_WL, t_op1_IL> T_op1RealType;
    typedef ap_fixed<t_op1_WL, t_op1_IL> T_op1ImagType;
