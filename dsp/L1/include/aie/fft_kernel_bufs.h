...
alignas(32) const cint16_t fft_lut_tw1_half[FFT_1];
alignas(32) const cint16_t fft_lut_tw2_half[FFT_2];
alignas(32) const cint16_t fft_lut_tw4_half[FFT_4];
alignas(32) const cint16_t fft_lut_tw8_half[FFT_8];
alignas(32) const cint16_t fft_lut_tw16_half[FFT_16/2];
alignas(32) const cint16_t fft_lut_tw32_half[FFT_32/2];
alignas(32) const cint16_t fft_lut_tw64_half[FFT_64/2];
alignas(32) const cint16_t fft_lut_tw128_half[FFT_128/2];
alignas(32) const cint16_t fft_lut_tw256_half[FFT_256/2];
alignas(32) const cint16_t fft_lut_tw512_half[FFT_512/2];
alignas(32) const cint16_t fft_lut_tw1024_half[FFT_1024/2];
alignas(32) const cint16_t fft_lut_tw2048_half[FFT_2048/2];

//Full (2 quadrant) integer tables
alignas(32) const cint16_t fft_lut_tw1[FFT_1];
alignas(32) const cint16_t fft_lut_tw2[FFT_2];
alignas(32) const cint16_t fft_lut_tw4[FFT_4];
alignas(32) const cint16_t fft_lut_tw8[FFT_8];
alignas(32) const cint16_t fft_lut_tw16[FFT_16];
alignas(32) const cint16_t fft_lut_tw32[FFT_32];
alignas(32) const cint16_t fft_lut_tw64[FFT_64];
alignas(32) const cint16_t fft_lut_tw128[FFT_128];
alignas(32) const cint16_t fft_lut_tw256[FFT_256];
alignas(32) const cint16_t fft_lut_tw512[FFT_512];
alignas(32) const cint16_t fft_lut_tw1024[FFT_1024];
alignas(32) const cint16_t fft_lut_tw2048[FFT_2048];
...
alignas(32) const cint16_t fft_lut_tw1_cfloat[FFT_1];
alignas(32) const cint16_t fft_lut_tw2_cfloat[FFT_2];
alignas(32) const cint16_t fft_lut_tw4_cfloat[FFT_4];
alignas(32) const cint16_t fft_lut_tw8_cfloat[FFT_8];
alignas(32) const cint16_t fft_lut_tw16_cfloat[FFT_16];
alignas(32) const cint16_t fft_lut_tw32_cfloat[FFT_32];
alignas(32) const cint16_t fft_lut_tw64_cfloat[FFT_64];
alignas(32) const cint16_t fft_lut_tw128_cfloat[FFT_128];
alignas(32) const cint16_t fft_lut_tw256_cfloat[FFT_256];
alignas(32) const cint16_t fft_lut_tw512_cfloat[FFT_512];
alignas(32) const cint16_t fft_lut_tw1024_cfloat[FFT_1024];
alignas(32) const cint16_t fft_lut_tw2048_cfloat[FFT_2048];
*/
