...
NOINLINE_DECL void widget_api_cast<TT_DATA, kWindowAPI, kWindowAPI, 1, TP_WINDOW_VSIZE, 2, TP_PATTERN>::transferData(
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kWindowAPI, kWindowAPI, 1, TP_WINDOW_VSIZE, 3, TP_PATTERN>::transferData(
    input_window<TT_DATA>* __restrict inWindow0,
    output_window<TT_DATA>* __restrict outWindow0,
    output_window<TT_DATA>* __restrict outWindow1,
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 1, TP_WINDOW_VSIZE, 1, TP_PATTERN>::transferData(
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 1, TP_WINDOW_VSIZE, 2, TP_PATTERN>::transferData(
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 1, TP_WINDOW_VSIZE, 3, TP_PATTERN>::transferData(
    input_stream<TT_DATA>* __restrict inStream0,
    output_window<TT_DATA>* __restrict outWindow0,
    output_window<TT_DATA>* __restrict outWindow1,
    output_window<TT_DATA>* __restrict outWindow2) {
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 1, TP_WINDOW_VSIZE, 4, TP_PATTERN>::transferData(
    input_stream<TT_DATA>* __restrict inStream0,
    output_window<TT_DATA>* __restrict outWindow0,
    output_window<TT_DATA>* __restrict outWindow1,
    output_window<TT_DATA>* __restrict outWindow2,
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 2, TP_WINDOW_VSIZE, 1, TP_PATTERN>::transferData(
    input_stream<TT_DATA>* __restrict inStream0,
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 2, TP_WINDOW_VSIZE, 2, TP_PATTERN>::transferData(
    input_stream<TT_DATA>* __restrict inStream0,
    input_stream<TT_DATA>* __restrict inStream1,
    output_window<TT_DATA>* __restrict outWindow0,
    output_window<TT_DATA>* __restrict outWindow1) {
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 2, TP_WINDOW_VSIZE, 3, TP_PATTERN>::transferData(
    input_stream<TT_DATA>* __restrict inStream0,
    input_stream<TT_DATA>* __restrict inStream1,
    output_window<TT_DATA>* __restrict outWindow0,
    output_window<TT_DATA>* __restrict outWindow1,
...
// stream to window, 2 in 3 out
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kStreamAPI, kWindowAPI, 2, TP_WINDOW_VSIZE, 4, TP_PATTERN>::transferData(
    input_stream<TT_DATA>* __restrict inStream0,
    input_stream<TT_DATA>* __restrict inStream1,
    output_window<TT_DATA>* __restrict outWindow0,
    output_window<TT_DATA>* __restrict outWindow1,
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kWindowAPI, kStreamAPI, 1, TP_WINDOW_VSIZE, 1, TP_PATTERN>::transferData(
...
template <typename TT_DATA, unsigned int TP_WINDOW_VSIZE, unsigned int TP_PATTERN>
NOINLINE_DECL void widget_api_cast<TT_DATA, kWindowAPI, kStreamAPI, 1, TP_WINDOW_VSIZE, 2, TP_PATTERN>::transferData(
    input_window<TT_DATA>* __restrict inWindow0,
