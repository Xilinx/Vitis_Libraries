...
void back_transpose_simple_wrapper(
    ...
    backTransposeSimpleCls<POINT_SIZE, SSR, DATAWIDTH, POINT_SIZE_D1>::t_stream_out sig_o[SSR]) { // 2
#pragma HLS interface mode = ap_ctrl_none port = return
#pragma HLS DATAFLOW
    static backTransposeSimpleCls<POINT_SIZE, SSR, DATAWIDTH, POINT_SIZE_D1> uut;
