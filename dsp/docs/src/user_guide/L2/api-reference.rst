...
For all library elements, the recommended approach is to include the L2 library element as a subgraph within your application graph. Graph declarations can be found in `L2/include/aie/`. This section describes the interface to each library element, including configuration parameters, constructor arguments, and ports.
...
- `FIR Filters <../../rst/group_fir_graphs.html>`_
- `Function Approximation <../../rst/group_func_approx.html>`_
- `Graph Utilities <../../rst/group_graph_utils.html>`_
