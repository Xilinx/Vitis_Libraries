...
:ref:`FIGURE_DDS_IMPL` below shows the construction-time creation of a vector of offsets, then the runtime use of this vector to create multiple outputs from a single sin/cos lookup each cycle.
