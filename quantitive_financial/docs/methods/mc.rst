...
Most of the time, the value of underlying asset are affected by multiple factors, which makes it don't have an analytic solution and numerical solution. For this scenario, Monte Carlo Methods are very suitable.
