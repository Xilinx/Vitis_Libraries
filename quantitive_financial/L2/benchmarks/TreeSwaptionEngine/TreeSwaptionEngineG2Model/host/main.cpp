...
int main(int argc, const char* argv[]) {
    ...
    if (timestep == 50) golden = 14.13975427223244;
    if (timestep == 100) golden = 14.08193848427266;
    double fixedRate[3] = {0.049995924285639641, 0.059995109142767566, 0.039996739428511716};
    ...
    for (int i = 0; i < loop_cnt; ++i) {
        ...
        kernel_TreeBermudanEngine.setArg(1, fixedRate[0]);
    ...
    std::cout << "FPGA Execution time: " << tvdiff(&start_time, &end_time) * 1000 / loop_cnt << "ms" << std::endl;
    std::cout << "QuantLib 1.15 CPU Execution time: 258.0ms" << std::endl;
