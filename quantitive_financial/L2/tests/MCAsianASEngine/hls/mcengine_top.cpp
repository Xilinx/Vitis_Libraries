...
void MCAsian_Arithmetic_AV_Strike_Engine_top(unsigned int timeSteps,
                                             TEST_DT timeLength,
                                             TEST_DT strike,
                                             TEST_DT volatility,
                                             TEST_DT underlying,
    ...
    xf::fintech::MCAsianArithmeticASEngine<TEST_DT, 2>(underlying, volatility, dividendYield, riskFreeRate, timeLength,
