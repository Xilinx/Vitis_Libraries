...
add_files "${WORKDIR}/kernel/INFLATION_k0.cpp" -cflags "-I ${WORKDIR}/kernel -I ${WORKDIR}/host -I ${WORKDIR}/../../../L2/include -I${WORKDIR}/../../../L1/include -D HLS_TEST"
