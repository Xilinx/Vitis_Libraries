...
int main(int argc, char* argv[]) {
    ...
    // xf::fintech::MCAmericanEnginePreSamples<TEST_DT, 2>(underlying, volatility, riskFreeRate, dividendYield,
    // timeLength,
    //                                                    strike, optionType, seed0, pOut, mOut, calibSamples,
    //                                                    timeSteps);

    kernel_0_top(underlying, volatility, riskFreeRate, dividendYield, timeLength, strike, optionType, seed0, pOut, mOut,
