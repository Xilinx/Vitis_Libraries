...
#ifndef _XF_FINTECH_CF_GARMAN_KOHLHAGEN_H_
#define _XF_FINTECH_CF_GARMAN_KOHLHAGEN_H_
...
/**
 * @class CFGarmanKohlhagen
 *
 * @brief This class implements the Closed Form Garman Kohlhagen model.
 *
 ...
 */
class CFGarmanKohlhagen : public CFBlackScholes {
   public:
    CFGarmanKohlhagen(unsigned int maxAssetsPerRun);
    ~CFGarmanKohlhagen();
