...
.. table:: Table 1 IP resources for jpegDecoder with jfif parser and huffman decoder
    :align: center
...
.. table:: Table 2 Hardware resources for jpegDecoder with jfif parser, huffman decoder, idct
    :align: center
...
Table 3 : Jpeg Decoder profiling
