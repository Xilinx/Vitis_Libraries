...
The Counter (CTR) mode is a typical encryption and decryption mode using AES algorithm.
...
We support CTR-AES256 mode in this implementation.
...
As we can see from the chart, both encryption and decryption part of CTR mode has no dependencies, so the input block of each iteration can be directly calculated by the counter.
...
====== ====== ====== ===== ====== ===== ====== ========
 957    3692   4887    0    138    417    0     2.827
====== ====== ====== ===== ====== ===== ====== ========
...
====== ====== ====== ===== ====== ====== ====== ========
 CLB    LUT     FF    DSP   BRAM   SRL    URAM   CP(ns)
====== ====== ====== ===== ====== ====== ====== ========
 1167   3727   4887    0    138    417     0     3.101
====== ====== ====== ===== ====== ====== ====== ========
