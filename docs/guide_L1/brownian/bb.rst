...
Suppose :math:`\{W_{t}\}_{t \in [0,T]}` is a 1-dimensional Brownian motion,:math:`a, b \in \mathbb{R}`, then the process
...
Suppose :math:`W` is a 1-dimensional Brownian motion, :math:`a,b \in \mathbb{R}, 0 < s < t < u`, then with known :math:`(W_{u}, W_{s})`, the conditional probability distribution is as follows:
