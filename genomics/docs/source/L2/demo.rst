...
.. meta::
   :keywords: Vitis, Library, Genomics, Xilinx, FPGA OpenCL Kernels, Smithwaterman Demo
...
Demo examples for  **smithwaterman** kernels are available in the ``L2/demos/`` directory.
