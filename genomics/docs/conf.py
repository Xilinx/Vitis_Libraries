...
project = 'Vitis Genomics Library'
...
latex_documents = [
    (master_doc, 'genomics.tex', 'Vitis Genomics Library',
     'Xilinx', 'manual'),
]
...
man_pages = [
    (master_doc, 'xfgenomics', 'Vitis Genomics Library',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xfgenomics', 'Vitis Genomics Library',
     author, 'Xilinx', 'Library of FPGA accelerated genomics algorithms.',
     'Miscellaneous'),
]
