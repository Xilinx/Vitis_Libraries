...
void aes256CbcEncrypt::compute(int hb_in_size, int hb_out_size, ap_uint<128>* hb_in, ap_uint<128>* hb_out) {
...
// @brief top of kernel
void aes256CbcEncrypt::hls_kernel(int hb_in_size, int hb_out_size, ap_uint<128>* hb_in, ap_uint<128>* hb_out) {
