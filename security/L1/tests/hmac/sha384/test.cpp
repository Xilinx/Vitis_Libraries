...
void test_hmac_sha384(hls::stream<ap_uint<KEYW> >& keyStrm,
                      ...
                      hls::stream<bool>& eHshStrm) {
    xf::security::hmac<MSGW, LENW, HSHW, KEYL, BLOCK_SIZE, sha384_wrapper>(keyStrm, msgStrm, lenStrm, eLenStrm, hshStrm,
                                                                           eHshStrm);
}
...
#pragma HLS stream variable = endHshStrm depth = 128
    ...
    // call fpga module
    test_hmac_sha384(keyStrm, msgStrm, lenMsgStrm, endLenStrm, hshStrm, endHshStrm);
