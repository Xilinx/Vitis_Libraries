...
#pragma HLS DATAFLOW
    ...
    xf::cv::rgbir2bayer<FILTERSIZE1, FILTERSIZE2, BPATTERN, IN_TYPE, HEIGHT, WIDTH, NPC, XF_CV_DEPTH_IN,
                        XF_CV_DEPTH_OUT_1, XF_CV_DEPTH_OUT_2, XF_CV_DEPTH_3XWIDTH, XF_BORDER_CONSTANT, XF_USE_URAM>(
