...
#include "xf_accumulate_weighted_accel_config.h"
...
void accumulate_weighted_accel(ap_uint<INPUT_PTR_WIDTH>* img_in1,
                               ...
                               int width) {
// clang-format off
    #pragma HLS INTERFACE m_axi port=img_in1 offset=slave bundle=gmem0 depth=__XF_DEPTH_IN
    #pragma HLS INTERFACE m_axi port=img_in2 offset=slave bundle=gmem1 depth=__XF_DEPTH_IN
...
// clang-format off
    ...
    // Run xfOpenCV kernel:
    xf::cv::accumulateWeighted<IN_TYPE, OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_IN_1, XF_CV_DEPTH_IN_2,
                               XF_CV_DEPTH_OUT_1>(imgInput1, imgInput2, imgOutput, alpha);
