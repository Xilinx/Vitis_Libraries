...
#pragma HLS INLINE OFF
    // clang-format on
    xf::cv::Mat<XF_SRC_T, XF_HEIGHT * 2, XF_WIDTH + NUM_H_BLANK, XF_NPPC, XF_CV_DEPTH_IN_1> imgInput(
...
#pragma HLS DATAFLOW
    ...
    AXIVideo2BayerMat<XF_SRC_T, XF_HEIGHT * 2, XF_WIDTH + NUM_H_BLANK, XF_NPPC, XF_CV_DEPTH_IN_DR1>(s_axis_video,
                                                                                                    imgInput);
    ...
    if (XF_DST_T == XF_8UC3) {
        ...
        xf::cv::xf_QuatizationDithering<XF_DST_T, XF_LTM_T, XF_HEIGHT, XF_WIDTH, 256, Q_VAL, XF_NPPC, XF_USE_URAM,
...
void isppipeline(uint16_t width,
                 uint16_t height,
...
#pragma HLS INTERFACE s_axilite port=rgain bundle=CTRL offset=0x30
#pragma HLS INTERFACE s_axilite port=bgain bundle=CTRL offset=0x38
#pragma HLS INTERFACE s_axilite port=mode_reg bundle=CTRL offset=0x20
