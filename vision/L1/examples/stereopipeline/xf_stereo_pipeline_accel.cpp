...
// clang-format off
    ...
    xf::cv::remap<XF_REMAP_BUFSIZE, XF_INTERPOLATION_BILINEAR, XF_8UC1, XF_32FC1, XF_8UC1, XF_HEIGHT, XF_WIDTH,
                  XF_NPPC1, XF_CV_DEPTH_L, XF_CV_DEPTH_leftRemapped, XF_CV_DEPTH_mapxL, XF_CV_DEPTH_mapyL, XF_USE_URAM>(
    ...
    xf::cv::remap<XF_REMAP_BUFSIZE, XF_INTERPOLATION_BILINEAR, XF_8UC1, XF_32FC1, XF_8UC1, XF_HEIGHT, XF_WIDTH,
                  XF_NPPC1, XF_CV_DEPTH_R, XF_CV_DEPTH_rightRemapped, XF_CV_DEPTH_mapxR, XF_CV_DEPTH_mapyR,
    ...
    xf::cv::StereoBM<SAD_WINDOW_SIZE, NO_OF_DISPARITIES, PARALLEL_UNITS, XF_8UC1, XF_16UC1, XF_HEIGHT, XF_WIDTH,
                     XF_NPPC1, XF_CV_DEPTH_leftRemapped, XF_CV_DEPTH_rightRemapped, XF_CV_DEPTH_disp, XF_USE_URAM>(
