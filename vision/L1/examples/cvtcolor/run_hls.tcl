...
if {$CSIM == 1} {
  csim_design -ldflags "-L ${OPENCV_LIB} -lopencv_imgcodecs -lopencv_imgproc -lopencv_core -lopencv_highgui -lopencv_flann -lopencv_features2d" -argv " ${XF_PROJ_ROOT}/data/input.jpg ${XF_PROJ_ROOT}/data/ref_Y.png ${XF_PROJ_ROOT}/data/ref_U.png ${XF_PROJ_ROOT}/data/ref_V.png "
}
...
if {$COSIM == 1} {
  cosim_design -ldflags "-L ${OPENCV_LIB} -lopencv_imgcodecs -lopencv_imgproc -lopencv_core -lopencv_highgui -lopencv_flann -lopencv_features2d" -argv " ${XF_PROJ_ROOT}/data/input.jpg ${XF_PROJ_ROOT}/data/ref_Y.png ${XF_PROJ_ROOT}/data/ref_U.png ${XF_PROJ_ROOT}/data/ref_V.png "
}
