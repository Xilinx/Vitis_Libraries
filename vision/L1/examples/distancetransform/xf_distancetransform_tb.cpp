...
#include "xf_distancetransform_tb_config.h"
...
int main(int argc, char** argv) {
    ...
    distancetransform_accel((ap_uint<INPUT_PTR_WIDTH>*)in_img.data, (float*)out_img.data,
                            (ap_uint<FWPASS_PTR_WIDTH>*)fw_pass_data, height, width);
