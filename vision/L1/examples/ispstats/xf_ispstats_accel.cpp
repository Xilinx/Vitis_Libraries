...
static constexpr int __XF_DEPTH_PTR = STATS_SIZE * MAX_ROWS * MAX_COLS * NUM_OUT_CH;
static constexpr int __XF_DEPTH_PTR_BINS = FINAL_BINS_NUM;
...
#pragma HLS INTERFACE m_axi     port=stats    offset=slave bundle=gmem1 depth=__XF_DEPTH_PTR
#pragma HLS INTERFACE m_axi     port=max_bins offset=slave bundle=gmem2 depth=__XF_DEPTH_PTR_BINS
