...
#include "xf_hdrdecompand_accel_config.h"
...
void hdrdecompand_accel(ap_uint<INPUT_PTR_WIDTH>* in_ptr,
...
#pragma HLS DATAFLOW
    ...
    hdr_decompand<IN_TYPE, OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_IN, XF_CV_DEPTH_OUT>(imgInput, imgOutput, params,
                                                                                            bayerp);
