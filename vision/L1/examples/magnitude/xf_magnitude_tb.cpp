...
/////////////////    OpenCV reference  /////////////////
    ...
    static xf::cv::Mat<XF_16SC1, HEIGHT, WIDTH, NPC1> imgInputx(in_img.rows, in_img.cols);
    static xf::cv::Mat<XF_16SC1, HEIGHT, WIDTH, NPC1> imgInputy(in_img.rows, in_img.cols);
    static xf::cv::Mat<XF_16SC1, HEIGHT, WIDTH, NPC1> imgOutput(in_img.rows, in_img.cols);
    ...
    xf::cv::absDiff(ocv_ref1, imgOutput, diff); // Compute absolute difference image
