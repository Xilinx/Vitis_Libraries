...
// clang-format off
    ...
    xf::cv::Mat<TYPE, (HEIGHT / 2), (WIDTH / 2), NPPC, XF_CV_DEPTH_OUT> out_mat(out_rows, out_cols);

// clang-format off
    #pragma HLS DATAFLOW
    // clang-format on
    xf::cv::Array2xfMat<INPUT_PTR_WIDTH, TYPE, HEIGHT, WIDTH, NPPC, XF_CV_DEPTH_IN>(img_inp, in_mat);
    xf::cv::pyrDown<TYPE, HEIGHT, WIDTH, NPPC, XF_USE_URAM, XF_CV_DEPTH_IN, XF_CV_DEPTH_OUT>(in_mat, out_mat);
    xf::cv::xfMat2Array<OUTPUT_PTR_WIDTH, TYPE, (HEIGHT / 2), (WIDTH / 2), NPPC, XF_CV_DEPTH_OUT>(out_mat, img_out);
}
...
// clang-format off
    ...
    xf::cv::densePyrOpticalFlow<NUM_LEVELS, NUM_LINES_FINDIT, WINSIZE_OFLOW, TYPE_FLOW_WIDTH, TYPE_FLOW_INT, XF_8UC1,
                                HEIGHT, WIDTH, NPPC, XF_USE_URAM, XF_CV_DEPTH_CURR_IMG, XF_CV_DEPTH_NEXT_IMG,
