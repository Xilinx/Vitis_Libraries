...
int main(int argc, char** argv) {
    ...
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, INTYPE> imgInput(img_gray.rows, img_gray.cols); // XF_NPPC1,XF_NPPC4
    static xf::cv::Mat<XF_2UC1, HEIGHT, WIDTH, XF_NPPC32> nms_output(img_gray.rows, img_gray.cols);
    static xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, XF_NPPC8> edge_output(img_gray.rows, img_gray.cols);
