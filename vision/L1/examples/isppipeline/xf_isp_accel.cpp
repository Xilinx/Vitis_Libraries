...
#pragma HLS DATAFLOW
    // clang-format on
    if (WB_TYPE) {
        xf::cv::AWBhistogram<OUT_TYPE, OUT_TYPE, XF_HEIGHT, XF_WIDTH, NPPCX, WB_TYPE, HIST_SIZE, XFCVDEPTH_DEMOSAIC_OUT,
                             XFCVDEPTH_DEMOSAIC_OUT>(demosaic_out, impop, hist0, thresh, inputMin, inputMax, outputMin,
                                                     outputMax);
