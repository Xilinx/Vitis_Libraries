...
#pragma HLS DATAFLOW
    // clang-format on
    if (WB_TYPE) {
        xf::cv::AWBhistogram<XF_DST_T, XF_DST_T, XF_HEIGHT, XF_WIDTH, XF_NPPC, XFCVDEPTH_DEMOSAIC_OUT,
                             XFCVDEPTH_DEMOSAIC_OUT, WB_TYPE, HIST_SIZE>(demosaic_out, impop, hist0, thresh, inputMin,
                                                                         inputMax, outputMin, outputMax);
        xf::cv::AWBNormalization<XF_DST_T, XF_DST_T, XF_HEIGHT, XF_WIDTH, XF_NPPC, XFCVDEPTH_DEMOSAIC_OUT,
                                 XFCVDEPTH_LTM_IN, WB_TYPE, HIST_SIZE>(impop, ltm_in, hist1, thresh, inputMin, inputMax,
                                                                       outputMin, outputMax);
    } else {
        xf::cv::AWBChannelGain<XF_DST_T, XF_DST_T, XF_HEIGHT, XF_WIDTH, XF_NPPC, XFCVDEPTH_DEMOSAIC_OUT,
                               XFCVDEPTH_DEMOSAIC_OUT, 0>(demosaic_out, impop, thresh, gain0);
        xf::cv::AWBGainUpdate<XF_DST_T, XF_DST_T, XF_HEIGHT, XF_WIDTH, XF_NPPC, XFCVDEPTH_DEMOSAIC_OUT,
                              XFCVDEPTH_LTM_IN, 0>(impop, ltm_in, thresh, gain1);
    }
}
