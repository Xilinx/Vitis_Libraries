...
add_files -tb "${XF_PROJ_ROOT}/L1/examples/demosaicing/xf_demosaicing_tb.cpp ${XF_PROJ_ROOT}/L1/examples/demosaicing/xf_demosaicing_ref.cpp" -cflags "-I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags "-I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
