...
add_files "${XF_PROJ_ROOT}/L1/examples/accumulatesquared/xf_accumulate_squared_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/accumulatesquared/accumulatesquared_NPPC8_8UC1_16UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/accumulatesquared/accumulatesquared_NPPC8_8UC1_16UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/accumulatesquared/xf_accumulate_squared_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/accumulatesquared/accumulatesquared_NPPC8_8UC1_16UC1 -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/accumulatesquared/accumulatesquared_NPPC8_8UC1_16UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
