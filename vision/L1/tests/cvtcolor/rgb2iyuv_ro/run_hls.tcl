...
if {$CSIM == 1} {
  csim_design -ldflags "-L ${OPENCV_LIB} -lopencv_imgcodecs -lopencv_imgproc -lopencv_core -lopencv_highgui -lopencv_flann -lopencv_features2d" -argv " ${XF_PROJ_ROOT}/data/cvtcolor/RGB2IYUV/input/testcase1_ocv.png ${XF_PROJ_ROOT}/data/cvtcolor/RGB2IYUV/output/testcase1_RGBA2IYUV_Y.png ${XF_PROJ_ROOT}/data/cvtcolor/RGB2IYUV/output/testcase1_RGBA2IYUV_U.png ${XF_PROJ_ROOT}/data/cvtcolor/RGB2IYUV/output/testcase1_RGBA2IYUV_V.png "
}
