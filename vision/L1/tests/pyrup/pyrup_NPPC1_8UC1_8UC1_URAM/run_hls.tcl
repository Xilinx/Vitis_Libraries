...
add_files "${XF_PROJ_ROOT}/L1/examples/pyrup/xf_pyr_up_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrup/pyrup_NPPC1_8UC1_8UC1_URAM -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrup/pyrup_NPPC1_8UC1_8UC1_URAM -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/pyrup/xf_pyr_up_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrup/pyrup_NPPC1_8UC1_8UC1_URAM -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrup/pyrup_NPPC1_8UC1_8UC1_URAM -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
