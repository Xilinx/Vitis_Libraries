...
add_files "${XF_PROJ_ROOT}/L1/examples/sobelfilter/xf_sobel_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/sobelfilter/sobelfilter_NPPC8_8UC1_8UC1_FILTER_SIZE_3 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/sobelfilter/sobelfilter_NPPC8_8UC1_8UC1_FILTER_SIZE_3 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/sobelfilter/xf_sobel_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/sobelfilter/sobelfilter_NPPC8_8UC1_8UC1_FILTER_SIZE_3 -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/sobelfilter/sobelfilter_NPPC8_8UC1_8UC1_FILTER_SIZE_3 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
set_top sobel_accel
