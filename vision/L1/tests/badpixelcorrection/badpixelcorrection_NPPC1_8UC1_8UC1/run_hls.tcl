...
add_files "${XF_PROJ_ROOT}/L1/examples/badpixelcorrection/xf_badpixelcorrection_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/badpixelcorrection/badpixelcorrection_NPPC1_8UC1_8UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/badpixelcorrection/badpixelcorrection_NPPC1_8UC1_8UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
