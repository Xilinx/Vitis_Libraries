...
add_files "${XF_PROJ_ROOT}/L1/examples/degamma/xf_degamma_accel.cpp" -cflags "-I ${XF_PROJ_ROOT}/L1/tests/degamma/degamma_NPPC8_8UC1_8UC1_BAYER_BG -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags "-I ${XF_PROJ_ROOT}/L1/tests/degamma/degamma_NPPC8_8UC1_8UC1_BAYER_BG -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
