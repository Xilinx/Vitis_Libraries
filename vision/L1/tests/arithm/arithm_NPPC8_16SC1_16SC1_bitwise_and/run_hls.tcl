...
add_files "${XF_PROJ_ROOT}/L1/examples/arithm/xf_arithm_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/arithm/arithm_NPPC8_16SC1_16SC1_bitwise_and -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/arithm/arithm_NPPC8_16SC1_16SC1_bitwise_and -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/arithm/xf_arithm_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/arithm/arithm_NPPC8_16SC1_16SC1_bitwise_and -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/arithm/arithm_NPPC8_16SC1_16SC1_bitwise_and -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
