...
add_files "${XF_PROJ_ROOT}/L1/examples/bilateralfilter/xf_bilateral_filter_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/bilateralfilter/bilateralfilter_NPPC1_8UC3_8UC3_FILTER_SIZE_5 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/bilateralfilter/bilateralfilter_NPPC1_8UC3_8UC3_FILTER_SIZE_5 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/bilateralfilter/xf_bilateral_filter_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/bilateralfilter/bilateralfilter_NPPC1_8UC3_8UC3_FILTER_SIZE_5 -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/bilateralfilter/bilateralfilter_NPPC1_8UC3_8UC3_FILTER_SIZE_5 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
