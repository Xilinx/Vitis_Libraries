...
add_files "${XF_PROJ_ROOT}/L1/examples/pyrdown/xf_pyr_down_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrdown/pyrdown_NPPC1_8UC3_8UC3 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrdown/pyrdown_NPPC1_8UC3_8UC3 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/pyrdown/xf_pyr_down_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrdown/pyrdown_NPPC1_8UC3_8UC3 -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/pyrdown/pyrdown_NPPC1_8UC3_8UC3 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
