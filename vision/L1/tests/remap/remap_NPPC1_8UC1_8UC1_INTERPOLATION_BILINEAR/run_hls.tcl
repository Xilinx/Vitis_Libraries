...
add_files "${XF_PROJ_ROOT}/L1/examples/remap/xf_remap_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/remap/remap_NPPC1_8UC1_8UC1_INTERPOLATION_BILINEAR -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/remap/remap_NPPC1_8UC1_8UC1_INTERPOLATION_BILINEAR -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/remap/xf_remap_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/remap/remap_NPPC1_8UC1_8UC1_INTERPOLATION_BILINEAR -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/remap/remap_NPPC1_8UC1_8UC1_INTERPOLATION_BILINEAR -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
set_top remap_accel
