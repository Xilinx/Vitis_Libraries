...
add_files "${XF_PROJ_ROOT}/L1/examples/accumulate/xf_accumulate_image_accel.cpp" -cflags "-I${XF_PROJ_ROOT}/L1/include -I ${XF_PROJ_ROOT}/L1/tests/accumulate/accumulate_NPPC1_8UC1_16UC1 -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags "-I${XF_PROJ_ROOT}/L1/include -I ${XF_PROJ_ROOT}/L1/tests/accumulate/accumulate_NPPC1_8UC1_16UC1 -I ./ -D__SDSVHLS__ -std=c++0x"
