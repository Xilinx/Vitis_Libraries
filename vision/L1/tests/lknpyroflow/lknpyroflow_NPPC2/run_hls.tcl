...
if {$CSIM == 1} {
  csim_design -compiler gcc -argv { ../../../../../../../examples/lknpyroflow/data/im0.png ../../../../../../../examples/lknpyroflow/data/im1.png} -clean
}
...
if {$COSIM == 1} {
  cosim_design -argv { ../../../../../../../examples/lknpyroflow/data/im0.png ../../../../../../../examples/lknpyroflow/data/im1.png}
}
