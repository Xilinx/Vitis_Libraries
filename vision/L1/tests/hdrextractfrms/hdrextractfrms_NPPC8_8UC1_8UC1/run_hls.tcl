...
add_files "${XF_PROJ_ROOT}/L1/examples/hdrextractfrms/xf_extract_eframes_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/hdrextractfrms/hdrextractfrms_NPPC8_8UC1_8UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/hdrextractfrms/hdrextractfrms_NPPC8_8UC1_8UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/hdrextractfrms/xf_extract_eframes_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/hdrextractfrms/hdrextractfrms_NPPC8_8UC1_8UC1 -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/hdrextractfrms/hdrextractfrms_NPPC8_8UC1_8UC1 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
