...
add_files "${XF_PROJ_ROOT}/L1/examples/modefilter/xf_modefilter_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/modefilter/modefilter_NPPC8_8UC3_8UC3_WINDOW_SIZE_5X5 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/modefilter/modefilter_NPPC8_8UC3_8UC3_WINDOW_SIZE_5X5 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/modefilter/xf_modefilter_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/modefilter/modefilter_NPPC8_8UC3_8UC3_WINDOW_SIZE_5X5 -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/modefilter/modefilter_NPPC8_8UC3_8UC3_WINDOW_SIZE_5X5 -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
