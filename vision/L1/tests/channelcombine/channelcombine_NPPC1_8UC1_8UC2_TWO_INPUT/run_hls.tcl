...
add_files "${XF_PROJ_ROOT}/L1/examples/channelcombine/xf_channel_combine_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/channelcombine/channelcombine_NPPC1_8UC1_8UC2_TWO_INPUT -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/channelcombine/channelcombine_NPPC1_8UC1_8UC2_TWO_INPUT -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/channelcombine/xf_channel_combine_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/channelcombine/channelcombine_NPPC1_8UC1_8UC2_TWO_INPUT -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/channelcombine/channelcombine_NPPC1_8UC1_8UC2_TWO_INPUT -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
