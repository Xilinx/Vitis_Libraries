...
add_files "${XF_PROJ_ROOT}/L1/examples/warptransform/xf_warp_transform_accel.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/warptransform/warptransform_NPPC1_8UC1_8UC1_URAM_PERSPECTIVE_NN -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/warptransform/warptransform_NPPC1_8UC1_8UC1_URAM_PERSPECTIVE_NN -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "${XF_PROJ_ROOT}/L1/examples/warptransform/xf_warp_transform_tb.cpp" -cflags " -I ${XF_PROJ_ROOT}/L1/tests/warptransform/warptransform_NPPC1_8UC1_8UC1_URAM_PERSPECTIVE_NN -I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags " -I ${XF_PROJ_ROOT}/L1/tests/warptransform/warptransform_NPPC1_8UC1_8UC1_URAM_PERSPECTIVE_NN -I${XF_PROJ_ROOT}/L1/include -I ./ -D__SDSVHLS__ -std=c++0x"
