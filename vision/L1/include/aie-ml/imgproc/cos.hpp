...
alignas(::aie::vector_decl_align) int32_t coeffs[16] = {67108754, -33553524, 2795239, -92852,
                                                        1606,     -14}; //{268420400, -44714204, 2225239,
                                                                        //-50998,544};//{1046858, -172858, 8160, -141};
                                                                        //// NO_COEFFS in config.h=6
...
template <int NO_COEFFS, int NO_BOXES_PER_TILE>
void Cos1<NO_COEFFS, NO_BOXES_PER_TILE>::cos_runImpl_api(adf::input_buffer<int32_t>& ptr_img_in,
...
template <int NO_COEFFS, int NO_BOXES_PER_TILE>
__attribute__((always_inline)) void Cos1<NO_COEFFS, NO_BOXES_PER_TILE>::cos_runImpl(int32_t* restrict ptr_img_in,
