...
alignas(::aie::vector_decl_align) int32_t coeffs[16] = {67105182, -11178610, 556320, -12750, 136};//{268420400, -44714204, 2225239, -50998,544};//{1046858, -172858, 8160, -141}; // NO_COEFFS in config.h=6
...
namespace xf
{
    namespace cv
    {
        ...
        template <int NO_COEFFS, int NO_BOXES_PER_TILE>
            ...
            template <int NO_COEFFS, int NO_BOXES_PER_TILE>
            void Sin1<NO_COEFFS, NO_BOXES_PER_TILE>::sin_runImpl_api(adf::input_buffer<int32_t> &ptr_img_in, adf::output_buffer<int32_t> &output) {
            ...
            template <int NO_COEFFS, int NO_BOXES_PER_TILE>
            __attribute__((always_inline)) void Sin1<NO_COEFFS, NO_BOXES_PER_TILE>::sin_runImpl(int32_t *restrict ptr_img_in, int32_t *restrict output){
                        // Load input
