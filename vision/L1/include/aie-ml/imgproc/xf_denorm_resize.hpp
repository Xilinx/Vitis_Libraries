...
#ifndef __XF_DENORM_RESIZE_
#define __XF_DENORM_RESIZE_
...
class DenormResize {
   public:
    ...
    void runImpl(adf::input_buffer<int8_t>& input,
...
__attribute__((noinline)) void DenormResize::xf_clamp(
...
__attribute__((noinline)) void DenormResize::xf_denormalize(int8_t* input1,
                                                            int8_t* input2,
                                                            uint8_t* output1,
                                                            uint8_t* output2,
                                                            int tile_width_in,
...
__attribute__((noinline)) void DenormResize::xf_resize1DV(uint8_t* input1,
                                                          uint8_t* input2,
                                                          uint8_t* output,
                                                          int row,
                                                          uint32_t scale_y,
...
__attribute__((noinline)) void DenormResize::xf_resize1DH(
    uint8_t* input, uint8_t* output, int row, uint32_t scale_x, int tile_width_in, int tile_width_out) {
...
__attribute__((noinline)) void DenormResize::xf_resize1DH1CH(
    uint8_t* input, uint8_t* output, int row, uint32_t scale_x, int tile_width_in, int tile_width_out) {
...
__attribute__((noinline)) void DenormResize::xf_resize1DUpscaleGenericTile(uint8_t* input,
                                                                           uint8_t* output,
                                                                           int start_in_row,
                                                                           int start_out_row,
                                                                           uint32_t scale_y,
...
__attribute__((noinline)) void DenormResize::runImpl(uint8_t* input,
                                                     uint8_t* output,
                                                     int row,
                                                     uint32_t scale_x,
                                                     uint32_t scale_y,
...
void DenormResize::runImpl(adf::input_buffer<int8_t>& input,
                           adf::output_buffer<uint8_t>& output,
                           uint32_t scale_x,
                           uint32_t scale_y,
                           int img_height_in,
...
void DenormResize::runImpl(int8_t* input,
                           uint8_t* output,
                           int row,
                           uint32_t scale_x,
                           uint32_t scale_y,
...
void DenormResize::runImpl(int8_t* input, uint8_t* output, int tile_width_out, const int16_t* coeff, int nChannels) {
