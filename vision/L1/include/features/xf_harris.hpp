...
// clang-format off
    ...
    if (FILTERSIZE == XF_FILTER_7X7) {
        ...
        Sobel<XF_BORDER_CONSTANT, FILTERSIZE, SRC_T, XF_32SC1, ROWS, COLS, NPC, XFCVDEPTH_IN, XFCVDEPTH_IN,
              XFCVDEPTH_IN, USE_URAM>(_src_mat, gradx_mat, grady_mat);
        ...
        Sobel<XF_BORDER_CONSTANT, FILTERSIZE, SRC_T, XF_16SC1, ROWS, COLS, NPC, XFCVDEPTH_IN, XFCVDEPTH_IN,
              XFCVDEPTH_IN, USE_URAM>(_src_mat, gradx_mat, grady_mat);
    ...
    boxFilter<XF_BORDER_CONSTANT, BLOCKWIDTH, XF_16SC1, ROWS, COLS, NPC, XFCVDEPTH_IN, XFCVDEPTH_IN, USE_URAM>(gradx_2,
                                                                                                               gradx2g);
    boxFilter<XF_BORDER_CONSTANT, BLOCKWIDTH, XF_16SC1, ROWS, COLS, NPC, XFCVDEPTH_IN, XFCVDEPTH_IN, USE_URAM>(grady_2,
                                                                                                               grady2g);
    boxFilter<XF_BORDER_CONSTANT, BLOCKWIDTH, XF_16SC1, ROWS, COLS, NPC, XFCVDEPTH_IN, XFCVDEPTH_IN, USE_URAM>(gradxy,
                                                                                                               gradxyg);
