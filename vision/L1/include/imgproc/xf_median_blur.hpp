...
void ProcessMedian3x3(xf::cv::Mat<TYPE, ROWS, COLS, NPC>& _src_mat,
...
template <int ROWS, int COLS, int PLANES, int TYPE, int NPC, int WORDWIDTH, int TC, int WIN_SZ, int WIN_SZ_SQ>
void xFMedian3x3(xf::cv::Mat<TYPE, ROWS, COLS, NPC>& _src,
...
// clang-format off
    ...
    xFMedian3x3<ROWS, COLS, XF_CHANNELS(TYPE, NPC), TYPE, NPC, 0, (COLS >> XF_BITSHIFT(NPC)) + (FILTER_SIZE >> 1),
