...
// clang-format off
    ...
    if (NPC == 8) {
        ...
        xf::cv::Mat<XF_16SC1, ROWS, COLS, NPC> magnitude_mat(img_height, img_width);
...
// clang-format off
        ...
        // Sobel<XF_BORDER_CONSTANT, FILTER_TYPE, SRC_T, XF_16SC1, ROWS, COLS, NPC,USE_URAM>(_src_mat, gradx_mat,
        // grady_mat);
        ...
        // xFMagnitude<ROWS, COLS, XF_16SP,XF_16SP, NPC,
        // XF_128UW,XF_128UW>(gradx1_mat,grady1_mat,magnitude_mat,_norm_type,img_height,img_width);
        magnitude<NORM_TYPE, XF_16SC1, XF_16SC1, ROWS, COLS, NPC>(gradx1_mat, grady1_mat, magnitude_mat);
        xFAngle<XF_16SC1, XF_8UC1, ROWS, COLS, XF_16SP, XF_8UP, NPC, XF_128UW, XF_64UW>(
        ...
        xFSuppression3x3<XF_16SC1, XF_8UC1, XF_2UC1, ROWS, COLS, XF_16SP, XF_8UP, DEPTH_OUT, NPC, XF_128UW, XF_64UW,
                         XF_16UW, (COLS >> XF_BITSHIFT(NPC))>(magnitude_mat, phase_mat, nms_mat, _lowthreshold,
...
// clang-format off
        ...
        xFDuplicate_rows<XF_16SC1, ROWS, COLS, XF_16SP, NPC, XF_16UW, TC>(
            gradx_mat, grady_mat, gradx1_mat, gradx2_mat, grady1_mat, grady2_mat, img_height, img_width);
        // xFMagnitude<ROWS, COLS, XF_16SP,XF_16SP, NPC,
        // XF_16UW,XF_16UW>(gradx1_mat,grady1_mat,magnitude_mat,_norm_type,img_height,img_width);
        magnitude<NORM_TYPE, XF_16SC1, XF_16SC1, ROWS, COLS, NPC>(gradx1_mat, grady1_mat, magnitude_mat);
        xFAngle<XF_16SC1, XF_8UC1, ROWS, COLS, XF_16SP, XF_8UP, NPC, XF_16UW, XF_8UW>(gradx2_mat, grady2_mat, phase_mat,
                                                                                      img_height, img_width);
        xFSuppression3x3<XF_16SC1, XF_8UC1, XF_2UC1, ROWS, COLS, XF_16SP, XF_8UP, XF_2UP, NPC, XF_16UW, XF_8UW, XF_2UW,
                         (COLS >> XF_BITSHIFT(NPC))>(magnitude_mat, phase_mat, nms_mat, _lowthreshold, _highthreshold,
                                                     img_height, img_width);
