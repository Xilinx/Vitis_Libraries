...
#ifndef _XF_PYR_UP_GAUSSIAN_BLUR_
#define _XF_PYR_UP_GAUSSIAN_BLUR_
...
// clang-format off
        ...
        // clang-format on
        P0 = 0;
        xFPyrUpProcessWindow<ROWS, COLS, DEPTH, NPC, WORDWIDTH, TC, WIN_SZ, WIN_SZ_SQ, PLANES>(
...
template <int ROWS,
          ...
          int WIN_SZ_SQ,
          int PLANES>
void xFPyrUpGaussianBlur(hls::stream<XF_TNAME(DEPTH, NPC)>& _src,
    ...
    xf_pyrup_gaussian_nxn<ROWS, COLS, DEPTH, NPC, WORDWIDTH, (COLS >> XF_BITSHIFT(NPC)) + (WIN_SZ >> 1), WIN_SZ,
