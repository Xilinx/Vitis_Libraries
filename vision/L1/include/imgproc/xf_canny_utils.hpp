...
void ProcessNms3x3canny(
    xf::cv::Mat<IN_T1, ROWS, COLS, NPC>& _magnitude_mat, // hls::stream< XF_SNAME(WORDWIDTH_SRC) > & _magnitude_mat,
    xf::cv::Mat<IN_T2, ROWS, COLS, NPC>& _phase_mat,     // hls::stream< XF_SNAME(WORDWIDTH_PHASE) > & _phase_mat,
...
// clang-format off
        ...
        ProcessNms3x3canny<IN_T1, IN_T2, DST_T, ROWS, COLS, DEPTH_IN, DEPTH_PHASE, DEPTH_OUT, NPC, WORDWIDTH_SRC,
                           WORDWIDTH_PHASE, WORDWIDTH_DST, COLS_COUNT>(
...
// clang-format off
    ...
    xFAngleKernel<SRC_T, DST_T, ROWS, COLS, DEPTH_SRC, DEPTH_DST, NPC, WORDWIDTH_SRC, WORDWIDTH_DST,
                  (COLS >> XF_BITSHIFT(NPC))>(_src1, _src2, _dst, imgheight, imgwidth);
}
