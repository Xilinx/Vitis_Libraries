...
template <unsigned short MAXHEIGHT, unsigned short MAXWIDTH, int FLOW_WIDTH, int FLOW_INT>
void split_stream_int_fixed(unsigned int* instream,
...
template <unsigned short MAXHEIGHT,
          ...
          int FLOW_INT,
          bool USE_URAM>
void xFLKOpticalFlowDenseKernel(unsigned char* currImg,
                                unsigned char* nextImg,
                                unsigned int* strmFlowin,
                                unsigned int* strmFlow,
