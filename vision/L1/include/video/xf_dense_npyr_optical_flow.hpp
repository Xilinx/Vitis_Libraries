...
// top level wrapper to avoid dataflow problems
template <int ROWS, int COLS, int NPC, int WINDOW_SIZE, bool USE_URAM>
static void flowWrap(ap_uint<8>* frame0,
                     ap_uint<8>* frame1,
                     xf::cv::Mat<XF_32FC1, ROWS, COLS, NPC>& flowx,
                     xf::cv::Mat<XF_32FC1, ROWS, COLS, NPC>& flowy,
                     int rows,
...
//  framef - Output frame with flows visualized. 3 bytes per pixel + 1 byte padding
template <int ROWS, int COLS, int NPC, int WINDOW_SIZE, bool USE_URAM>
static void fpga_optflow8(ap_uint<8>* frame0,
                          ap_uint<8>* frame1,
                          xf::cv::Mat<XF_32FC1, ROWS, COLS, NPC>& flowx,
                          xf::cv::Mat<XF_32FC1, ROWS, COLS, NPC>& flowy,
                          int rows,
...
void DenseNonPyrLKOpticalFlow(xf::cv::Mat<TYPE, ROWS, COLS, NPC>& frame0,
                              ...
                              xf::cv::Mat<XF_32FC1, ROWS, COLS, NPC>& flowy) {
    if (NPC == XF_NPPC1) {
        fpga_optflow8<ROWS, COLS, NPC, WINDOW_SIZE, USE_URAM>((ap_uint<8>*)frame0.data, (ap_uint<8>*)frame1.data, flowx,
                                                              flowy, frame0.rows, frame0.cols, frame0.size);
    } else {
        fpga_optflow16<ROWS, COLS, NPC, WINDOW_SIZE, USE_URAM>((ap_uint<16>*)frame0.data, (ap_uint<16>*)frame1.data,
                                                               (ap_uint<64>*)flowx.data, (ap_uint<64>*)flowy.data,
