...
// clang-format off
    ...
    xf::cv::Mat<OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_OUT_0> _dstgx(rows, cols);
    // clang-format off
    // clang-format on

    xf::cv::Mat<OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_OUT_1> _dstgy(rows, cols);
// clang-format off
// clang-format on
...
// clang-format off
    ...
    xf::cv::Sobel<XF_BORDER_CONSTANT, FILTER_WIDTH, IN_TYPE, OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_USE_URAM,
                  XF_CV_DEPTH_IN, XF_CV_DEPTH_OUT_0, XF_CV_DEPTH_OUT_1>(in_mat, _dstgx, _dstgy);
    printf("xfMat2Array .... !!!\n");
    xf::cv::xfMat2Array<OUTPUT_PTR_WIDTH, OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_OUT_0>(_dstgx, img_out1);
    xf::cv::xfMat2Array<OUTPUT_PTR_WIDTH, OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_OUT_1>(_dstgy, img_out2);
}
}