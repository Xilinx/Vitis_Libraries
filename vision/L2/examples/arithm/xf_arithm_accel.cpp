...
// clang-format off
    ...
    xf::cv::Mat<IN_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_OUT_1> imgOutput(height, width);
...
// clang-format off
    ...
    // Run xfOpenCV kernel:
    xf::cv::FUNCT_NAME<OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_IN_1, XF_CV_DEPTH_OUT_1>(imgInput1, imgOutput);
...
// Run xfOpenCV kernel:
#ifdef EXTRA_PARM
    xf::cv::FUNCT_NAME<EXTRA_PARM, OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_IN_1, XF_CV_DEPTH_IN_2,
...
#else
    xf::cv::FUNCT_NAME<OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_IN_1, XF_CV_DEPTH_IN_2, XF_CV_DEPTH_OUT_1>(
