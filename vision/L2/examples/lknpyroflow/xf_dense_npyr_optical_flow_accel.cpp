...
// clang-format off
    ...
    xf::cv::DenseNonPyrLKOpticalFlow<KMED, XF_8UC1, MAX_HEIGHT, MAX_WIDTH, NPPC, XF_CV_DEPTH_IN_1, XF_CV_DEPTH_IN_2,
                                     XF_CV_DEPTH_OUT_1, XF_CV_DEPTH_OUT_2>(in_curr_mat, in_prev_mat, outx_mat,
                                                                           outy_mat);
