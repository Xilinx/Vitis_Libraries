...
static constexpr int PXL_WIDTH = XF_PIXELWIDTH(SIN_CHANNEL_IN_TYPE, NPPCX);
...
#pragma HLS DATAFLOW
    ...
    gtm<IN_TYPE, OUT_TYPE, SIN_CHANNEL_IN_TYPE, SIN_CHANNEL_OUT_TYPE, HEIGHT, WIDTH, NPPCX, XF_CV_DEPTH_IN_1,
