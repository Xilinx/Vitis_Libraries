...
#pragma HLS DATAFLOW
    ...
    xf::cv::Array2xfMat<PTR_IN_WIDTH, INTYPE, HEIGHT, WIDTH, NPC1, XF_CV_DEPTH_IN_1>(img_in, imgInput);
    ...
    xf::cv::xfMat2Array<PTR_OUT_WIDTH, OUTTYPE, HEIGHT, WIDTH, NPC1, XF_CV_DEPTH_OUT_1>(imgOutput, img_out);
