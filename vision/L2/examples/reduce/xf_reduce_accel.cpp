...
// clang-format off
    ...
    xf::cv::Mat<OUT_TYPE, ONE_D_HEIGHT, ONE_D_WIDTH, NPPCX, XF_CV_DEPTH_OUT> imgOutput(ONE_D_HEIGHT, ONE_D_WIDTH);
...
#pragma HLS DATAFLOW
    ...
    xf::cv::xfMat2Array<OUTPUT_PTR_WIDTH, OUT_TYPE, ONE_D_HEIGHT, ONE_D_WIDTH, NPPCX, XF_CV_DEPTH_OUT>(imgOutput,
                                                                                                       img_out);
