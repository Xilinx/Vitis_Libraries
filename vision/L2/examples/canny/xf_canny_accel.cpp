...
#pragma HLS DATAFLOW
    ...
    xf::cv::Canny<FILTER_WIDTH, NORM_TYPE, XF_8UC1, XF_2UC1, HEIGHT, WIDTH, INTYPE, XF_NPPC32, XF_CV_DEPTH_IN_1,
                  XF_CV_DEPTH_OUT_1, XF_USE_URAM>(in_mat, dst_mat, low_threshold, high_threshold);
