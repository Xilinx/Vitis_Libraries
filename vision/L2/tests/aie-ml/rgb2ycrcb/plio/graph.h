...
#ifndef ADF_RGB2YCrCb_GRAPH_H
#define ADF_RGB2YCrCb_GRAPH_H
...
class RGB2YCrCbGraph : public adf::graph {
   private:
   ...
   public:
    ...
    RGB2YCrCbGraph(int tile_col, int tile_row, int CORE_IDX) {
        int mt_col = tile_col;
        ...
        for (int i = 0; i < NO_CORES_PER_COL; i++) {
            k[i] = kernel::create_object<RGB2YCrCbRunner>();
