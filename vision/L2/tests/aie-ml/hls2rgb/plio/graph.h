...
#ifndef ADF_HLS2RGB_GRAPH_H
#define ADF_HLS2RGB_GRAPH_H
...
class HLS2RGBGraph : public adf::graph {
   private:
   ...
   public:
    ...
    HLS2RGBGraph(int tile_col, int tile_row, int CORE_IDX) {
        int mt_col = tile_col;
        ...
        for (int i = 0; i < NO_CORES_PER_COL; i++) {
            k[i] = kernel::create_object<HLS2RGBRunner>();
