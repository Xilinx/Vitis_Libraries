...
#ifndef ADF_GRAPH_MEAN_RGB800_H
#define ADF_GRAPH_MEAN_RGB800_H
...
class meanGraph : public adf::graph {
   private:
   ...
   public:
    ...
    meanGraph(int tile_col, int tile_row, int CORE_IDX) {
        int mt_col = tile_col;
        ...
        for (int i = 0; i < NO_CORES_PER_COL; i++) {
            k[i] = kernel::create_object<MeanRunner>();
