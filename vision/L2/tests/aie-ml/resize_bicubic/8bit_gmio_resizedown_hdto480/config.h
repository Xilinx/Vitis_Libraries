...
using DATA_TYPE = uint8_t; // in/out image depth type
#define VF 32              // vectorization factor is 32 for uint8_t type, 16 for uint16_t
#define NO_CORES 1
...
static constexpr int IMAGE_HEIGHT_OUT = 270;
...
static constexpr int TILE_WINDOW_SIZE_IN = (TILE_ELEMENTS_IN) + xf::cv::aie::METADATA_SIZE;
...
static constexpr int IMAGE_WIDTH_IN2 = 270;
static constexpr int IMAGE_HEIGHT_IN2 = 1920;
static constexpr int IMAGE_WIDTH_OUT2 = 270;
static constexpr int IMAGE_HEIGHT_OUT2 = 480;
...
static constexpr int TILE_WINDOW_SIZE_IN2 = (TILE_ELEMENTS_IN2) + xf::cv::aie::METADATA_SIZE;
static constexpr int TILE_ELEMENTS_OUT2 = (TILE_WIDTH_OUT2 * TILE_HEIGHT_OUT2 * CHANNELS);
static constexpr int TILE_WINDOW_SIZE_OUT2 = (TILE_ELEMENTS_OUT2) + xf::cv::aie::METADATA_SIZE;
;
