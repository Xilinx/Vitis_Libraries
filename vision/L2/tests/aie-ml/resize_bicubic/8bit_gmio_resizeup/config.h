...
static constexpr int IMAGE_WIDTH_IN = 1280;
static constexpr int IMAGE_HEIGHT_IN = 720;
static constexpr int IMAGE_WIDTH_OUT = 1280;
...
static constexpr int IMAGE_HEIGHT_IN2 = 1280;
