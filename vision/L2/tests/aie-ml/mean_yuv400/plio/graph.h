...
#ifndef ADF_GRAPH_MEAN_400_H
#define ADF_GRAPH_MEAN_400_H
...
class meanYuv400Graph : public adf::graph {
   private:
   ...
   public:
    ...
    meanYuv400Graph(int tile_col, int tile_row, int CORE_IDX) {
        int mt_col = tile_col;
