...
static constexpr int IMAGE_WIDTH_IN = 256;
static constexpr int IMAGE_HEIGHT_IN = 128;
static constexpr int IMAGE_WIDTH_OUT = 480;
static constexpr int IMAGE_HEIGHT_OUT = 212;
...
static constexpr int IN_FBITS = 5;
static constexpr int ALPHA_FBITS = 8;
static constexpr int BETA_FBITS = 7;
static constexpr int OUT_FBITS = 0;
