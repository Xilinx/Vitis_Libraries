...
#ifndef ADF_YCrCb2RGB_GRAPH_H
#define ADF_YCrCb2RGB_GRAPH_H
...
class YCrCb2RGBGraph : public adf::graph {
   private:
   ...
   public:
    ...
    YCrCb2RGBGraph(int tile_col, int tile_row, int CORE_IDX) {
        int mt_col = tile_col;
        ...
        for (int i = 0; i < NO_CORES_PER_COL; i++) {
            k[i] = kernel::create_object<YCrCb2RGBRunner>();
