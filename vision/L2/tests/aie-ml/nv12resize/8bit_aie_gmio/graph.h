...
extern uint8_t outu_buf[256];
extern uint8_t outv_buf[256];
...
class myGraph : public adf::graph {
   public:
    ...
    myGraph() {
        ...
        yinptr = input_gmio::create("gmioIn1", 256, 1000);
        youtptr = output_gmio::create("gmioOut1", 256, 1000);
...
class myGraph1 : public adf::graph {
   public:
    ...
    input_gmio uvinptr;
    output_gmio uvoutptr;

    myGraph1() {
        k1 = kernel::create(nv12resize_uv);

        uvinptr = input_gmio::create("gmioIn2", 256, 1000);
        uvoutptr = output_gmio::create("gmioOut2", 256, 1000);
