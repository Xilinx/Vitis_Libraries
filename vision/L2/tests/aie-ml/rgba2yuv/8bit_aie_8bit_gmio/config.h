...
static constexpr int TILE_WINDOW_SIZE_Y = TILE_ELEMENTS * sizeof(DATA_TYPE);
static constexpr int TILE_WINDOW_SIZE_UV = TILE_WINDOW_SIZE_Y / 2;
static constexpr int TILE_WINDOW_SIZE_RGBA = TILE_WINDOW_SIZE_Y * 4;
...
static constexpr int ELEM_WITH_METADATA_RGBA = (4 * TILE_ELEMENTS) + (xf::cv::aie::METADATA_SIZE / sizeof(DATA_TYPE));
