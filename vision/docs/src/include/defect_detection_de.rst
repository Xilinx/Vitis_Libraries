...
Gaussian Otsu pipeline, which includes functions `xf::cv::custom-bgr2y8 <https://docs.xilinx.com/r/2022.2-English/Vitis_Libraries/vision/api-reference.html#custom-bgr2y8>`__, 
`xf::cv::GaussianBlur <https://docs.xilinx.com/r/2022.2-English/Vitis_Libraries/vision/api-reference.html#gaussian-filter>`__, `xf::cv::OtsuThreshold <https://docs.xilinx.com/r/2022.2-English/Vitis_Libraries/vision/api-reference.html#otsu-threshold>`__.
Preprocess pipeline, which includes functions `xf::cv::Threshold <https://docs.xilinx.com/r/2022.2-English/Vitis_Libraries/vision/api-reference.html#thresholding>`__, ``xf::cv::fw_cca``.
