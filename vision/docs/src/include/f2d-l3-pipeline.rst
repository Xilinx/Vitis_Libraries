...
The steps for library download and environment setup can be found in README of L3 folder. Please refer :ref:`Getting Started with Vitis Vision AIEngine Library Functions <aie_prerequisites>` for more details. For getting the design,
