...
#pragma HLS DATAFLOW
    ...
    if (WB_TYPE) {
        ...
        xf::cv::AWBNormalization<XF_DST_T, XF_DST_T, XF_HEIGHT, XF_WIDTH, XF_NPPC, WB_TYPE, HIST_SIZE, XFCVDEPTH_ltm_in,
                                 XFCVDEPTH_ltm_in>(impop, ltm_in, hist1, thresh, inputMin, inputMax, outputMin,
                                                   outputMax);
    } else {
        ...
        xf::cv::AWBGainUpdate<XF_DST_T, XF_DST_T, XF_HEIGHT, XF_WIDTH, XF_NPPC, 0, XFCVDEPTH_ltm_in, XFCVDEPTH_ltm_in>(
