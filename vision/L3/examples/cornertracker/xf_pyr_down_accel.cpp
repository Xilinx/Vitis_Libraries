...
// clang-format off
    ...
    xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1, XF_CV_DEPTH_PD_2> pyr1_out_mat;
    ...
    xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1, XF_CV_DEPTH_PD_4> pyr2_out_mat;
...
// clang-format off
    ...
    xf::cv::pyrDown<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1, XF_CV_DEPTH_PD_1, XF_CV_DEPTH_PD_2>(pyr1_in_mat, pyr1_out_mat);
    xf::cv::xfMat2Array<INPUT_PTR_WIDTH, XF_8UC1, HEIGHT, WIDTH, XF_NPPC1, XF_CV_DEPTH_PD_2>(pyr1_out_mat, outImgPyr1);

    xf::cv::Array2xfMat<INPUT_PTR_WIDTH, XF_8UC1, HEIGHT, WIDTH, XF_NPPC1, XF_CV_DEPTH_PD_3>(inImgPyr2, pyr2_in_mat);
    xf::cv::pyrDown<XF_8UC1, HEIGHT, WIDTH, XF_NPPC1, XF_CV_DEPTH_PD_3, XF_CV_DEPTH_PD_4>(pyr2_in_mat, pyr2_out_mat);
    xf::cv::xfMat2Array<INPUT_PTR_WIDTH, XF_8UC1, HEIGHT, WIDTH, XF_NPPC1, XF_CV_DEPTH_PD_4>(pyr2_out_mat, outImgPyr2);
