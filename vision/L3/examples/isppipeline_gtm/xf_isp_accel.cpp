...
#pragma HLS INLINE OFF
    ...
    xf::cv::Mat<XF_GTM_T, XF_HEIGHT, XF_WIDTH, XF_NPPCX, XF_CV_DEPTH_OUT_4> _dst(height, width);
    xf::cv::Mat<XF_GTM_T, XF_HEIGHT, XF_WIDTH, XF_NPPCX, XF_CV_DEPTH_OUT_5> aecin(height, width);
...
#pragma HLS DATAFLOW
    ...
    if (OUT_TYPE == XF_8UC3) {
        ...
        xf::cv::gtm<OUT_TYPE, XF_GTM_T, IN_TYPE, SIN_CHANNEL_TYPE, XF_HEIGHT, XF_WIDTH, XF_NPPCX, XF_CV_DEPTH_OUT_3,
                    XF_CV_DEPTH_OUT_5>(lsc_out, aecin, mean1, mean2, L_max1, L_max2, L_min1, L_min2, c1, c2);
    }
    xf::cv::gammacorrection<XF_GTM_T, XF_GTM_T, XF_HEIGHT, XF_WIDTH, XF_NPPCX, XF_CV_DEPTH_OUT_5, XF_CV_DEPTH_OUT_4>(
        aecin, _dst, gamma_lut);
    // ColorMat2AXIvideo<XF_GTM_T, XF_HEIGHT, XF_WIDTH, XF_NPPCX>(_dst, m_axis_video);
    xf::cv::rgb2yuyv<XF_GTM_T, XF_16UC1, XF_HEIGHT, XF_WIDTH, XF_NPPCX, XF_CV_DEPTH_OUT_4, XF_CV_DEPTH_OUT_6>(
        _dst, _imgOutput);
