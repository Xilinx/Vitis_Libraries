...
/*  reading in the color image  */
    ...
    OCL_CHECK(err, err = kernel.setArg(16, gtm_config_1));
    OCL_CHECK(err, err = kernel.setArg(17, gtm_config_2));
    ...
    OCL_CHECK(err, err = kernel.setArg(23, buffer_ccm_matrix_int));
    OCL_CHECK(err, err = kernel.setArg(24, buffer_offsetarray_int));
    OCL_CHECK(err, err = kernel.setArg(25, bformat));
    OCL_CHECK(err, err = kernel.setArg(26, ggain));
