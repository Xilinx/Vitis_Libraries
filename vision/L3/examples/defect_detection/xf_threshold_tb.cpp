...
////////////////  reference code  ////////////////
    ...
    OCL_CHECK(err, err = kernel.setArg(6, buffer_array));
    ...
    cl_ulong cca_start = 0;
    cl_ulong cca_end = 0;
    double cca_diff_prof = 0.0f;
    ...
    OCL_CHECK(err, err = cca_krnl.setArg(1, cca_tempbuffer_2));
    ...
    OCL_CHECK(err, err = krnl.setArg(2, cca_tempbuffer));
    OCL_CHECK(err, err = krnl.setArg(3, obj_pix_buffer));
    OCL_CHECK(err, err = krnl.setArg(4, thresh));
    ...
    * width),
    ...
    cca_event_sp.getProfilingInfo(CL_PROFILING_COMMAND_START, &cca_start);
    cca_event_sp.getProfilingInfo(CL_PROFILING_COMMAND_END, &cca_end);
