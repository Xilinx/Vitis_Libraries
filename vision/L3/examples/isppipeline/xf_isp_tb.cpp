...
/*  reading in the color image  */
    ...
    OCL_CHECK(err, err = kernel.setArg(9, buffer_ccm_matrix_int));
    OCL_CHECK(err, err = kernel.setArg(10, buffer_offsetarray_int));
    OCL_CHECK(err, err = kernel.setArg(11, bformat));
    OCL_CHECK(err, err = kernel.setArg(12, ggain));
