...
#include "xf_fft/hls_ssr_fft_complex_multiplier.hpp"
...
#pragma HLS UNROLL
    ...
    // D0t[0] = p_bflyIndata[0] + p_bflyIndata[1];
    // D0t[1] = p_bflyIndata[0] - p_bflyIndata[1];
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++Length 8 fft kernel using two radix 4
// kernels+++++++++++++++++++++++++++++++++++++
template <bool isFirstStage,
          scaling_mode_enum t_scalingMode,
          transform_direction_enum transform_direction,
