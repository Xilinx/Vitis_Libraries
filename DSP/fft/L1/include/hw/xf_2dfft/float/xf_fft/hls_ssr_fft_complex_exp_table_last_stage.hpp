...
struct ComplexExpTableLastStage<t_R, transform_direction, butterfly_rnd_mode, t_realLength, complex_wrapper<T_dtype> > {
    static void initComplexExpTable(complex_wrapper<T_dtype> p_table[]) {
        typedef typename TwiddleTypeCastingTraits<complex_wrapper<T_dtype> >::T_roundingBasedCastType T_roundedCastType;
