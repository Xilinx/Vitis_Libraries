...
set PROJ "clarke_inverse_fp32_hls_sim.prj"
set SOLN "sol1"
...
add_files "${XF_PROJ_ROOT}/L1/tests/tests_fp32/clarke_inverse_fp32_tb/src/clarke_inverse_fp32_top.cpp" -cflags "-DSIM_FINITE -I${XF_PROJ_ROOT}/L1/include/models_fp -I${XF_PROJ_ROOT}/L1/tests/tests_fp32/clarke_inverse_fp32_tb/src"
