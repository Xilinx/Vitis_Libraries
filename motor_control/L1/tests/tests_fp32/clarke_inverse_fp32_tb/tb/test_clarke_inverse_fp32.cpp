...
struct ErrorMetrics {
    ...
    ErrorMetrics() : max_error_a(0), max_error_b(0), max_error_c(0),
...
void test_boundary_cases(ErrorMetrics& metrics) {
    ...
    TestCase cases[] = {
        {"All zeros",          0.0f,     0.0f},
        {"Only alpha",         10.0f,    0.0f},
        {"Only beta",          0.0f,     10.0f},
        {"Negative alpha",    -10.0f,    5.0f},
        {"Negative beta",      10.0f,   -5.0f},
        {"Both negative",     -10.0f,   -5.0f},
        {"Large amplitude",   100.0f,   100.0f},
        {"Small amplitude",    0.001f,   0.001f}
    };
