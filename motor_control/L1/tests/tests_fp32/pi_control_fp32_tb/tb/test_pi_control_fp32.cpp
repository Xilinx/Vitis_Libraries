...
void test_boundary_cases(ErrorMetrics& metrics) {
    ...
    TestCase cases[] = {
        {"Zero error",      50.0f,  50.0f,  1.0f, 0.5f},
        {"Large error",     0.0f,   100.0f, 1.0f, 0.5f},
        {"Negative error",  100.0f, 0.0f,   1.0f, 0.5f},
        {"Zero gains",      10.0f,  50.0f,  0.0f, 0.0f},
        {"High Kp",         10.0f,  50.0f,  10.0f, 0.1f},
        {"High Ki",         10.0f,  50.0f,  0.1f, 10.0f}
    };
    ...
    for (const auto& tc : cases) {
        ...
        std::cout << "  Measured=" << tc.measured << " Setpoint=" << tc.setpoint 
                  << " Kp=" << tc.kp << " Ki=" << tc.ki << "\n";
        std::cout << "  DUT Output:    " << dut_output << "\n";
        std::cout << "  Golden Output: " << golden_output << "\n";
        std::cout << "  Error: " << err << "\n\n";
