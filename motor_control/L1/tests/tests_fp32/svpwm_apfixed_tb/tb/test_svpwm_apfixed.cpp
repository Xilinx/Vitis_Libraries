...
TestPoint run_test_point(float va, float vb, float vc, float dc_link) {
    ...
    details::calculate_ratios_core<T_FOC_COM>(duty_ratio, Vcmd, dc_link_fixed,
...
void print_summary(const std::vector<TestPoint>& results, const std::string& mode) {
    ...
    std::cout << "  SNR:       " << std::fixed << std::setprecision(2) << metrics_a.snr_db << " dB" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  SNR:       " << std::fixed << std::setprecision(2) << metrics_b.snr_db << " dB" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  SNR:       " << std::fixed << std::setprecision(2) << metrics_c.snr_db << " dB" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Worst SNR:       " << std::fixed << std::setprecision(2) << worst_snr << " dB" << std::endl;
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "  Q-format: Q" << I_IO << "." << (W_IO - I_IO) << " (ap_fixed<" << W_IO << "," << I_IO << ">)"
              << std::endl;
