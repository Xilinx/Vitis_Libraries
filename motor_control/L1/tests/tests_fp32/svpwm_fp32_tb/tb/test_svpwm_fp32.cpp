...
struct ErrorMetrics {
    ...
    ErrorMetrics() : max_error_duty_a(0), max_error_duty_b(0), max_error_duty_c(0), num_tests(0), num_passed(0) {}
...
void test_boundary_cases(ErrorMetrics& metrics) {
    ...
    TestCase cases[] = {
        {"All zeros", 0.0f, 0.0f, 0.0f, 300.0f},          {"Only Va", 100.0f, 0.0f, 0.0f, 300.0f},
        {"Balanced max", 100.0f, -50.0f, -50.0f, 300.0f}, {"High modulation", 150.0f, -75.0f, -75.0f, 300.0f},
        {"Low DC link", 10.0f, -5.0f, -5.0f, 50.0f},      {"Negative voltages", -50.0f, -50.0f, -50.0f, 300.0f}};
    ...
    for (const auto& tc : cases) {
        ...
        std::cout << "  Input:  Va=" << tc.va << " Vb=" << tc.vb << " Vc=" << tc.vc << " DC=" << tc.dc_link << "\n";
        std::cout << "  DUT Duties:    A=" << dut_output.duty_a << " B=" << dut_output.duty_b
                  << " C=" << dut_output.duty_c << "\n";
        std::cout << "  Golden Duties: A=" << golden_output.duty_a << " B=" << golden_output.duty_b
