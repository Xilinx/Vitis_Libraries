...
set PROJ "clarke_direct_apfixed_hls_sim.prj"
set SOLN "sol1"
...
add_files "${XF_PROJ_ROOT}/L1/tests/tests_fp32/clarke_direct_apfixed_tb/src/clarke_direct_apfixed_top.cpp" -cflags "-DSIM_FINITE -I${XF_PROJ_ROOT}/L1/include/models_fp -I${XF_PROJ_ROOT}/L1/include"
