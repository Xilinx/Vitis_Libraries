...
/**
 * @brief This module helps in finding better match length by doing
 * more character match with supported max match length while maintaining
 * an offset window. This helps in improving Compression Ratio.
 *
