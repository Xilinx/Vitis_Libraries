...
int main(int argc, char **argv) {
  ...
  if( posix_memalign( (void**) &a_short, 4096, (size_t)m * (size_t)n * sizeof(short)) != 0 ) { printf("[ERROR] failed to create the matrix a_short\n"); exit(1); }
  if( posix_memalign( (void**) &x_short, 4096, (size_t)n * sizeof(short)) != 0 ) { printf("[ERROR] failed to create the vector x_short\n"); exit(1); }
  if( posix_memalign( (void**) &y_short, 4096, (size_t)m * sizeof(short)) != 0 ) { printf("[ERROR] failed to create the vector y_short\n"); exit(1); }
