...
int main(int argc, char **argv) {
  ...
  if( posix_memalign( (void**) &a_short, 4096, (size_t)m * (size_t)k * sizeof(short)) != 0 ) { printf("[ERROR] failed to create the matrix a_short\n"); exit(1); }
  if( posix_memalign( (void**) &b_short, 4096, (size_t)k * (size_t)n * sizeof(short)) != 0 ) { printf("[ERROR] failed to create the matrix a_short\n"); exit(1); }
  if( posix_memalign( (void**) &c_short, 4096, (size_t)m * (size_t)n * sizeof(short)) != 0 ) { printf("[ERROR] failed to create the matrix a_short\n"); exit(1); }
