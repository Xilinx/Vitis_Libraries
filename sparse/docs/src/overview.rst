...
.. meta::
   ...
   :description: Vitis SPARSE Library licensing, trademark notice and hardware & software requirements.
...
This library is designed to work with Vitis |ProjectVersion| and later, and therefore inherits the system requirements of Vitis and XRT.
...
Hardware modules and kernels are designed to work with Alveo U280 cards.
