...
edit_on_github_branch = 'master/sparse/docs/src'
...
latex_documents = [
    (master_doc, 'xf_Sparse.tex', 'Vitis Sparse Library',
     'Xilinx', 'manual'),
]
...
man_pages = [
    (master_doc, 'xf_sparse', 'Vitis Sparse Library Documentation',
     [author], 1)
]
