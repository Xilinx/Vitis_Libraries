 ...
 * @param p_param memory pointer for retriving parameters
 * @param p_rd0 HBM0 pointer for reading NNZ value and indices
 * @param p_wr0 HBM0 pointer for writing back result row vector entries
 * @param p_rd1 HBM1 pointer for reading NNZ value and indices
 * @param p_wr1 HBM1 pointer for writing back result row vector entries
 * @param p_rd2 HBM2 pointer for reading NNZ value and indices
 * @param p_wr2 HBM2 pointer for writing back result row vector entries
 * @param p_rd3 HBM3 pointer for reading NNZ value and indices
 * @param p_wr3 HBM3 pointer for writing back result row vector entries
 * @param out0 axi stream outputs to cscRowPkt kernel
 * @param int0 axi stream inputs from cscRowPkt kernel
 * @param out1 axi stream outputs to cscRowPkt kernel
 * @param int1 axi stream inputs from cscRowPkt kernel
 * @param out2 axi stream outputs to cscRowPkt kernel
 * @param int2 axi stream inputs from cscRowPkt kernel
 * @param out3 axi stream outputs to cscRowPkt kernel
 * @param int3 axi stream inputs from cscRowPkt kernel
 */

/**
 * @brief readWriteHbmKernel
